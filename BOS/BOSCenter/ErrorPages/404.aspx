<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="404.aspx.vb" Inherits="BOSCenter._404" %>
        	...
        	<div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head">
                    	<asp:Label ID="Label1" runat="server"  Text="404 - Page Not Found"></asp:Label>
                    </div>
                </div>
            </div>
        	<div class="log_form">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-12 top_mar12">
                         <asp:Label ID="lblErrormsg" runat="server" Text="Sorry, but the page you are looking for has not been found. Try checking the URL for error, then hit the refresh button on your browser or try found something else in our app."></asp:Label>
                        </div>
                  </div>
