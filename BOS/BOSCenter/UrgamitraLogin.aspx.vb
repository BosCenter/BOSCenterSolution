...
Public Class UrgamitraLogin
        ...
        Try
            If Not IsPostBack Then
                ...
                If Not IsPostBack Then
                    ...
                    txtCompanyCode.Text = "CMP1205" '"CMP1205"
    ...
    Protected Sub lnkSignup_Click(sender As Object, e As EventArgs) Handles lnkSignup.Click
        Try
            ...
            Else
                ...
                End If
            End If
            Response.Redirect("create_custome1.aspx?admin=" & CompanyCode)
        Catch ex As Exception
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSubmit.Click
        Try
            ...
            txtCompanyCode.Text = "CMP1205" '"CMP1202"
            Dim CompanyCode As String = GV.parseString(txtCompanyCode.Text.Trim)
            ...
            If Len(txtUserName.Text.Trim) = 10 And IsNumeric(txtUserName.Text.Trim) Then

                If GV.FL_AdminLogin.RecCount(DBName.Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration where MobileNo='" & GV.parseString(txtUserName.Text.Trim) & "'  ") Then
                    Result = True
                Else
                    Result = False
                ...
                ds = GV.FL_AdminLogin.OpenDs(DBName.Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration where  MobileNo='" & GV.parseString(txtUserName.Text.Trim) & "' and Encrypted_Pass='" & Encrypted_Pass & "' ")
