<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Admin/SuperAdmin.Master"   CodeBehind="BOS_Card_Kyc_Report.aspx.vb" Inherits="BOSCenter.BOS_Card_Kyc_Report" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Card KYC Report"></asp:Label>	
                    </div>
                </div>
            </div>
        ...
        <form class="form-horizontal">
         ...
         <div class="row">
                   ...
                   <div class="row">               
                      <div class="form-group">
                       <div class="col-sm-3">
                       <asp:DropDownList ID="ddlApproveStatus" cssclass="form-control"  runat="server" >
