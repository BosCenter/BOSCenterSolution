            ...
            If group.Trim.ToUpper = "Retailer".Trim.ToUpper Then
                ...
                If GridView1.Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To GridView1.Rows.Count - 1
                        ...
                        TotalAmt = TotalAmt + GV.parseString(GridView1.Rows(i).Cells(9).Text)
