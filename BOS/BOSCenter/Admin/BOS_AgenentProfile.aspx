<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_AgenentProfile.aspx.vb" Inherits="BOSCenter.BOS_AgenentProfile" %>
...
<label for='txtAgentType'>  AgentType</label>
  <asp:DropDownList ID="ddlAgentType" runat="server" class='form-control' Enabled="false" AutoPostBack="true">
...
<div class="col-md-4">
<div class="form-group">
<label for='txtAgentName'>  Agency Name</label>
<asp:TextBox ID='txtAgentName' runat='server'  placeholder='AgentName' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>

<div class="col-md-4">
<div class="form-group">
<label for='txtPanCardNumber'>  PanCardNumber</label>
<asp:TextBox ID='txtPanCardNumber' runat='server'  placeholder='PanCardNumber' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
...
<asp:TextBox ID='txtFirstName' runat='server'  placeholder='FirstName' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
<label for='txtLastName'>  LastName</label>
<asp:TextBox ID='txtLastName' runat='server'  placeholder='LastName' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
...
<asp:TextBox ID='txtDOB' runat='server'  placeholder='DOB' class='form-control'  Enabled="false"></asp:TextBox>
...
<asp:TextBox ID='txtEmailID' runat='server'  placeholder='EmailID' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
<label for='txtMobileNo'>  MobileNo</label>
<asp:TextBox ID='txtMobileNo' runat='server'  MaxLength="10" placeholder='MobileNo' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
...
<asp:TextBox ID='txtAlternateMobileNo' runat='server' MaxLength="10"  placeholder='AlternateMobileNo' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtPermanentAddress'>  PermanentAddress</label>
<asp:TextBox ID='txtPermanentAddress' runat='server'  placeholder='PermanentAddress' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
<label for='txtBusinessType'>  BusinessType</label>
  <asp:DropDownList ID="ddlBussinessType" runat="server" class='form-control'  Enabled="false">
...
<div class="col-md-4">
<div class="form-group">
<label for='txtOfficeAddress'>  OfficeAddress</label>
<asp:TextBox ID='txtOfficeAddress' runat='server'  placeholder='OfficeAddress' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
...
<label for='txtState'>  State</label>
  <asp:DropDownList ID="ddlState" runat="server" class='form-control'  Enabled="false">
 </asp:DropDownList>
</div>
</div>
<div class="col-md-4">
...
<asp:TextBox ID='txtCity' runat='server'  placeholder='City' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
...
<asp:TextBox ID='txtPincode' runat='server'  placeholder='Pincode' MaxLength="6" class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtAddharCardNo'>  AddharCardNo</label>
<asp:TextBox ID='txtAddharCardNo' runat='server'  placeholder='AddharCardNo' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
...
<asp:TextBox ID='txtGSTNO' runat='server'  placeholder='GSTNO' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
<label for='txtWebSite'>  WebSite</label>
<asp:TextBox ID='txtWebSite' runat='server'  placeholder='WebSite' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
</div>
...
<asp:TextBox ID='txtBankName' runat='server'  placeholder='Bank Name' class='form-control'  Enabled="false"></asp:TextBox>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
<label for='txtBranchName'>Branch Name</label>
<asp:TextBox ID='txtBankBranch' runat='server'  placeholder='Branch Name'  Enabled="false"
...
<asp:TextBox ID='txtAccountNumber' runat='server'  placeholder='Account Number'   Enabled="false"
        class='form-control'></asp:TextBox>
</div>
</div>
</div>
...
<label for='txtAccountType'>  Account Type</label>
  <asp:DropDownList ID="ddlAccountType" runat="server" class='form-control' Enabled="false"> 
...
<asp:TextBox ID='txtIFSCode' runat='server'  placeholder='IFSC Code'  ReadOnly="true"
        class='form-control'></asp:TextBox>
</div>
</div>
<div class="col-md-4">
...
<label for='txtIncomeProof'>  Pan Card</label>
    ...
    <div style="margin-bottom:5px;"></div>
<asp:FileUpload ID="FileUpload_PanCard" runat="server" Enabled="false" />

    <asp:Button ID="btnUpload_PanCard" runat="server" Enabled="false"
        Text="Upload" />
...
<asp:FileUpload ID="FileUpload_AddharCardFront" runat="server" Enabled="false" />

    <asp:Button ID="btnUpload_AddharCardFront" runat="server" Enabled="false"
        Text="Upload" />
...
<asp:FileUpload ID="FileUpload_AddharCardBack" runat="server" Enabled="false" />

    <asp:Button ID="btnUpload_AddharCardBack" runat="server" Enabled="false"
        Text="Upload" />
...
<asp:FileUpload ID="FileUpload_OtherDocuments" runat="server" Enabled="false" />

    <asp:Button ID="btnUpload_OtherDocuments" runat="server" Enabled="false"
        Text="Upload" />
...
<asp:FileUpload ID="FileUpload_Photo" Enabled="false" runat="server"  />

    <asp:Button ID="btnUpload_Photo" runat="server"  Enabled="false"
        Text="Upload" />
