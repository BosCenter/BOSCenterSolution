...
Public Class BOS_Create_Customer
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Else
                ...
                End If
            End If
            formheading3.Text = "Create Customer"
            ...
            If Not IsPostBack Then
                ...
                GV.FL.AddInDropDownListDistinct(ddl_Ref_Code, "Ref_Code", "" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Ref_Code_Master order by Ref_Code ")
                ...
                If Not Session("RecordID") = "" And Session("RecordEdit") = 1 And Session("RecordEditConfirm") = 9 Then
                    ...
                    btnClear.Text = "Close"
                    '  btnDelete.Enabled = True
                    lblformsectionhead3.Text = "Edit Create Customer "
                    ...
                    If Not DS Is Nothing Then
                        If DS.Tables.Count > 0 Then
                            ...
                            If Not IsDBNull(DS.Tables(0).Rows(0).Item("Ref_Code")) Then
                                If Not DS.Tables(0).Rows(0).Item("Ref_Code").ToString() = "" Then
                                    ddl_Ref_Code.SelectedValue = GV.parseString(DS.Tables(0).Rows(0).Item("Ref_Code").ToString())
                                Else
                ...
                Else
                    ...
                    If GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim.ToUpper = "BosCenter_DB".Trim.ToUpper Then
                        txtAgencyName.Text = "BOS Money"
                    Else
                        Dim CompanyName As String = GV.FL_AdminLogin.AddInVar("CompanyName", " " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_ClientRegistration where CompanyCode='" & GV.get_SuperAdmin_SessionVariables("CompanyCode", Request, Response).Trim & "' ")
    ...
    Private Sub btnClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClear.Click
        Try
            If btnClear.Text = "Close" Then
                Response.Redirect("BOS_SearchCustomer.aspx") '/Change the name of form
            Else
                Clear()
                ddlAgentType_SelectedIndexChanged(sender, e)
            End If
        ...
        Try
            ...
            If Session("EditFlag") = 0 Then
                ...
                If VAddharCardNo.Trim = "" Then
                    strQry = "" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration Where (EmailID='" & VEmailID & "' or MobileNo='" & VMobileNo & "') and ( AgentType='" & VAgentType & "' ) "
                    QryMsg = "Record with EmailID or Mobile Already Exists."
                Else
                    strQry = "" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration Where (EmailID='" & VEmailID & "' or MobileNo='" & VMobileNo & "'  or AddharCardNo='" & VAddharCardNo & "' ) and ( AgentType='" & VAgentType & "' ) "
                    QryMsg = "Record with EmailID or Mobile or AddharCardNo Already Exists."
                End If

                If GV.FL.RecCount(strQry) > 0 Then 'Change where condition according to Criteria 

                    lblDialogMsg.Text = QryMsg
                    lblDialogMsg.CssClass = "errorlabels"
                    btnCancel.Text = "Ok"
                ...
                Dim QryStr As String = "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration (AEPS_Onboard_Status,Encrypted_Pass,HoldAmt,Ref_Code,District,AEPS_API_Status,RechargeAPI_Status,MoneyTransferAPI_Status,PANCardAPI_Status,EmpCode,ActiveStatus,TransactionPin,CreditBalnceLimit,RefrenceID,RefrenceType,AgentPassword,UploadPanCard,UploadAddharCard_Front,UploadAddharCard_Back,UploadOtherProof,UploadPhoto,UpdatedBy,UpdatedOn,RecordDateTime,RegistrationDate,AgentType,AgencyName,FirstName,EmailID,DOB,AlternateMobileNo,PermanentAddress,State,AddharCardNo,WebSite,RegistrationId,PanCardNumber,MobileNo,OfficeAddress,City,LastName,Pincode,BusinessType,GSTNO) values('No' ,'" & GV.DecryptString(GV.key, Encrypted_Pass) & "' ,0,'" & VRef_Code & "','" & VDistrict & "','" & APIStatus & "','" & APIStatus & "','" & APIStatus & "','" & APIStatus & "','" & EMPCode & "','" & VActiveStatus & "','" & trnsactionpinNo & "','" & VCreditBalLimit & "','" & VRefrenceID & "','" & VRefrenceType & "','" & Vpassword & "','" & VPanCard_Path & "','" & VAddharCardFront_PAth & "','" & VAddharCardBack_Path & "','" & VOtherDocuments_Path & "','" & VPhoto_Path & "','" & VUpdatedBy & "'," & VUpdatedOn & "," & VRecord_DateTime & ",'" & VRegisterDate & "', '" & VAgentType & "','" & VAgencyName & "','" & VFirstName & "','" & VEmailID & "','" & VDOB & "','" & VAlternateMobileNo & "','" & VPermanentAddress & "','" & VState & "','" & VAddharCardNo & "','" & VWebSite & "','" & VRegistrationId & "','" & VPanCardNumber & "','" & VMobileNo & "','" & VOfficeAddress & "','" & VCity & "','" & VLastName & "','" & VPincode & "','" & VBusinessType & "','" & VGSTNO & "' ) ;"
                ...
                If CDec(lblServiceCharge.Text.Trim) > 0 Then
                    ...
                    QryStr = QryStr & " " & "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Ref_TransID,Actual_Transaction_Amount,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values('" & GV.parseString(GV.GetIPAddress) & "','" & vTransID & "','" & vTransID & "','" & lblServiceCharge.Text.Trim & "','" & SDtypecommTo & "','" & SDtypecommFrom & "','Deposit','Deposit','" & Now.Date & "','" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response) & "','" & VRegistrationId & "','" & lblServiceCharge.Text.Trim & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"

                End If

                If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN" Or GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "SUPER ADMIN") Then
                    ...
                    ElseIf GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "Customer".Trim.ToUpper Then
                    ...
                    DS = New DataSet
                    DS = GV.FL.OpenDsWithSelectQuery("select * from BOS_Ref_Code_Master where Ref_Code='" & GV.parseString(ddl_Ref_Code.SelectedValue) & "'")
                    If Not DS Is Nothing Then
                        If DS.Tables.Count > 0 Then
            ...
            ElseIf Session("EditFlag") = 1 Then
                ...
                If VAddharCardNo.Trim = "" Then
                    strQry = "" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration Where (EmailID='" & VEmailID & "' or MobileNo='" & VMobileNo & "') and ( AgentType='" & VAgentType & "' ) and ( not RegistrationId='" & VRegistrationId & "' ) "
                    QryMsg = "Record with EmailID or Mobile Already Exists."
                Else
                    strQry = "" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration Where (EmailID='" & VEmailID & "' or MobileNo='" & VMobileNo & "'  or AddharCardNo='" & VAddharCardNo & "' ) and ( AgentType='" & VAgentType & "' ) and ( not RegistrationId='" & VRegistrationId & "' ) "
                    QryMsg = "Record with EmailID or Mobile or AddharCardNo Already Exists."
                End If
                ...
                Dim QryStr As String = "update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration set District='" & VDistrict & "', ActiveStatus='" & VActiveStatus & "', CreditBalnceLimit='" & VCreditBalLimit & "', UploadPanCard='" & VPanCard_Path & "',UploadAddharCard_Front='" & VAddharCardFront_PAth & "',UploadAddharCard_Back='" & VAddharCardBack_Path & "',UploadOtherProof='" & VOtherDocuments_Path & "',UploadPhoto='" & VPhoto_Path & "',UpdatedBy='" & VUpdatedBy & "',UpdatedOn=" & VUpdatedOn & ", AgentType='" & VAgentType & "', AgencyName='" & VAgencyName & "', FirstName='" & VFirstName & "', EmailID='" & VEmailID & "', DOB='" & VDOB & "', AlternateMobileNo='" & VAlternateMobileNo & "', PermanentAddress='" & VPermanentAddress & "', State='" & VState & "', AddharCardNo='" & VAddharCardNo & "', WebSite='" & VWebSite & "',  PanCardNumber='" & VPanCardNumber & "', MobileNo='" & VMobileNo & "', OfficeAddress='" & VOfficeAddress & "', City='" & VCity & "', LastName='" & VLastName & "', Pincode='" & VPincode & "', BusinessType='" & VBusinessType & "', GSTNO='" & VGSTNO & "' where RID=" & lblRID.Text.Trim & " ;"
                QryStr = QryStr & " " & " delete from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_BankDetails where RegistrationId = '" & VRegistrationId & "';"
                If GridView2.Rows.Count > 0 Then
                    For i As Integer = 0 To GridView2.Rows.Count - 1
    ...
    Protected Sub ddlAgentType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlAgentType.SelectedIndexChanged
        Try
            ...
            ElseIf ddlAgentType.SelectedValue.Trim.ToUpper = "Customer".Trim.ToUpper Then
                txtRegistrationId.Text = GV.FL.AddInVar("Customer_Prefix", "" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.AutoNumber") & GV.get_AutoNumber("CustomerID", GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim)
            End If
        Catch ex As Exception
    ...
    Protected Sub ddl_Ref_Code_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddl_Ref_Code.SelectedIndexChanged
        Try
            If ddl_Ref_Code.SelectedIndex = 0 Then
                lblServiceCharge.Text = "0"
            Else
                lblServiceCharge.Text = GV.FL.AddInVar("AmtToDebit", "" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Ref_Code_Master where Ref_Code='" & GV.parseString(ddl_Ref_Code.SelectedValue) & "'")
            End If
        Catch ex As Exception
