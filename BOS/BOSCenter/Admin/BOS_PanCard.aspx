 ...
 <label for="inputEmail3" class="col-sm-3 control-label"> Enter Trans PIN<asp:Label ID="Label6" runat="server" ForeColor="Red" Text="&nbsp;*"></asp:Label></label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                          ...
                          <div class="col-sm-9">
                              <asp:Button ID="btnChangeNo" CssClass="btn btn-warning" Visible="false"  runat="server" Text="Change Number" />
...
<td align="center" bgcolor="Silver"   >&nbsp;</td>
    ...
    <tr>
        ...
        <div  id="DIV_PrintReceipt">        
            ...
            <asp:Label ID="Label22" runat="server" CssClass="mar_lft30" Text="Pancard Type : " ></asp:Label> &nbsp;&nbsp;<asp:Label ID="lblPopPancartType" runat="server"  ForeColor="Blue" Font-Bold="true" ></asp:Label><br />
            <asp:Label ID="Label19" runat="server" CssClass="mar_lft30" Text="Transsaction Amount : " ></asp:Label> &nbsp;&nbsp;<asp:Label ID="lblPopTransationAmt" runat="server"  ForeColor="Blue" Font-Bold="true" ></asp:Label><br />
