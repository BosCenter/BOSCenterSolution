<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="GoToClientAccount.aspx.vb" Inherits="BOSCenter.GoToClientAccount" %>
                                ...
                                <asp:TemplateField ShowHeader="False">
                                  <ItemTemplate>
                                    ...
                                    <%-- <asp:Label ID="lblgrdRID" runat="server" Text='<%# Eval("SrNo") %>' Visible="false" ></asp:Label>--%>
                                          ...
                                          CommandName="Select" Text=""><i class="fa fa-list">&nbsp;Go To Client A/c</i></asp:LinkButton>
                                  </ItemTemplate>
                              </asp:TemplateField>
