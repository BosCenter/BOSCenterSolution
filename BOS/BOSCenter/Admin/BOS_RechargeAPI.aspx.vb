            ...
            ElseIf ddlGateway.SelectedValue.Trim.ToUpper = "Recharge-2".Trim.ToUpper Then
                ...
                If lblSessionFlag.Text = 0 Then
                    ...
                    If GV.FL.DMLQueriesBulk(QryStr) = True Then
                        ...
                        lblPopTransactionAmt.Text = GV.parseString(txtAmt.Text.Trim)
                        lblPopStatus.Text = Vstatus
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                'select Gateway  from BOS_ProductServiceVsAdmin_SA_MD  where Title='Recharge & Bill Payment' and AdminID='cmp1045'
