<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_MoneyTransferTransaction_Report.aspx.vb" Inherits="BOSCenter.BOS_MoneyTransferTransaction_Report" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Money Transation Details"></asp:Label>	
                    </div>
                </div>
            </div>
