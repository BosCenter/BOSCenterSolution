<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_PanCard_Report.aspx.vb" Inherits="BOSCenter.BOS_PanCard_Report" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="log_form_head1">
                            <asp:Label ID="lblHeading" runat="server" Text="Pan Card Report"></asp:Label>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-3">
                                            ...
                                            <asp:DropDownList ID="ddlAmountType" CssClass="form-control inputtext" runat="server" AutoPostBack="true">
                                                ...
                                                <asp:ListItem>E Card</asp:ListItem>
                                                <asp:ListItem>P Card</asp:ListItem>
                                            </asp:DropDownList>
