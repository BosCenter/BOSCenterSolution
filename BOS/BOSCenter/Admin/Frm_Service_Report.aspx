<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="Frm_Service_Report.aspx.vb" Inherits="BOSCenter.Frm_Service_Report" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Search Service Report"></asp:Label>	
                    </div>
                </div>
            </div>
...
<div class="row">
        ...
        <form class="form-horizontal">
                   ...
                   <div class="row">
                      ...
                      <div class="form-group">
                       <div class="col-sm-3">
                        <asp:DropDownList ID="ddlAgentType" runat="server" class='form-control mar_lft10' AutoPostback="true" >
                               <asp:ListItem>Shop Act</asp:ListItem>
<asp:ListItem>Udyam Registration</asp:ListItem>
<asp:ListItem>Food Licence</asp:ListItem>
<asp:ListItem>GST Registration</asp:ListItem>
<asp:ListItem>Passport Sewa</asp:ListItem>
<asp:ListItem>Digital Signature</asp:ListItem>
<asp:ListItem>Voter ID</asp:ListItem>
<asp:ListItem>IT Return</asp:ListItem>
<asp:ListItem>Gazzet</asp:ListItem>
<asp:ListItem>NSDC Form</asp:ListItem>
