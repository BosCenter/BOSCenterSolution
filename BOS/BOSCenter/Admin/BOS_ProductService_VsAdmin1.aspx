<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_ProductService_VsAdmin1.aspx.vb" Inherits="BOSCenter.BOS_ProductService_VsAdmin1" %>
...
<ContentTemplate>
	...
	<div class="row">
        	...
        	<div class="log_form1">
                ...
                <div class="form-group">
                       ...
                       <div class="clearfix" style="margin-bottom:5px;"></div>
                        ...
                        <div class="col-sm-4">
                            <asp:DropDownList ID="ddlContainCategory" cssclass="form-control"  
                        ...
                        <div class="col-sm-5">
                            <asp:DropDownList ID="ddlSlabApplicable" cssclass="form-control"  
                    ...
                    <div class="clearfix" style="margin-bottom:5px;"></div>
                        <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Admin Commission <asp:Label ID="Label4"  ForeColor="Red" runat="server" Text=" *"></asp:Label></label>
                        <div class="col-sm-4">
                            <asp:DropDownList ID="ddl_Admin_CommsissionType" cssclass="form-control"  runat="server" 
                                AutoPostBack="True">
                         ...
                         <div class="col-sm-5">
                            <asp:TextBox ID="txt_Admin_Commission" cssclass="form-control" runat="server"></asp:TextBox>
        ...
        runat="server" Enabled="True" FilterType="Custom" ValidChars=".0123456789" 
                                 TargetControlID="txt_Admin_Commission"> </ajaxToolkit:FilteredTextBoxExtender>
                        </div>
                    </div>
                       <div class="clearfix" style="margin-bottom:5px;"></div>
                      <div class="clearfix" style="margin-bottom:5px;"></div>
                   ...
                   <asp:DropDownList ID="ddlServiceCharge" cssclass="form-control"  runat="server" 
                         ...
                         <div class="col-sm-5">
                            <asp:TextBox ID="txtServiceCharge" cssclass="form-control" runat="server"></asp:TextBox>
                             <ajaxToolkit:FilteredTextBoxExtender ID="txtFilteredCommission1" runat="server"  Enabled="True" FilterType="Custom" ValidChars=".0123456789" TargetControlID="txtServiceCharge"/>
...
<%--
         ...
         <asp:BoundField HeaderText="Admin_Comm_Type" DataField="Admin_CommissionType" />
         <asp:BoundField HeaderText="Admin_Comm" DataField="Admin_Commission" />
