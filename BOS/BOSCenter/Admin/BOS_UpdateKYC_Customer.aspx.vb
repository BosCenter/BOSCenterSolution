...
Public Class BOS_UpdateKYC_Customer
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                '  btnDelete.Enabled = True
                lblformsectionhead3.Text = "KYC Details"
    ...
    Dim VRefrenceID, VRefrenceType, VRef_Code As String
    Private Sub btnPopupYes_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPopupYes.Click
        Try
            ...
            If GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "Master Distributor".Trim.ToUpper Or GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "Distributor".Trim.ToUpper Or GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "Retailer".Trim.ToUpper Or GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "Customer".Trim.ToUpper Then
            Else
                VRefrenceID = "ADMIN"
                VRefrenceType = "ADMIN"
            ...
            ElseIf Session("EditFlag") = 1 Then
                ...
                If GV.FL.DMLQueries(QryStr) = True Then
                    ...
                    lblDialogMsg.Text = "KYC Updated Successfully."
                    lblDialogMsg.CssClass = "Successlabels"
                    btnCancel.Text = "Ok"
                    btnPopupYes.Visible = False
                    ModalPopupExtender1.Show()
