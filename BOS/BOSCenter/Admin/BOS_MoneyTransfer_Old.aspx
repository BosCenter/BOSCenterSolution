<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_MoneyTransfer_Old.aspx.vb" Inherits="BOSCenter.BOS_MoneyTransfer_Old" %>
   ...
   <center>  
    ...
    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <asp:ListItem Value="Money Transfer">MoneyTransferAPI</asp:ListItem>
                            <asp:ListItem Value="Money Transfer-2">MoneyTransferAPI-2</asp:ListItem>
                            </asp:DropDownList> 
...
<div class='row' runat="server" id="Div_AddCustomer" visible="true">
<div class='col-md-12'>
<div class='form-section'>
<div class='form-section-head'>
...
<asp:TextBox ID='txtCustomerName'  runat='server' placeholder=' Enter Customer Name' class='form-control'></asp:TextBox>
</div>
</div>
...
<div class='row' runat="server" id="Div_CustomerDetails" visible="true">
<div class='col-md-12'>
<div class='form-section'>
<div class='form-section-head'>
...
<div class='row' runat="server" id="Div_VerifyOTP" visible="true">
<div class='col-md-12'>
<div class='form-section'>
<div class='form-section-head'>
...
<div class='row' runat="server" id="Div_RecepientDetails" visible="true">
<div class='col-md-12'>
<div class='form-section'>
<div class='form-section-head'>
...
<div class='row' runat="server" id="Div_AddRecepient" visible="true">
<div class='col-md-12'>
<div class='form-section'>
<div class='form-section-head'>
...
<div class="col-md-4">
<div class="form-group">
    <asp:DropDownList ID="ddlSelectBank" runat="server"  class='form-control'> 
    </asp:DropDownList>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtAgentType'>  Mobile No<asp:Label ID="Label12" runat="server" ForeColor="Red" Text="&nbsp;*"></asp:Label></label>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
<asp:TextBox ID='txtRecepientMobileNo'  runat='server' MaxLength="10" class='form-control'></asp:TextBox>
 <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" 
                                runat="server" Enabled="True" FilterType="Numbers" 
                                TargetControlID="txtRecepientMobileNo">
                            </asp:FilteredTextBoxExtender>
...
<div class='row' runat="server" id="Div_TransferAmt" visible="true">
<div class='col-md-12'>
<div class='form-section'>
<div class='form-section-head'>
