...
Public Class Add_Money_EaseBuzz_Handler_Success
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            '  mode: "DC",
            '  status: "success",
            '  ##success/failure/userCancelledunmappedstatus: "NA",
            '  cardCategory: "NA",
            ...
            If Not IsPostBack Then
                'Dim reStatus As String = Request.Form("status").ToString
                'Dim reHash As String = Request.Form("hash").ToString
                'Dim retxnid As String = Request.Form("txnid").ToString
                'Dim remode As String = Request.Form("mode").ToString
                'Dim rawData As NameValueCollection = Request.Form
                'remode = remode
                'txnid
                        ...
                        Try
                            ...
                            If Not GV.FL.RecCount(" " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents Where Amt_Transfer_TransID='" & VAmtTransTransID & "' ") > 0 Then 'Change where condition according to Criteria 
                                ...
                                If GV.FL.DMLQueries(QryStr) = True Then
                                    ...
                                    Dim Service() As String = GV.FL.AddInVar("convert(nvarchar,ServiceCharge)+':'+ServiceType", "" & GV.DefaultDatabase.Trim & ".dbo.BOS_ProductServiceVsAdmin_SA where AdminID='" & GV.get_SuperAdmin_SessionVariables("CompanyCode", Request, Response).Trim & "' and Title='Easebuzz' ").Split(":")
