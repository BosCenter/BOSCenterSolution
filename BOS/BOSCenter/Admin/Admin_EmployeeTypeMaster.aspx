<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="Admin_EmployeeTypeMaster.aspx.vb" Inherits="BOSCenter.Admin_EmployeeTypeMaster" %>
    	...
    	<div class="col-sm-8 col-sm-offset-2">
        	...
        	<div class="log_form1">
                    ...
                    <form class="form-horizontal">
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Enter Employee Type</label>
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtEmployeeTypeName" cssclass="form-control inputtext" runat="server"  ClientIDMode="Static" ></asp:TextBox>
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ControlToValidate="txtEmployeeTypeName" ErrorMessage="Enter Employee Type" CssClass="errorlabels"  
            ...
            <ItemTemplate>
                <%# Container.DataItemIndex + 1%>
                              ...
                              <asp:BoundField HeaderText="Employee Type" DataField="Employee_Type" />
