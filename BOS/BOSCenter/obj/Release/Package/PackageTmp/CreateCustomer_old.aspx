<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="CreateCustomer_old.aspx.vb" Inherits="BOSCenter.CreateCustomer_old" %>
...
<asp:Label ID='formheading3' runat='server' Text='Create Customer'></asp:Label>
</div>
<div class='log_form1'>
...
<asp:TextBox ID='txtRefrenceID' runat='server'  placeholder='RegistrationId' 
        class='form-control' AutoPostBack="True"></asp:TextBox>
<asp:TextBox ID='txtRefrenceType' runat='server' ReadOnly="true" Visible="false"  placeholder='RegistrationId' class='form-control'></asp:TextBox>
</div>
</div>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtAgentName'>  Company Name<asp:Label ID="Label4" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtAgentName'>  Reference Code<asp:Label ID="Label20" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtBusinessType'>  Occupation </label>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtOfficeAddress'>  OfficeAddress (If Any)</label>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtState'>  District</label>
...
<asp:TextBox ID='txtGSTNO' runat='server' Visible="false"  placeholder='GSTNO' class='form-control'></asp:TextBox>
</div>
</div>

</div>
<div class="row mar_top10" id="ddd123" runat="server" visible="false" >
<div class="col-md-4">
<div class="form-group">
<label for='txtWebSite'>  <%--WebSite--%></label>
<asp:TextBox ID='txtWebSite' runat='server'  Visible="false" placeholder='WebSite' class='form-control'></asp:TextBox>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
<label for='txtAddharCardNo'> <%-- Credit Bal Limit--%></label>
<asp:TextBox ID='txtCreditBalLimit' runat='server' Visible="false"   placeholder='Credit Bal Limit' Text="0" class='form-control'></asp:TextBox>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtBusinessType'> <%--Status--%>  </label>
  <asp:DropDownList ID="ddlStatus" runat="server" Visible="false"  class='form-control'>
