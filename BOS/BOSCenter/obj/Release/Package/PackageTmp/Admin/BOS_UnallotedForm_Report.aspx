<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Admin/SuperAdmin.Master"   CodeBehind="BOS_UnallotedForm_Report.aspx.vb" Inherits="BOSCenter.BOS_UnallotedForm_Report" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Unalloted Complaint Report"></asp:Label>	
                    </div>
                </div>
            </div>
                    ...
                    <asp:GridView ID="GridView1" runat="server"  cssclass="grid-view-themeclass"
                          ...
                          <Columns>
                             ...
                             <asp:TemplateField ShowHeader="False">
                              ...
                              <asp:BoundField DataField="kCodeType" HeaderText="kCodeType" />
...
<td colspan="2" align="center" bgcolor="Silver"   >&nbsp;</td>
    ...
    <tr>
        <td colspan="2" align="center" bgcolor="Silver">
            <strong>Udpate Allot Status Dialog</strong>
            <br />
        </td>
    ...
    <tr>
       ...
       &nbsp;&nbsp;</td>
       <td align="right" >
          <asp:DropDownList ID="ddlEmployee" runat="server" CssClass="form-control wid_auto margin-r-5">
           </asp:DropDownList>
       &nbsp; &nbsp; &nbsp;</td>
