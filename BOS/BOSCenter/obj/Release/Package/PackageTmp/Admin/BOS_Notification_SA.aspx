<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_Notification_SA.aspx.vb" Inherits="BOSCenter.BOS_Notification_SA" %>
...
<div class='row'>
<div class='col-md-3' >
<label for='ddlProduct_BrandCode'>  Select Admin <label for='txtProduct_Date' style="color:Red;">  *</label></label>
</div>
<div class='col-md-9'>
<asp:DropDownList ID='ddl_Admin' runat='server' class='form-control'>
</asp:DropDownList>
...
<asp:LinkButton ID='LinkButton2' OnClick='GridView1_SelectedIndexChanged' CssClass='btn btn-primary' runat='server'><i class='fa fa-pencil'></i></asp:LinkButton>
 ...
 <asp:BoundField  HeaderText="SrNo" DataField="SrNo" />
    ...
    <asp:BoundField  HeaderText="Admin" DataField="AgentType" />
