<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="Frm_Passport_Sewa.aspx.vb" Inherits="BOSCenter.Frm_Passport_Sewa" %>
...
<asp:Label ID='formheading_1' runat='server' Text='PASSPORT SEWA'></asp:Label>
</div>
<div class='log_form1'>
...
<asp:Label ID='lblformsectionhead2' runat='server' Text='Passport Details'></asp:Label>
</div>
...
<div class="col-md-3">
<div class="form-group">
<label for='txtApplicantFathersLastName'>  Applicant Fathers Last Name</label>
...
<div class="col-md-3">
<div class="form-group">
<label for='txtApplicantFathersFirstName'>  Applicant Fathers First Name</label>
<asp:TextBox ID='txtApplicantFathersFirstName' runat='server'  class='form-control'></asp:TextBox>
</div>
</div>
<div class="col-md-3">
<div class="form-group">
<label for='txtApplicantFathersMiddleName'>  Applicant Fathers Middle Name</label>
...
<div class="col-md-3">
<div class="form-group">
<label for='txtSOPUSENAME'>  SPOUSE NAME</label>
<asp:TextBox ID='txtSOPUSENAME' runat='server'  class='form-control'></asp:TextBox>
</div>
</div>
</div>
<div class="row mar_top10">
...
<div class="col-md-3">
<div class="form-group">
<label for='txtBuildingName'>  BuildingName</label>
...
<asp:FilteredTextBoxExtender ID="txtPin_FilteredTextBoxExtender1" 
