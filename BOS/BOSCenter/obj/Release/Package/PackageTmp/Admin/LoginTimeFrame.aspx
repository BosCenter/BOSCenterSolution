<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Admin/SuperAdmin.Master"   CodeBehind="LoginTimeFrame.aspx.vb" Inherits="BOSCenter.LoginTimeFrame" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                    	&nbsp;Set Login Timeframe of Employees
                    </div>
                </div>
            </div>
                    ...
                    <asp:GridView ID="GridView1" runat="server"  cssclass="grid-view-themeclass"
                          ...
                          <Columns>
                             ...
                             <asp:TemplateField ShowHeader="False">
                              ...
                              <asp:BoundField DataField="User_Name" HeaderText="Operator Name" />
                              <asp:BoundField DataField="User_Type" HeaderText="Group" />
