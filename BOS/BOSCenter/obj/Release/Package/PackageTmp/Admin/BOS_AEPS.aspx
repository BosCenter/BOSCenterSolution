<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_AEPS.aspx.vb" Inherits="BOSCenter.BOS_AEPS" %>
...
<asp:Label ID="lblAgentType" runat="server" Visible="False"></asp:Label>
 ...
 <asp:LinkButton ID="lnkbtn_StartAEPS" cssclass="btn btn-danger mar_top10"  runat="server">START AEPS</asp:LinkButton>
 <br /><br />
