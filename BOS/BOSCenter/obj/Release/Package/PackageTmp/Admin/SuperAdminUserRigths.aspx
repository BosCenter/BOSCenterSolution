<%@ Page Title="" Language="vb" AutoEventWireup="false"  MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="SuperAdminUserRigths.aspx.vb" Inherits="BOSCenter.SuperAdminUserRigths" %>
 ...
 <div class="col-sm-12">
                      ...
                      <div class="form-group">
                       ...
                       <label>Select Module</label>
                        ...
                        <asp:ListBox ID="lstModules" runat="server"  CssClass="form-control"
                              Height="440px" AutoPostBack="True"  Font-Bold="True" 
                               Font-Size="12pt" >
                           </asp:ListBox>
     ...
     <div class="col-sm-9">
        ...
        <Columns>
             ...
             <asp:Button ID="DeleteAll"  CommandName="btnDeleteAll" CssClass="btn btn-primary mar_top10"  Text="ALL" runat="server" /><br>
                ...
                <ItemTemplate>
                    <asp:CheckBox ID="chkDelete" runat="server" CssClass="mar_top10" Checked='<%# Bind("CanDelete") %>' 
                        Enabled="true" />
                          <asp:Label ID="lblCreateLink" runat="server" Text='<%# Eval("CreateLink") %>' Visible="false" ></asp:Label>
                </ItemTemplate>
                <ControlStyle Width="70px" />
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
            ...
            <asp:BoundField DataField="Searching_Keyword" HeaderText="SearchKeyword" />
        </Columns>
    </asp:GridView>
                    </div>
                                </div>
