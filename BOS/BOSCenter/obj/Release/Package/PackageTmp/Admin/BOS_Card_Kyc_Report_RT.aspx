<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Admin/SuperAdmin.Master"   CodeBehind="BOS_Card_Kyc_Report_RT.aspx.vb" Inherits="BOSCenter.BOS_Card_Kyc_Report_RT" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Card KYC Report - Retailer"></asp:Label>	
                    </div>
                </div>
            </div>
         ...
         <div class="row">
                      ...
                      <div class="col-sm-4">
                          <asp:CheckBox ID="chkduration" runat="server" 
                              Text="&nbsp;Apply Request Date" AutoPostBack="True" />
                   ...
                   <div class="row">               
                      <div class="form-group">
                       <div class="col-sm-3">
                       <asp:DropDownList ID="ddlApproveStatus" cssclass="form-control"   runat="server"  visible="false">
                      ...
                      <label for="inputEmail3" class="col-sm-1 control-label" style="padding-right: 14px;"> Criteria</label>
                        <div class="col-sm-3">
                          <asp:DropDownList ID="ddlSelectCriteria" cssclass="form-control"  runat="server" >
                                ...
                                <asp:ListItem>Registration ID</asp:ListItem>
        ...
        <div class="col-md-12" >
                 ...
                 <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridView1" runat="server"  cssclass="grid-view-themeclass"
                            BorderStyle="None" AllowPaging="True" AutoGenerateColumns="False" ShowFooter="true" >
...
<asp:TemplateField ShowHeader="False">
                                  <ItemTemplate>
                                     ...
                                     <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CssClass="btn btn-primary" OnClick="UpdateDetails_Click"
                                          CommandName="Select" Text="">Print</asp:LinkButton>
                                  </ItemTemplate>
                              </asp:TemplateField>
                              ...
                              <asp:BoundField DataField="AadharNumber" HeaderText="AadharNumber" />
                              <asp:BoundField DataField="CardNumber" HeaderText="CardNumber" />
                              <asp:BoundField DataField="RefNo" HeaderText="RefNo" />
                                <asp:TemplateField ShowHeader="true" HeaderText="Aadhar Front">
                                  <ItemTemplate>
                                       <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                <asp:Label ID="lbl_AF_Attachment" runat="server" Text='<%# Eval("UploadAddharCard_Front") %>' Visible="false" ></asp:Label> 
                                                <asp:LinkButton ID="lnk_AF_dwnload" runat="server" CausesValidation="False" CssClass="btn btn-primary"  OnClick="DownloadRow_click_AF" Text=""><i class=" fa fa-download">&nbsp;Download</i></asp:LinkButton>
                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:PostBackTrigger ControlID="lnk_AF_dwnload" />
                                            </Triggers>
                                         </asp:UpdatePanel>
                                     </ItemTemplate>
                              </asp:TemplateField>
                                <asp:TemplateField ShowHeader="true" HeaderText="Aadhar Back">
                                  <ItemTemplate>
                                       <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            <ContentTemplate>
                                                <asp:Label ID="lbl_AB_Attachment" runat="server" Text='<%# Eval("UploadAddharCard_Back") %>' Visible="false" ></asp:Label> 
                                                <asp:LinkButton ID="lnk_AB_dwnload" runat="server" CausesValidation="False" CssClass="btn btn-primary"  OnClick="DownloadRow_click_AB" Text=""><i class=" fa fa-download">&nbsp;Download</i></asp:LinkButton>
                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:PostBackTrigger ControlID="lnk_AB_dwnload" />
                                            </Triggers>
                                         </asp:UpdatePanel>
                                     </ItemTemplate>
                              </asp:TemplateField>
                               <asp:TemplateField ShowHeader="true" HeaderText="Phote">
                                  <ItemTemplate>
                                       <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                            <ContentTemplate>
                                                   <asp:Label ID="lbl_PH_Attachment" runat="server" Text='<%# Eval("UploadPhoto") %>' Visible="false" ></asp:Label> 
                                                <asp:LinkButton ID="lnk_PH_dwnload" runat="server" CausesValidation="False" CssClass="btn btn-primary"  OnClick="DownloadRow_click_PH" Text=""><i class=" fa fa-download">&nbsp;Download</i></asp:LinkButton>
                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:PostBackTrigger ControlID="lnk_PH_dwnload" />
                                            </Triggers>
                                         </asp:UpdatePanel>
                                     </ItemTemplate>
                              </asp:TemplateField>
