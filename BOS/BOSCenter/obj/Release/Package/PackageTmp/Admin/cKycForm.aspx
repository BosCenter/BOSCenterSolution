<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="cKycForm.aspx.vb" Inherits="BOSCenter.cKycForm" %>
...
<%--<div class='log_form_head1'></div>--%>
<asp:Label ID='formheading_1' runat='server' Text='Card KYC Form' Visible="false"></asp:Label>
...
<asp:Label ID='lblformsectionhead4' runat='server' Text='Customer KYC Details'></asp:Label>
</div>
...
<div class="col-md-3">
<div class="form-group">
<label for='txtPassword'>  First Name<span style="color:red;">*</span></label>
<asp:TextBox ID='txtFirstName' runat='server'  class='form-control'></asp:TextBox>
</div>
</div>
<div class="col-md-3">
<div class="form-group">
<label for='txtRegistrationDate'>  Middle Name<label style="color:red;"></label> </label>
...
<div class='col-md-6'>
<div class='form-group'>
<label for='lblEmailID'>  Address<span style="color:red;">*</span></label>
<asp:TextBox ID='txtAddress' runat='server'  class='form-control'></asp:TextBox>
</div>
</div>
<div class='col-md-6'>
<div class='form-group'>
<label for='lblMobileNo'>  Phone No<span style="color:red;">*</span></label>
...
<div class='col-md-6'>
<div class='form-group'>
<label for='txtResidenceNo'>  Aadhar Number<span style="color:red;">*</span></label>
...
<div class='col-md-6'>
<div class='form-group'>
<label for='txtAddress'>  OTP Number</label>
<asp:TextBox ID='txtCardNo' runat='server'  class='form-control'  MaxLength="14"></asp:TextBox>
</div>
</div>
</div>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtSignatureUpload'>  Finger Print Upload<label style="color:red;">*</label> <asp:Label 
...
<%--<asp:FileUpload ID="FileUpload1" runat="server"  />--%>
 <div style="margin-bottom:5px;"></div>
    ...
    <div style="margin-bottom:5px;"></div>
     ...
     <asp:Button ID="btnCapture" runat="server" Text="Capture"   ValidationGroup="a"  OnClientClick="return Capture();" style="color:black;"  />&nbsp;  
    &nbsp;<asp:Button ID="btnremove" runat="server"   Text="Remove" style="color:black;" />
