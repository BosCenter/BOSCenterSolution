<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_GST_TDS_Report.aspx.vb" Inherits="BOSCenter.BOS_GST_TDS_Report" %>
...
<div class="row">
        ...
        <form class="form-horizontal">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                          <asp:RadioButton ID="rdbDatewise" Text="Datewise" GroupName="x"  runat="server" 
                              AutoPostBack="True" /> &nbsp; <asp:RadioButton ID="rdbMonthwise" 
                              GroupName="x" Text="Monthwise"   runat="server" AutoPostBack="True" />
