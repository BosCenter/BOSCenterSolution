...
Public Class PaysprintInstaCallbkController
    ...
    Public Function PostData(<FromBody()> ByVal data As JObject) As ResponseData
        Try
            Dim v_API_Response, v_event, status, response_code, txnstatus, message, ackno, amount,
            refid, ttype, api_type, upi_txn_id, txn_completion_date, customer_virtual_address, customer_mobile_number, customer_account_name As String
            ...
            Dim Str As String = "insert into BosCenter_DB.dbo.InstaCollectCallBack(API_Response,RecordDatetime) values('" & data.ToString() & "',getdate())"
            executeDMLQuery(Str)
            'v_AdminID = ""
            'v_AgentID = ""
            'v_AgentType = ""
