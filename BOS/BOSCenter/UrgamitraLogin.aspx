<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UrgamitraLogin.aspx.vb" Inherits="BOSCenter.UrgamitraLogin" %>
...
<body id="top">
    ...
    <!-- Login 2 start -->
    <div class="login-2" style="position: relative;">
        <a href="UrjamitraB2B_login.aspx" id="btn-class" style="position: absolute; top: 10px; right: 10px; z-index: 5;
       padding: 5px 12px; text-decoration: none; border-radius: 15px; color: white; border: 1px solid white;
       ">B2B Login</a>
        <div class="container">
