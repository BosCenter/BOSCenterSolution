...
Public Class create_custome1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                txtAgentType.Text = "Customer"

                txtAgentType.CssClass = "form-control"
                txtRefrenceID.Text = ""
                ...
                txtAgentType_TextChanged(sender, e)
    ...
    Protected Sub txtAgentType_TextChanged(sender As Object, e As EventArgs) Handles txtAgentType.TextChanged
        Try

            If txtAgentType.Text.Trim.ToUpper = "Master Distributor".Trim.ToUpper Then
            ...
            ElseIf txtAgentType.Text.Trim.ToUpper = "Distributor".Trim.ToUpper Then
            ...
            ElseIf txtAgentType.Text.Trim.ToUpper = "Retailer".Trim.ToUpper Then
            ...
            ElseIf txtAgentType.Text.Trim.ToUpper = "Customer".Trim.ToUpper Then
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            End If
            If txtAgentType.Text.Trim.ToUpper = "Customer".Trim.ToUpper Then
            ...
            If VAddharCardNo.Trim = "" Then
                strQry = "" & txtDBName.Text.Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration Where ( MobileNo='" & GV.parseString(txtMobileNo.Text) & "') and ( AgentType='" & txtAgentType.Text & "' ) "
    ...
    Private Sub btnPopupYes_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPopupYes.Click
        Try
            ...
            lblError.Text = ""
            lblError.CssClass = ""
            VAgentType = GV.parseString(txtAgentType.Text.Trim)
