<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_ChangePinNumber.aspx.vb" Inherits="BOSCenter.BOS_ChangePinNumber" %>
        	...
        	<div class="log_form1">
                   ...
                   <form class="form-horizontal">
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Old Pin No</label>
                        <div class="col-sm-5">
                            <asp:TextBox ID="txtOldPassword" cssclass="form-control" runat="server"  MaxLength="4"
                      ...
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">New Pin No</label>
                        <div class="col-sm-5">
                            <asp:TextBox ID="txtNewPassword" cssclass="form-control" runat="server" MaxLength="4" 
                                TextMode="Password"  ></asp:TextBox>
                          ...
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="btnchpwd"
                                    ControlToValidate="txtNewPassword" ErrorMessage="Enter New Pin No" 
                                     CssClass="errorlabels-sm"></asp:RequiredFieldValidator> 
                          
                      </div>
                      <div class="clearfix" style="margin-bottom:5px;"></div>
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Confirm Pin No</label>
                        <div class="col-sm-5">
                            <asp:TextBox ID="txtConfirmPassword"  cssclass="form-control" runat="server"  MaxLength="4"
                                TextMode="Password"></asp:TextBox>
                            
                            </div>
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="btnchpwd"
                                    ControlToValidate="txtConfirmPassword" ErrorMessage="Enter Confirm Pin No" 
                                      CssClass="errorlabels-sm"></asp:RequiredFieldValidator>  
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                          ...
                          <div class="col-sm-9">
                           <asp:Button ID="btnChangePassword" runat="server" ValidationGroup="btnchpwd" Text="Change PinNo" CausesValidation="true" 
