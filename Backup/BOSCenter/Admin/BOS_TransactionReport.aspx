<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_TransactionReport.aspx.vb" Inherits="BOSCenter.BOS_TransactionReport" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Transaction Report"></asp:Label>	
                    </div>
                </div>
            </div>
...
<div class="row">
        ...
        <form class="form-horizontal">
                   ...
                   <div class="row">
                      ...
                      <div class="form-group">
                              <label for="inputEmail3" class="col-sm-1 control-label" style="padding-right: 14px;">&nbsp;</label>
                      <div class="col-sm-3">
                        <asp:DropDownList ID="ddlSelect" runat="server" class='form-control' AutoPostBack="True">
                        <asp:ListItem>Not Applicable</asp:ListItem>
                        <asp:ListItem>Master Distributor Wise</asp:ListItem>
...
<div class="col-sm-12 ExportPanel">
        ...
        <ContentTemplate>
            ...
            &nbsp;
                ...
                <label for="inputEmail3" class="col-sm-1 control-label" style="padding-right: 14px;"> ClosingBal</label>
                     <div class="col-lg-2">
                  <asp:Label ID="lblClosingBal" CssClass="pull-right" runat="server" Text="0"></asp:Label>&nbsp;
                </div>
                    </div>
