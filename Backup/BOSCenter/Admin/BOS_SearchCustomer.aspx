<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_SearchCustomer.aspx.vb" Inherits="BOSCenter.BOS_SearchCustomer" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Search & Edit Customer"></asp:Label>	
                    </div>
                </div>
            </div>
