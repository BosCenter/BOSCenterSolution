...
Public Class BOS_ClosedComplaint_Report
    ...
    Public Sub Bind()
        Try
            ...
            End If
            Querystring = "select RID as SrNo,(CONVERT(VARCHAR(11),ComplaintDate,106)) as ComplaintDate,ComplaintID,kCode,kCodeType,Product,(Problem+'/'+Complaint) as ComplaintProblem,isnull(Attachment,'') as Attachment,ComplaintStatus,AllotedTo,(CONVERT(VARCHAR(11),AllotedDateTime,106)) as AllotedDateTime,Remarks,(CONVERT(VARCHAR(11),ClosedDateTime,106)) as ClosedDateTime,ClosedBy from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Complaint_Master where ComplaintStatus='Closed' " & GROUPFilter & " " & Filter & " order by RID Desc"
            ...
            If Not Querystring = "" Then
                ...
                If GridView1.Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To GridView1.Rows.Count - 1
                        ...
                        If Not GV.FL.RecCount("" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Complaint_Master_Chat where ComplaintID='" & GV.parseString(GridView1.Rows(i).Cells(2).Text) & "'") > 0 Then
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        Try
            If Not lblRID.Text = "" Then
                ...
                str = ("update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Complaint_Master set AllotedTo='" & GV.parseString(ddlEmployee.SelectedValue.Trim) & "',AllotedDateTime=getdate() where RID=" & GV.parseString(lblRID.Text) & " ")
