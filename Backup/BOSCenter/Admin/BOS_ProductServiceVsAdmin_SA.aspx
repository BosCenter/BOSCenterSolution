<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_ProductServiceVsAdmin_SA.aspx.vb" Inherits="BOSCenter.BOS_ProductServiceVsAdmin_SA" %>
...
<ContentTemplate>
	...
	<div class="row">
        	...
        	<div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                    	Service/API Vs Admin Commission
                    </div>
                </div>
            </div>
        	<div class="log_form1">
        ...
        runat="server" Enabled="True" FilterType="Custom" ValidChars=".0123456789" 
                                 TargetControlID="txt_Admin_Commission">
