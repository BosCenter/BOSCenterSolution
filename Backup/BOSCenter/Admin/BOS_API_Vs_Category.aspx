<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_API_Vs_Category.aspx.vb" Inherits="BOSCenter.BOS_API_Vs_Category" %>
...
<div class ="row">
 <div class="form-group">
                       ...
                       <div class="clearfix" style="margin-bottom:5px;"></div>
                        ...
                        <div class="col-sm-9">
                         <asp:DropDownList ID="ddlContainCategory" cssclass="form-control"  runat="server">
                       ...
                       <div class="clearfix" style="margin-bottom:5px;"></div>
                        <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Can Change Downwards</label>
                        <div class="col-sm-9">
                          <asp:DropDownList ID="ddlCanChangeDownwards" CssClass="form-control" runat="server">
                    ...
                    <div class="clearfix"></div>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false"  cssclass="grid-view-themeclass"
                          ...
                          <Columns>
                              ...
                              <asp:BoundField HeaderText="ProductService" DataField="ProductService" />
