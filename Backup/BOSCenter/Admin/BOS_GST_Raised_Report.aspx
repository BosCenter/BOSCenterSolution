<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Admin/SuperAdmin.Master"   CodeBehind="BOS_GST_Raised_Report.aspx.vb" Inherits="BOSCenter.BOS_GST_Raised_Report" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="GST Raised Request Report"></asp:Label>	
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12" >
                 ...
                 <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridView1" runat="server"  cssclass="grid-view-themeclass"
                            BorderStyle="None" AllowPaging="True" AutoGenerateColumns="true"  ShowFooter="true" >
