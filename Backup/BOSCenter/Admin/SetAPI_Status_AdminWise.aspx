<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Admin/SuperAdmin.Master"   CodeBehind="SetAPI_Status_AdminWise.aspx.vb" Inherits="BOSCenter.SetAPI_Status_AdminWise" %>
     ...
     <div class="col-md-12" >
                 ...
                 <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridView1" runat="server"  cssclass="grid-view-themeclass"
                            BorderStyle="None" PageSize="1000000"  AutoGenerateColumns="False"  >
                          ...
                          <Columns>
                             ...
                             <asp:BoundField HeaderText="DatabaseName" DataField="DatabaseName" />                               
                            ...
                            <asp:TemplateField ShowHeader="true" HeaderText="RechargeAPI">
                               ...
                               <asp:TemplateField ShowHeader="true" HeaderText="RechargeAPI2">
                                  <ItemTemplate>    
                                        <asp:LinkButton ID="lnk_RechargeAPI_2" runat="server" CausesValidation="False" CssClass="btn btn-primary mar_top10" OnClick="lnk_RechargeAPI_2_GridView_Click"
                                          CommandName="Select" Text='<%# Eval("RechargeAPI2") %>'></asp:LinkButton>
                                  </ItemTemplate>
                              </asp:TemplateField>
                                ...
                                <asp:TemplateField ShowHeader="true" HeaderText="MoneyTransferAPI2">
                                  <ItemTemplate>                                                                         
                                        <asp:LinkButton ID="lnk_MoneyTransferAPI_2" runat="server" CausesValidation="False" CssClass="btn btn-primary mar_top10 " OnClick="lnk_MoneyTransferAPI_2_GridView_Click"
                                          CommandName="Select" Text='<%# Eval("MoneyTransferAPI2") %>'></asp:LinkButton>
                                  </ItemTemplate>
                              </asp:TemplateField>
                             ...
                             <asp:TemplateField ShowHeader="true" HeaderText="AEPS_API">
                              ...
                              <asp:TemplateField ShowHeader="true" HeaderText="HoldAmt">
                               ...
                               <asp:TemplateField ShowHeader="true" HeaderText="HoldAmtRemarks">
                                  <ItemTemplate>  
                                      <asp:TextBox ID="txtHoldAmtRemarks" runat="server" Text='<%# Eval("HoldAmtRemarks") %>' Width="250px" TextMode="MultiLine" Rows="3" CssClass="form-control mar_top5" AutoPostBack="true"   OnTextChanged="txt_HoldAmtRemarks_GridView_TextChanged"></asp:TextBox>                                                                  
                                  </ItemTemplate>
                              </asp:TemplateField>
                          </Columns>
...
<td colspan="2" align="center" bgcolor="Silver"   >&nbsp;</td>
    ...
    <tr style="margin-top:10px">
       ...
       <tr >
        ...
        <td align="right" style="width:180px">
          ...
          <asp:Label ID="Label5" runat="server" Text="RechargeAPI-2"></asp:Label> 
       &nbsp;&nbsp;</td>
       <td align="left">
           
             <asp:DropDownList ID="ddlRechargeAPI_Status_2" Width="60%" style="margin-top:10px"   runat="server" >
               <asp:ListItem>Active</asp:ListItem>
               <asp:ListItem>Inactive</asp:ListItem>
           </asp:DropDownList>
       &nbsp;</td>
    ...
    <tr>
       ...
       <td align="left">
           ...
           <asp:TextBox ID="txtHoldAmt" runat="server" style="margin-top:10px"  
