...
Public Class CLientRegistration
    ...
    Protected Sub btnsaveOk_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveOk.Click
        Try
            ...
            End If
            Dim Encrypted_Pass As String = GV.convertToHashMD5(vClientPassword.Trim)
                ...
                If lblSessionFlag.Text = 0 Then
                    ...
                    Else
                        ...
                        If ddlCreateDatabase.SelectedValue.Trim.ToUpper = "No".ToUpper Then
                            ...
                            'Sapna
                            qry = qry & "  " & " insert into BOS_ClientRegistration (Encrypted_Pass,HoldAmt,AEPS_API_Status,RechargeAPI_Status,MoneyTransferAPI_Status,PANCardAPI_Status,CreditBalnceLimit,WebRedirectUrl,RegisterationDate,CompanyCode,CompanyName,CompanyHead,ContactPerson,Companylogo,Address_1,Address_2,Address_3,PinCode,State,District,City,Country,PhoneNo_1,PhoneNo_2,Mobile_No,Email_ID,TinNo,CinNo,GSTNo,Status,ClientPassword,LastLogin,ClientRole,IsNewDatabase,DatabaseName,ChangeTheme,Record_DateTime,EmpCode,UpdatedBy,UpdatedOn) values('" & Encrypted_Pass & "',0,'" & APIStatus & "','" & APIStatus & "','" & APIStatus & "','" & APIStatus & "', '" & VCreditBalLimit & "', '" & VWebRedirectUrl & "', '" & VRegisterationDate & "','" & VCompanyCode & "','" & VCompanyName & "','" & VCompanyHead & "','" & VContactPerson & "','" & VCompanylogo & "','" & VAddress_1 & "','" & VAddress_2 & "','" & VAddress_3 & "','" & VPinCode & "','" & VState & "','" & VDistrict & "','" & VCity & "','" & VCountry & "','" & VPhoneNo_1 & "','" & VPhoneNo_2 & "','" & VMobile_No & "','" & VEmail_ID & "','" & VTinNo & "','" & VCinNo & "','" & VGSTNo & "','" & VStatus & "','" & vClientPassword & "','" & VLastLogin & "','" & VClientRole & "','" & VIsNewDatabase & "','" & VDatabaseName & "','" & VChangeTheme & "',getdate(),'" & VEmpCode & "','" & VUpdatedBy & "',getdate() );"
                        ...
                        If result = True Then
                            ...
                            Div_deInfo.Visible = True
                            lblPassword.Text = " " & vClientPassword
