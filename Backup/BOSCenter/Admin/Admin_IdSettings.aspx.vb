                ...
                If Not DS Is Nothing Then
                    If DS.Tables.Count > 0 Then
                        If DS.Tables(0).Rows.Count > 0 Then
                            ...
                            If Not IsDBNull(DS.Tables(0).Rows(0).Item("Sub_DistributorID")) Then
                                If Not DS.Tables(0).Rows(0).Item("Sub_DistributorID").ToString() = "" Then
                                    txtSubDistributorID.Text = GV.parseString(DS.Tables(0).Rows(0).Item("Sub_DistributorID").ToString())
                                Else
            ...
            If Not lnkbtn Is Nothing Then
                If Not lnkbtn.CommandArgument.Trim = "" Then
                    ...
                    ElseIf lbllnkbtn.Text.Trim.ToUpper = "SubDistributorID".ToUpper Then
                        ...
                        Name = "Distributor ID"
                        strcol = " Sub_DistributorID='" & Sub_DistributorID & "' "
                    End If
