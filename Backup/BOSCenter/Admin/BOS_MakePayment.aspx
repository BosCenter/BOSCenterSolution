...
<div class = "col-sm-9">
    <asp:RadioButton ID="rdbCash" runat="server" GroupName="a" Text="Cash" AutoPostBack ="true"/>
    <asp:RadioButton ID="rdbCheque" runat="server" GroupName="a" Text="Online Payment" AutoPostBack ="true" />
    <asp:RadioButton ID="rdbNetBanking" runat="server" GroupName="a" Text="Net Banking" AutoPostBack ="true"/>
    <asp:RadioButton ID="rdbATMTransfer" runat="server" GroupName="a" Text="ATM Transfer" AutoPostBack ="true"/>
    <asp:RadioButton ID="rdbPosMachine" runat="server" GroupName="a" Text="POS Machine" AutoPostBack ="true"/>
...
<div class ="col-sm-3">
    <asp:Label ID="lblbranchcode" CssClass="text-bold" runat="server" Text="Branch Code:"></asp:Label>
</div>
<div class ="col-sm-4">
