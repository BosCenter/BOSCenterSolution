        ...
        Try
            ...
            If GridView1.Rows.Count > 0 Then
                ...
                For i As Integer = 0 To GridView1.Rows.Count - 1
                    If Not GV.parseString(GridView1.Rows(i).Cells(3).Text.Trim) = "" Then

                        If oldval = "" Then
                            oldval = GV.parseString(GridView1.Rows(i).Cells(3).Text.Trim)
                        End If

                        If GridView1.Rows(i).Cells(3).Text.Trim = oldval Then
    ...
    Protected Sub ddlCompany_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlCompany.SelectedIndexChanged
        Try
            ...
            If Not lblDatabaseName.Text.Trim = "" Then
                Session("Dyanamic") = "No"
                fillGrid("Select *,'0' as CanshowServices, '0' as CanshowButton from " & GV.DefaultDatabase.Trim & ".dbo.CRM_DyanamicServices_Dashboard   order by OrderNo  asc")
            ...
            If GV.FL.RecCount(" " & lblDatabaseName.Text.Trim & ".dbo.CRM_DyanamicServices_Rights_Dashboard where CompanyCode='" & VCompanyCode & "'") > 0 Then
                ...
                LocalDS = GV.FL.OpenDs(" " & lblDatabaseName.Text.Trim & ".dbo.CRM_DyanamicServices_Rights_Dashboard where CompanyCode='" & VCompanyCode & "' and CanshowServices='1'  order by OrderNo asc")
                Dim chk As CheckBox
                For i As Integer = 0 To LocalDS.Tables(0).Rows.Count - 1
                    For j As Integer = 0 To GridView1.Rows.Count - 1

                        If (GV.parseString(LocalDS.Tables(0).Rows(i).Item("ServiceName").ToString.Trim).ToUpper() = GV.parseString(GridView1.Rows(j).Cells(3).Text.Trim).ToUpper()) Then
    ...
    Protected Sub btnsaveOk_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveOk.Click
        Try
            ...
            For i As Integer = 0 To GridView1.Rows.Count - 1
                ...
                Dim servicename As String = GV.parseString(GridView1.Rows(i).Cells(3).Text.Trim)
