<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Admin/SuperAdmin.Master"   CodeBehind="BOS_BankDetails.aspx.vb" Inherits="BOSCenter.BOS_BankDetails" %>
                 ...
                 <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridView1" runat="server"  cssclass="grid-view-themeclass"
                          ...
                          <Columns>
                              ...
                              <asp:BoundField DataField="PanNo" HeaderText="ServiceCharge" />
