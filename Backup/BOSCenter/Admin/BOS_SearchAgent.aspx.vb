...
Public Class BOS_SearchAgent
        ...
        Try
            If Not IsPostBack Then
                ...
                ElseIf GV.get_SuperAdmin_SessionVariables("Group", Request, Response) = "Distributor" Then
                    ...
                    ddlAgentType.CssClass = "form-control"
                Else
                    lblHeading.Text = "Search & Edit Master Distributor"
        ...
        Try
            ...
            If chkduration.Checked = True Then
                ...
                Else
                    RefrenceId = ""
                End If
                Querystring = "select RID as SrNo,RegistrationId,(CONVERT(VARCHAR(11),RegistrationDate,106)) as RegistrationDate,AgencyName	,(FirstName+ ' ' +LastName) as Name,MobileNo	,BusinessType	,PanCardNumber,	OfficeAddress,State,ActiveStatus,UploadPanCard=Replace(UploadPanCard,'~','https://www.boscenter.in'),UploadAddharCard_Front=Replace(UploadAddharCard_Front,'~','https://www.boscenter.in'),UploadAddharCard_Back=Replace(UploadAddharCard_Back,'~','https://www.boscenter.in'),UploadOtherProof=Replace(UploadOtherProof,'~','https://www.boscenter.in'),UploadPhoto=Replace(UploadPhoto,'~','https://www.boscenter.in'),UploadSelfyWithDoc=Replace(UploadSelfyWithDoc,'~','https://www.boscenter.in'),UploadSignature=Replace(UploadSignature,'~','https://www.boscenter.in') from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration b where RegistrationDate between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & "' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & "' " & colName & "  " & SearchColumnName & "  " & RefrenceId & "  order by  RID Desc"
            ...
            Else
                ...
                Else
                    RefrenceId = ""
                End If
                Querystring = "select RID as SrNo,RegistrationId,(CONVERT(VARCHAR(11),RegistrationDate,106)) as RegistrationDate,AgencyName	,(FirstName+ ' ' +LastName) as Name,MobileNo	,BusinessType	,PanCardNumber,	OfficeAddress,State,ActiveStatus,UploadPanCard=Replace(UploadPanCard,'~','https://www.boscenter.in'),UploadAddharCard_Front=Replace(UploadAddharCard_Front,'~','https://www.boscenter.in'),UploadAddharCard_Back=Replace(UploadAddharCard_Back,'~','https://www.boscenter.in'),UploadOtherProof=Replace(UploadOtherProof,'~','https://www.boscenter.in'),UploadPhoto=Replace(UploadPhoto,'~','https://www.boscenter.in'),UploadSelfyWithDoc=Replace(UploadSelfyWithDoc,'~','https://www.boscenter.in'),UploadSignature=Replace(UploadSignature,'~','https://www.boscenter.in')  from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration b  " & SearchColumnName & "  " & colName & " " & RefrenceId & " " & branchFilter & "  order by  RID Desc"
            End If
            ...
            If Not Querystring = "" Then
                ...
                If GridView1.Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To GridView1.Rows.Count - 1
                        ...
                        Dim activeSta As String = GV.parseString(GridView1.Rows(i).Cells(11).Text)
                        ...
                        If group1.Trim.ToUpper = "Retailer".Trim.ToUpper Then

                        ElseIf group1.Trim.ToUpper = "Master Distributor".Trim.ToUpper Or group1.Trim.ToUpper = "Distributor".Trim.ToUpper Then

                        ElseIf group1.Trim.ToUpper = "Admin".Trim.ToUpper Or group1.Trim.ToUpper = "Super Admin".Trim.ToUpper Then
    ...
    Protected Sub btnGrdActiveStatus_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            Dim gvrow As GridViewRow = DirectCast(btndetails.NamingContainer, GridViewRow)
            lblRID.Text = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(2).Text)
            Dim activeSta As String = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(11).Text)
    ...
    Protected Sub ImagebtnExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImagebtnExcel.Click
        Try
            If Not lblExportQry.Text = "" Then
                If GridView1.Rows.Count > 0 Then
                    GV.ExportToExcel_New(GridView1, Response, "", "AgentDetails", lblExportQry.Text, "dyanamic")
                End If
            End If
    ...
    Protected Sub ImagebtnWOrd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImagebtnWOrd.Click
        Try
            If Not lblExportQry.Text = "" Then
                If GridView1.Rows.Count > 0 Then
                    GV.ExportToWord_New(GridView1, Response, "AgentDetails", lblExportQry.Text, "dyanamic")
                End If
            End If
        Catch ex As Exception
    ...
    Protected Sub ExportToPdf_DivTag_HavingGridview(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles Imagepdf.Click
        Try
            If Not lblExportQry.Text = "" Then
                If GridView1.Rows.Count > 0 Then
                    GV.ExportToPdf_New(GridView1, "", Response, "AgentDetails  ", lblExportQry.Text, "dyanamic")
                End If
            End If
        Catch ex As Exception
