<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="SuperAdmin_ProfileMaster.aspx.vb" Inherits="BOSCenter.SuperAdmin_ProfileMaster" %>
        	...
        	<div class="log_form1">
                    ...
                    <form class="form-horizontal">
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Enter Profile</label>
                        <div class="col-sm-9">
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ControlToValidate="txtCountryName" ErrorMessage="Enter Profile" CssClass="errorlabels"  
