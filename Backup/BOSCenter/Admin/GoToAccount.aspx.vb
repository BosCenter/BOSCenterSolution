        ...
        Try
            ...
            If group.Trim.ToUpper = "Super Admin".ToUpper Then
                If ddlSelectCriteria.SelectedValue = "All Records" Then
                    ...
                    Querystring = "select '0' as 'SrNo',CompanyName,CompanyCode,ClientPassword as 'Password',CinNo,GSTNo,Status as 'Account Status',DatabaseName,ClientPin as 'Pin','0' as 'APIBalance' from " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration  order by  rid Desc"
                ElseIf ddlSelectCriteria.SelectedValue = "Name" Then
                    Querystring = "select '0' as 'SrNo',CompanyName,CompanyCode,ClientPassword as 'Password',CinNo,GSTNo,Status as 'Account Status',DatabaseName,ClientPin as 'Pin','0' as 'APIBalance' from " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration Where CompanyName  like '" & GV.parseString(txtSearchString.Text.Trim) & "%' order by  rid Desc"
                ElseIf ddlSelectCriteria.SelectedValue = "Login ID" Then
                    Querystring = "select '0' as 'SrNo',CompanyName,CompanyCode,ClientPassword as 'Password',CinNo,GSTNo,Status as 'Account Status',DatabaseName,ClientPin as 'Pin','0' as 'APIBalance' from " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration Where  CompanyCode='" & GV.parseString(txtSearchString.Text.Trim) & "'  order by  rid Desc"
                End If
            Else
                If ddlSelectCriteria.SelectedValue = "All Records" Then
                    ddlSelectCriteria.Text = ""
                    Querystring = "select '0' as 'SrNo',(FirstName+' '+LastName) as Name,RegistrationId,AgentPassword,TransactionPin,(CONVERT(VARCHAR(11),RegistrationDate,106)) as RegistrationDate,AgencyName,MobileNo,'0' as 'WalletBal' from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.[BOS_Dis_SubDis_Retailer_Registration] where AgentType='" & group & "' " & Loginid & "  order by  rid Desc"
                ElseIf ddlSelectCriteria.SelectedValue = "Name" Then
                    Querystring = "select '0' as 'SrNo',(FirstName+' '+LastName) as Name,RegistrationId,AgentPassword,TransactionPin,(CONVERT(VARCHAR(11),RegistrationDate,106)) as RegistrationDate,AgencyName,MobileNo,'0' as 'WalletBal' from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.[BOS_Dis_SubDis_Retailer_Registration] Where AgentType='" & group & "' " & Loginid & "  and FirstName  like '" & GV.parseString(txtSearchString.Text.Trim) & "%' order by  rid Desc"
                ElseIf ddlSelectCriteria.SelectedValue = "Login ID" Then
                    Querystring = "select '0' as 'SrNo',(FirstName+' '+LastName) as Name,RegistrationId,AgentPassword,TransactionPin,(CONVERT(VARCHAR(11),RegistrationDate,106)) as RegistrationDate,AgencyName,MobileNo,'0' as 'WalletBal' from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.[BOS_Dis_SubDis_Retailer_Registration] Where AgentType='" & group & "' " & Loginid & "  and RegistrationId='" & GV.parseString(txtSearchString.Text.Trim) & "'  order by  rid Desc"
                End If
            End If
