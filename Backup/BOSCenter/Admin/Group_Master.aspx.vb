...
Public Class Group_Master
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            If lblSessionFlag.Text = 0 Then
                ...
                If GV.FL.RecCount("CRM_Group_Master where Group_Name='" & VGroupName & "'") > 0 Then 'Change where condition according to Criteria 
                    lblError.Text = "Record Already Exists."
                    lblError.CssClass = "errorlabels"
                    Exit Sub
                Else
                    QryStr = "insert into CRM_Group_Master (Group_Name,UpdatedBy,UpdatedOn) values( '" & VGroupName & "','" & VUpdatedBy & "','" & VUpdatedOn & "' );"
            ...
            ElseIf lblSessionFlag.Text = 1 Then
                ...
                If GV.FL.RecCount("CRM_Group_Master where Group_Name='" & VGroupName & "' and not Group_Name='" & GV.parseString(lblUpadate.Text) & "'") > 0 Then 'Change where condition according to Criteria 
                    lblError.Text = "Record Already Exists."
                    lblError.CssClass = "errorlabels"
                Else

                    QryStr = "update CRM_Group_Master set Group_Name='" & VGroupName & "', UpdatedBy='" & VUpdatedBy & "', UpdatedOn='" & VUpdatedOn & "' where RID=" & lblRID.Text.Trim & ";"
                    If GV.FL.DMLQueries(QryStr) = True Then
                        lblSessionFlag.Text = 0
                        ClearAll()
                        Bind()
    ...
    Public Sub Bind()
        Try
            ...
            End If
            DS = GV.FL.OpenDsWithSelectQuery("select * from CRM_Group_Master " & Filter & " order by RID desc  ")
    ...
    Protected Sub btnGrdRowDelete_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            If GV.FL.RecCount("CRM_Login_Details where User_type='" & GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(1).Text) & "';") > 0 Then
                lblDialogMsg.CssClass = ""
    ...
    Protected Sub btnDeleteRow_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            If Not lblRID.Text = "" Then
                ...
                QryStr = ("delete from CRM_Group_Master where RID=" & lblRID.Text & "")
                If GV.FL.DMLQueries(QryStr) = True Then
                    ClearAll()
                    Bind()
