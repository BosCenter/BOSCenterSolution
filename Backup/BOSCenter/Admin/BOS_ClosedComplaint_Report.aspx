<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Admin/SuperAdmin.Master"   CodeBehind="BOS_ClosedComplaint_Report.aspx.vb" Inherits="BOSCenter.BOS_ClosedComplaint_Report" %>
                 ...
                 <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridView1" runat="server"  cssclass="grid-view-themeclass"
                          ...
                          <Columns>
                            ...
                            <asp:BoundField DataField="ClosedDateTime" HeaderText="ClosedDateTime" />
