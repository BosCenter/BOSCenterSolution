Public Class BOS_TransferAmount_Form
        ...
        Try
            ...
            If VGroup = "SUPER ADMIN" Then
                ...
                If ddlPaymentMode.SelectedValue = "PLUS" Then
                    ...
                    SMSMeassgeTo = "Your Wallet is Credited With Rs. " & txtTransferAmt.Text.Trim & " By BOS CENTER PVT LTD"
                Else
                    AmouontType = "Withdraw"
                    VTransferToMsg = "Your Wallet is Credited by Admin (" & aa(0).Trim & ")"
                    VTransferFromMsg = "Your Wallet is Debited by BOS CENTER PVT LTD"
                    SMSMeassgeFrom = "Your Wallet is Debited With Rs. " & txtTransferAmt.Text.Trim & " By BOS CENTER PVT LTD"
    ...
    Protected Sub txtCustomerID_TextChanged(sender As Object, e As EventArgs) Handles txtCustomerID.TextChanged
        Try
            ...
            Else
                ...
                If GV.FL.RecCount("" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.[BOS_Dis_SubDis_Retailer_Registration] where AgentType='Customer'  and ActiveStatus='Active' and RegistrationId='" & CustID & "' ") > 0 Then
                    txtCustomerName.ForeColor = Drawing.Color.Blue
                    txtCustomerName.Text = GV.FL.AddInVar(" (isnull(FirstName,'')+' '+isnull(LastName,'')) ", "" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.[BOS_Dis_SubDis_Retailer_Registration] where AgentType='Customer'  and ActiveStatus='Active' and RegistrationId='" & CustID & "' ")
                Else
                    txtCustomerName.ForeColor = Drawing.Color.Red
                    txtCustomerName.Text = "Invalid Customer ID"
