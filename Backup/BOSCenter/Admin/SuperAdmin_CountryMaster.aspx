<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="SuperAdmin_CountryMaster.aspx.vb" Inherits="BOSCenter.SuperAdmin_CountryMaster" %>
        	...
        	<div class="log_form1">
                    ...
                    <form class="form-horizontal">
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Enter Country</label>
                        <div class="col-sm-9">
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ControlToValidate="txtCountryName" ErrorMessage="Enter Country" CssClass="errorlabels"  
