...
Public Class ChangeOperatorPassword
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnChangePassword.Click
        Try
            ...
            'End If
            Dim str As String
            Dim Encrypted_Pass As String = GV.convertToHashMD5(txtNewPassword.Text.Trim)
            ...
            If GV.get_SuperAdmin_SessionVariables("Group", Request, Response) = "Distributor" Or GV.get_SuperAdmin_SessionVariables("Group", Request, Response) = "Master Distributor" Or GV.get_SuperAdmin_SessionVariables("Group", Request, Response) = "Retailer" Or GV.get_SuperAdmin_SessionVariables("Group", Request, Response) = "Customer" Then
                If GV.FL.RecCount("" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration where [RegistrationId]='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response) & "' and AgentPassword='" & GV.parseString(txtOldPassword.Text.Trim) & "' ") > 0 Then

                    str = " update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration set Encrypted_Pass='" & Encrypted_Pass & "' , AgentPassword='" & GV.parseString(txtNewPassword.Text.Trim) & "'  where [RegistrationId]='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response) & "' ; "
            ...
            Else
                If GV.FL.RecCount("" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.CRM_Login_Details where [User_ID]='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response) & "' and User_Password='" & GV.parseString(txtOldPassword.Text.Trim) & "' ") > 0 Then

                    str = " update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.CRM_Login_Details set  Encrypted_Pass='" & Encrypted_Pass & "' ,  User_Password='" & GV.parseString(txtNewPassword.Text.Trim) & "'  where [User_ID]='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response) & "' ; "
                    ...
                    If GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).ToString.ToUpper = "ADMIN" Then
                        If GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim.ToUpper = "BosCenter_DB".ToUpper Then
                            str = str & " update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_ClientRegistration set  Encrypted_Pass='" & Encrypted_Pass & "' ,   ClientPassword='" & GV.parseString(txtNewPassword.Text.Trim) & "', UpdatedBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response) & "', UpdatedOn=getdate() where DatabaseName='" & GV.parseString(GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim) & "';"
                        Else
                            str = str & " update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_ClientRegistration set  Encrypted_Pass='" & Encrypted_Pass & "' ,   ClientPassword='" & GV.parseString(txtNewPassword.Text.Trim) & "', UpdatedBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response) & "', UpdatedOn=getdate() where DatabaseName='" & GV.parseString(GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim) & "';"
                ...
                If DS.Tables.Count > 0 Then
                    If DS.Tables(0).Rows.Count > 0 Then
                        For i As Integer = 0 To DS.Tables(0).Rows.Count - 1
                            ...
                            '    End If
                            'End If
                            Encrypted_Pass = GV.convertToHashMD5(AgentPassword)

                            If str1 = "" Then
                                str1 = " update BosCenter_DB.dbo.BOS_Dis_SubDis_Retailer_Registration set Encrypted_Pass='" & Encrypted_Pass & "'  where [RegistrationId]='" & RegistrationId & "' ; "

                            Else
                                str1 = str1 & " " & " update BosCenter_DB.dbo.BOS_Dis_SubDis_Retailer_Registration set Encrypted_Pass='" & Encrypted_Pass & "' where [RegistrationId]='" & RegistrationId & "' ; "
