<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Oops.aspx.vb" Inherits="BOSCenter._Oops" %>
        	...
        	<div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head">
                    	<asp:Label ID="Label1" runat="server"  Text="Oops - Internal Server Error"></asp:Label>
                    </div>
                </div>
            </div>
        	<div class="log_form">
