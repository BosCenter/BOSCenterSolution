        ...
        Try
            ...
            If btn_bene_Save.Text = "Save" Then
                ...
                If AccountNumber = String.Empty Then
                    Dim InsrtQry As String = "Insert into BOS_beneficiaryDetails(AccountNumber,IfscCode,AccountName,AccountAddress,EmailID,MobileNo,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate,AccountStatus) values('" & VBene_AccountNumber & "','" & VBene_IFSC & "','" & VBene_Name & "','" & VBene_Address & "','" & VBene_Email & "','" & VBene_Mobile & "','" & VCreatedBy & "',getdate(),'" & VCreatedBy & "',getdate(),'" & VAccountStatus & "')"
            ...
            If btn_bene_Save.Text = "Pay" Then
                ...
                Else
                    ...
                    Dim Statuss, v_Transfer_Trans_ID As String

                    APIResult = GetAPISParametars("DomesticPayment_API_Parameters")
                    ...
                    TrxnId = ser_.SelectToken("merchantTrxnRefId").ToString.Trim
                    If Status = "Pending" Then
                        APIResult = GetAPISParametars("PaymentStatus_API_Parameters")
                        Dim jsons_ As String = APIResult
                        Dim sers_ As JObject = JObject.Parse(jsons_)
                        Statuss = sers_.SelectToken("status").ToString.Trim
                        TrxnId = sers_.SelectToken("trxn_id").ToString.Trim

                        If Statuss = "Success" Then
                            ...
                            If GRP = "Retailer".ToUpper Then
                                ...
                                If Not lblRID.Text = "" Then
                                    ...
                                    Else
                                        ...
                                        Qry = "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Actual_Transaction_Amount,Amt_Transfer_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values('" & GV.parseString(GV.GetIPAddress) & "','" & v_Transfer_Trans_ID.ToString & "','" & txt_Transc_Amount.Text.Trim & "','" & GV.parseString(lblPopTransactionId.Text.Trim) & "','" & typeAmtTo & "','" & typeAmtForm & "','" & TypeName & "','" & TypeName & "','" & Now.Date.ToString("MM-dd-yyyy") & "','" & RTEID & "','Admin','" & txt_Transc_Amount.Text.Trim & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"
                                        'Qry = Qry & "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Actual_Transaction_Amount,Amt_Transfer_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values('" & GV.parseString(GV.GetIPAddress) & "','" & lblPopTransactionId.Text.Trim & "','" & txt_Transc_Amount.Text.Trim & "','" & GV.parseString(lblPopTransactionId.Text.Trim) & "','" & typeAmtForm & "','" & typeAmtTo & "','" & TypeName & "','" & TypeName & "','" & Now.Date.ToString("MM-dd-yyyy") & "','" & RTEID & "','Admin','" & txt_Transc_Amount.Text.Trim & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"
                                        Qry = Qry & " " & "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Actual_Transaction_Amount,Amt_Transfer_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values('" & GV.parseString(GV.GetIPAddress) & "','" & v_Transfer_Trans_ID.ToString & "','" & txt_Transc_Amount.Text.Trim & "','" & GV.parseString(lblPopTransactionId.Text.Trim) & "','" & typeAmtTo & "','" & typeAmtForm & "','" & TypeName & "','" & TypeName & "','" & Now.Date.ToString("MM-dd-yyyy") & "','Admin','SUPERADMIN','" & txt_Transc_Amount.Text.Trim & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"
                                ...
                                If Service.Length > 1 Then
                                    ...
                                    Qry = Qry & " " & "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Actual_Transaction_Amount,Ref_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values('" & GV.parseString(GV.GetIPAddress) & "','" & lblPopTransactionId.Text.Trim & "','" & txt_Transc_Amount.Text.Trim & "','" & GV.parseString(lblPopTransactionId.Text.Trim) & "','" & VTo & "','" & VFrom & "','Service Charge','Service Charge','" & Now.Date.ToString("MM-dd-yyyy") & "','" & RTE & "','ADMIN','" & GV.parseString(NetAmount.ToString) & "',getdate(),'Admin',getdate() ) ;"
                                End If
                                ...
                                Qry = Qry & " " & "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Actual_Transaction_Amount,Ref_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values( '" & GV.parseString(GV.GetIPAddress) & "','" & lblPopTransactionId.Text.Trim & "','" & txt_Transc_Amount.Text.Trim & "', '" & GV.parseString(lblPopTransactionId.Text.Trim) & "','" & VTo_Trans & "','" & VFrom_Trans & "','Transaction Charge','Transaction Charge','" & Now.Date.ToString("MM-dd-yyyy") & "','Admin','Super Admin','" & Transaction_Charge_Amt & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"
                            ...
                            ElseIf GRP = "Customer".ToUpper Then
                                ...
                                If Not lblRID.Text = "" Then
                                    ...
                                    Qry = "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Actual_Transaction_Amount,Amt_Transfer_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values('" & GV.parseString(GV.GetIPAddress) & "','" & lblPopTransactionId.Text.Trim & "','" & txt_Transc_Amount.Text.Trim & "','" & GV.parseString(lblPopTransactionId.Text.Trim) & "','" & typeAmtTo & "','" & typeAmtForm & "','" & TypeName & "','" & TypeName & "','" & Now.Date.ToString("MM-dd-yyyy") & "','" & CustID & "','Admin','" & txt_Transc_Amount.Text.Trim & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"
                                ...
                                If GRP = "Retailer".ToUpper Or GRP = "Customer".ToUpper Then
                                    ...
                                    Qry = Qry & " " & "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Actual_Transaction_Amount,Ref_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values( '" & GV.parseString(GV.GetIPAddress) & "','" & lblPopTransactionId.Text.Trim & "','" & VCus_Amount & "', '" & GV.parseString(lblPopTransactionId.Text.Trim) & "','" & VTo_Trans & "','" & VFrom_Trans & "','Transaction Charge','Transaction Charge','" & Now.Date.ToString("MM-dd-yyyy") & "','Admin','Super Admin','" & Transaction_Charge_Amt & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"
                                    ...
                                    If Not GV.parseString(Comm_Result) = "" Then
                                        ...
                                        If Service_Charge_Amt > 0 Then
                                            ...
                                            Qry = Qry & " " & "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Actual_Transaction_Amount,Ref_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values( '" & GV.parseString(GV.GetIPAddress) & "','" & lblPopTransactionId.Text.Trim & "','" & VCus_Amount & "', '" & GV.parseString(lblPopTransactionId.Text.Trim) & "','" & VTo & "','" & VFrom & "','Service Charge','Service Charge','" & Now.Date.ToString("MM-dd-yyyy") & "','Admin','Super Admin','" & Service_Charge_Amt & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"
                                        End If
                                    ...
                                    If Not GV.parseString(Comm_Result) = "" Then
                                        ...
                                        If Service_Charge_Amt > 0 Then
                                            Dim VFrom As String = "Your Account is debited by ServiceCharge " & Service_Charge_Amt & " Rs. inculding GST Due to " & TypeName & " / AMT " & VCus_Amount & "."
                                            Dim VTo As String = "Your Account is credited by ServiceCharge " & Service_Charge_Amt & " Rs. inculding GST Due to " & TypeName & " / AMT " & VCus_Amount & "."
                                            Qry = Qry & " " & "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Actual_Transaction_Amount,Ref_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values( '" & GV.parseString(GV.GetIPAddress) & "','" & lblPopTransactionId.Text.Trim & "','" & VCus_Amount & "', '" & GV.parseString(lblPopTransactionId.Text.Trim) & "','" & VTo & "','" & VFrom & "','Service Charge','Service Charge','" & Now.Date.ToString("MM-dd-yyyy") & "','Super Admin','API Partner','" & Service_Charge_Amt & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"
                                        End If
