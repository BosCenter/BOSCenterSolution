...
Public Class CreateCustomer_1
    ...
    Private Sub btnPopupYes_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPopupYes.Click
                ...
                If GV.FL.DMLQueriesBulk(QryStr) = True Then
                    ...
                    If GV.FL.AddInVar("AllowSms", GV.DefaultDatabase.Trim & ".dbo.Autonumber").ToString.Trim.ToUpper = "Yes".ToUpper Then
                        If txtDBName.Text.Trim = "CMP1165" Then
                            Dim vMessage As String = "Dear " & VFirstName.Trim & " " & VLastName.Trim & " Your Login Id :- " & VMobileNo & " Your Password :- " & GV.DecryptString(GV.key, Vpassword) & " Your Tpin :- " & trnsactionpinNo & " Please Do Not Share With Anyone . Thanks For Using Kuber Money www.kvishmoney.com"
        ...
        End Try
    End Sub
    Public Sub goPayuGateway(ByVal TransID As String, ByVal VCustomerEmailID As String, ByVal VPayCustomerID As String, ByVal VPayCartAmount As String, ByVal VPayCustomerName As String, ByVal VPayCustomerPhoneNo As String, ByVal VDeliveryRID As String)
        Try
            ...
            Dim Text As String = MERCHANT_KEY & "|" & txnID & "|" & Convert.ToDecimal(VPayCartAmount).ToString("g29") & "|" & "Shopping" & "|" & VPayCustomerName & "|" & VCustomerEmailID & "|||||||||||" & SALT_KEY
            ...
            data.Add("amount", Convert.ToDecimal(VPayCartAmount).ToString("g29"))
