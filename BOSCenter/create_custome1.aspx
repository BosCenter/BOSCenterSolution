...
<asp:Label ID='lblformsectionhead3' runat='server' Text='Registration Details' Visible="false"></asp:Label>
...
<label for='txtAgentType'></label>
    <asp:TextBox ID="txtAgentType" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
  <asp:DropDownList ID="ddlAgentType" runat="server" class='form-control' AutoPostBack="true" Visible="false">
...
<asp:TextBox ID='txtCompanyName' runat='server'  placeholder='Agency Name'
    ...
    <asp:TextBox ID='txtLastName' runat='server'  placeholder='LastName' class='form-control' Visible="false"></asp:TextBox>
