        ...
        Try
            ...
            ElseIf CompanyCode.Trim = "CMP1174" Then
                ...
                Else
                    Exit Function
                End If
            ElseIf CompanyCode.Trim = "CMP1218" Then

                If msgtype = "Approve Submit Payment" Then
                    url = "http://adcruxmedia.in/V2/http-api.php?apikey=gz2Rmc4WewzoxK5i&senderid=JPGRPO&number=" & ContactNos & "&message=" & txtMessage & "&format=json"
                ElseIf msgtype = "Amount Transfer" Then
                    url = "http://adcruxmedia.in/V2/http-api.php?apikey=gz2Rmc4WewzoxK5i&senderid=JPGRPO&number=" & ContactNos & "&message=" & txtMessage & "&format=json"
                ElseIf msgtype = "Send Otp" Then
                    url = "http://adcruxmedia.in/V2/http-api.php?apikey=gz2Rmc4WewzoxK5i&senderid=JPGRPO&number=" & ContactNos & "&message=" & txtMessage & "&format=json"
