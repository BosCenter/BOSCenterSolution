                            ...
                            If GV.FL.RecCount(DBName & ".dbo.BOS_Dis_SubDis_Retailer_Registration where   RegistrationId='" & GV.parseString(MemberId) & "' and  MobileNo='" & GV.parseString(Email) & "' ") > 0 Then
                                ...
                                If GV.FL.AddInVar("AllowSms", GV.DefaultDatabase.Trim & ".dbo.Autonumber").ToString.Trim.ToUpper = "Yes".ToUpper Then
                                    ...
                                    ElseIf DBName.Trim = "CMP1218" Then
                                        Dim vMessage As String = "Dear " & vName & ", Your OTP for login is : " & Session("OTP") & " . Please Do Not Share With Anyone . Thanks For Using PayKre jpgroup."
                ...
                ElseIf Session("Src") = "Mobile" Then
                    ...
                    If rdbForgotType.SelectedValue = "Password" Then
                        If GV.FL.AddInVar("AllowSms", GV.DefaultDatabase.Trim & ".dbo.Autonumber").ToString.Trim.ToUpper = "Yes".ToUpper Then
                            ...
                            ElseIf DBName.Trim = "CMP1218" Then
                                Dim vMessage As String = "Dear " & vName & Environment.NewLine & "Your Password Is " & GV.DecryptString(GV.key, strarr(1).ToString.Trim) & Environment.NewLine & "Please Do Not Share With Anyone." & Environment.NewLine & "Thanks For Using PayKre jpgroup."
                                GV.send_Template_Based_SMS_API(GV.parseString(txtEmail.Text.Trim), vMessage, "Forgot Password", "CMP1218")
                            Else
                    ...
                    ElseIf rdbForgotType.SelectedValue = "PIN" Then
                        If GV.FL.AddInVar("AllowSms", GV.DefaultDatabase.Trim & ".dbo.Autonumber").ToString.Trim.ToUpper = "Yes".ToUpper Then
                            ...
                            ElseIf DBName.Trim = "CMP1218" Then
                                Dim vMessage As String = "Dear " & vName & "," & Environment.NewLine & "Your TPIN is " & strarr(2).ToString.Trim & " . " & Environment.NewLine & "Please Do Not Share With Anyone. " & Environment.NewLine & "Thanks For Using PayKre jpgroup."
                                GV.send_Template_Based_SMS_API(GV.parseString(txtEmail.Text.Trim), vMessage, "Forgot Pin", "CMP1218")
                            Else
