...
<div class="row">
      ...
      <asp:ListItem>Others</asp:ListItem>
                    ...
                    <asp:TextBox method="post" ID="txtPassword" runat="server" class="form-control" 
                            placeholder="Enter Your Password" TextMode="Password" MaxLength="15"></asp:TextBox>
                  ...
                  <div class="form-group">
                  	<div class="col-sm-12">
                          <asp:Button ID="btnSubmit" runat="server" Text="Submit" class="btn btn-danger pull-right mar_top10" />
