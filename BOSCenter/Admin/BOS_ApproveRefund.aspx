<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Admin/SuperAdmin.Master"   CodeBehind="BOS_ApproveRefund.aspx.vb" Inherits="BOSCenter.BOS_ApproveRefund" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Apporve Refund Request"></asp:Label>	
                    </div>
                </div>
            </div>
        ...
        <form class="form-horizontal">
                   ...
                   <div class="row">
                      ...
                      <div class="form-group">
                       <div class="col-sm-3">
                          <asp:DropDownList ID="ddlTransType" AutoPostBack="true"  cssclass="form-control"  runat="server" >
        ...
        <div class="col-md-12" >
                 ...
                 <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridView1" runat="server"  cssclass="grid-view-themeclass"
                            BorderStyle="None" AutoGenerateColumns="true" PageSize="10000" >
                          <Columns>
...
<td colspan="2" align="center" bgcolor="Silver"   >&nbsp;</td>
    ...
    <tr>
        <td align="left"  >
          <asp:Label ID="Label3" runat="server" Text="Refund Amt" CssClass="mar_lft10"></asp:Label> 
           <div style="margin-bottom:5px;"></div>
       &nbsp;&nbsp;</td>
       <td align="left" >
     ...
     <tr>
       ...
       <td align="left">
           &nbsp;&nbsp;  <asp:TextBox ID="txtRemarks" runat="server" 
               CssClass="form-control margin-r-5" Width="85%" TextMode="MultiLine" Rows="3" ></asp:TextBox> &nbsp;&nbsp; &nbsp;&nbsp;
       &nbsp;</td>
