        ...
        Try
            ...
            If group.Trim.ToUpper = "Retailer".Trim.ToUpper Then
                ...
                If Not ddlAmountType.SelectedIndex = 0 Then
                    Filter_rechType = " and Recharge_ServiceType='" & ddlAmountType.SelectedValue.Trim & "' "
                End If
                ...
                If GV.parseString(ddlAmountType.SelectedValue.Trim).ToUpper = "Mobile".Trim.ToUpper Then
                    Querystring = "Select RID as 'Sr No',(CONVERT(VARCHAR(11),Recharge_Date,106)) as  'Date',CONVERT(varchar(15),CAST(Recharge_Date AS TIME),100) as Time,Recharge_MobileNo_CaNo as 'Mobile No',Recharge_Operator as 'Operator',Recharge_Amount as 'Amount',API_TransId as 'TRANS_NO', API_status as 'Status',API_resText as 'Remarks' from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Recharge_API where API_status in ('Success','true')  and RetailerID='" & RetailerID & "' " & Filter_rechType & " " & Filter_Mode & " " & duration & "  order by rid desc "
                ElseIf GV.parseString(ddlAmountType.SelectedValue.Trim).ToUpper = "DTH".Trim.ToUpper Then
                    Querystring = "Select  RID as 'Sr No',(CONVERT(VARCHAR(11),Recharge_Date,106)) as 'Date',CONVERT(varchar(15),CAST(Recharge_Date AS TIME),100) as Time,Recharge_MobileNo_CaNo as 'CA No',Recharge_Operator as 'Operator',Recharge_Amount as 'Amount',API_TransId as 'TRANS_NO', API_status as 'Status',API_resText as 'Remarks' from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Recharge_API where API_status in ('Success','true') and RetailerID='" & RetailerID & "' " & Filter_rechType & " " & Filter_Mode & " " & duration & "  order by rid desc "
                ElseIf GV.parseString(ddlAmountType.SelectedValue.Trim).ToUpper = "PostPaid".Trim.ToUpper Then
                    Querystring = "Select  RID as 'Sr No',(CONVERT(VARCHAR(11),Recharge_Date,106)) as 'Date',CONVERT(varchar(15),CAST(Recharge_Date AS TIME),100) as Time,Recharge_MobileNo_CaNo as 'Mobile No',Recharge_Operator as 'Operator',Recharge_Amount as 'Amount',API_TransId as 'TRANS_NO', API_status as 'Status',API_resText as 'Remarks',Mode from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Recharge_API where API_status in ('Success','true') and RetailerID='" & RetailerID & "' " & Filter_rechType & " " & Filter_Mode & " " & duration & "  order by rid desc "
                ...
                ElseIf GV.parseString(ddlAmountType.SelectedValue.Trim).ToUpper = "Landline".Trim.ToUpper Then
                    Querystring = "Select  RID as 'Sr No',(CONVERT(VARCHAR(11),Recharge_Date,106)) as 'Date',CONVERT(varchar(15),CAST(Recharge_Date AS TIME),100) as Time,Recharge_MobileNo_CaNo as 'Telephone No',Recharge_Operator as 'Operator',Recharge_Amount as 'Amount',API_TransId as 'TRANS_NO', API_status as 'Status',API_resText as 'Remarks',Mode from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Recharge_API API_status in ('Success','true') and where RetailerID='" & RetailerID & "' " & Filter_rechType & " " & Filter_Mode & " " & duration & "  order by rid desc "
