...
Public Class ClientPasswordReport
    ...
    Public Sub Bind()
        Try
            ...
            If ddlSelectCriteria.SelectedValue = "All Records" Then
                ...
                Querystring = "select CompanyName,CompanyHead,CompanyCode,ClientPassword as 'Password',Status as 'Account Status' from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.CRM_CLientRegistration where Recordstatus='Active' and ApprovedStatus='Approved' order by  RegisterationDate Desc"
            ElseIf ddlSelectCriteria.SelectedValue = "Company Code" Then
                Querystring = "select CompanyName,CompanyHead,CompanyCode,ClientPassword as 'Password',Status as 'Account Status' from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.CRM_CLientRegistration  Where CompanyCode='" & txtSearchString.Text.Trim & "' and Recordstatus='Active' and ApprovedStatus='Approved' order by  RegisterationDate Desc"
            End If
