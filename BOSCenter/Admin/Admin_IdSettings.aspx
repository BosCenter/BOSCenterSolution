...
<asp:DropDownList ID="ddlMoneyTransferAPI_2_Status" cssclass="form-control inputtext"  
     ...
     <div class="col-md-3">
<div class="form-group">
<label for="txtSharePrice" class="control-label">Payin API-1</label>
<asp:LinkButton ID="lnkbtn_Payin_Status" runat="server" CommandArgument="Payin_API_Status" onclick ="btnUpdate_click" CssClass="btn btn-primary btn-sm pull-right" >
    <i class="icon-save icon-3"></i>
    </asp:LinkButton>
<asp:DropDownList ID="ddlPayin_Status" cssclass="form-control inputtext"  
                                runat="server"  >
                                <asp:ListItem>Active</asp:ListItem>
                                <asp:ListItem>Inactive</asp:ListItem>
                            </asp:DropDownList>
     ...
     <div class="col-md-3">
<div class="form-group">
<label for="txtSharePrice" class="control-label">Payin API-2</label>
<asp:LinkButton ID="lnkbtn_Payin_2_Status" runat="server" CommandArgument="Payin_API_2_Status" onclick ="btnUpdate_click" CssClass="btn btn-primary btn-sm pull-right" >
    <i class="icon-save icon-3"></i>
    </asp:LinkButton>
<asp:DropDownList ID="ddlPayin_2_Status" cssclass="form-control inputtext"  
                                runat="server"  >
                                <asp:ListItem>Active</asp:ListItem>
                                <asp:ListItem>Inactive</asp:ListItem>
                            </asp:DropDownList>
...
<div class="row">
        <div class="col-md-3">
<div class="form-group">
<label for="txtSharePrice" class="control-label">Payout API-1</label>
<asp:LinkButton ID="lnkbtn_Payout_2_Status" runat="server" CommandArgument="Payout_API_2_Status" onclick ="btnUpdate_click" CssClass="btn btn-primary btn-sm pull-right" >
    <i class="icon-save icon-3"></i>
    </asp:LinkButton>
<asp:DropDownList ID="ddlPayout_API_2_Status" cssclass="form-control inputtext"  
                                runat="server"  >
                                <asp:ListItem>Active</asp:ListItem>
                                <asp:ListItem>Inactive</asp:ListItem>
                            </asp:DropDownList>
     ...
     <div class="col-md-3">
<div class="form-group">
<label for="txtSharePrice" class="control-label">Payout API-2</label>
<asp:LinkButton ID="lnkbtn_Payout_API_Status" runat="server" CommandArgument="Payout_API_Status" onclick ="btnUpdate_click" CssClass="btn btn-primary btn-sm pull-right" >
    <i class="icon-save icon-3"></i>
    </asp:LinkButton>
<asp:DropDownList ID="ddlPayout_API_Status" cssclass="form-control inputtext"  
                                runat="server"  >
                                <asp:ListItem>Active</asp:ListItem>
                                <asp:ListItem>Inactive</asp:ListItem>
                            </asp:DropDownList>
