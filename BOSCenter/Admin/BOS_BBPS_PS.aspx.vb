...
Public Class BOS_BBPS_PS
                ...
                If Not Request.QueryString("type") Is Nothing Then
                    If Not Request.QueryString("type").Trim = "" Then
                        ...
                        ElseIf Request.QueryString("type").Trim.ToUpper = "Insurance".ToUpper Then
                            ...
                            Div_Navigation_buttons.Visible = False
                        ElseIf Request.QueryString("type").Trim.ToUpper = "FastTage".ToUpper Then
                            btnFastTage_Click(sender, e)
                            Div_Navigation_buttons.Visible = False
                        Else
                            btnmobile_Click(sender, e)
                        End If
    ...
    'Fast Tage Api Inetegartion of Pay Sprint
    Dim FASTTAGE_OPERATIONLIST_API_URL As String = "https://api.boscenter.in/api/BOS/OperatorsList"
    Dim FASTAGE_FETCHCUSOMERDETAILS_API_URL As String = "https://api.boscenter.in/api/BOS/FetchConsumerDetails"
    Dim FASTAGE_RECHARGE_API_URL As String = "https://api.boscenter.in/api/BOS/Recharge"
    ...
    Public Class DO_FASTAGE_RECHARGE_API_Parameters
        Dim Voperator, Vcanumber, Vamount, Vreferenceid, Vlatitude, Vlongitude As String

        'VmaxBillAmount, VacceptPayment, VacceptPartPay, VcellNumber, VuserName
        Public Property [operator]() As String
            Get
                Return Voperator
            End Get
        ...
        Public Property bill_fetch() As New bill_fetch()
    End Class
    ...
    Public Function GetApiResult_NEW(APIMethod As String) As String
        ...
        Try
            ...
            ElseIf APIMethod = "FASTTAGE_OPERATIONLIST_API_URL" Then 'Done
                StrParameters = Newtonsoft.Json.JsonConvert.SerializeObject("")
                API_URLS = FASTTAGE_OPERATIONLIST_API_URL
    ...
    Protected Sub btn_Proceed_Recharge_Click(sender As Object, e As EventArgs) Handles btn_Proceed_Recharge.Click
        ...
        Try
            ...
            ElseIf lblSelectedService.Text.Trim.ToUpper = "Electricity".Trim.ToUpper Or lblSelectedService.Text.Trim.ToUpper = "DTH".Trim.ToUpper Or lblSelectedService.Text.Trim.ToUpper = "Fasttage".Trim.ToUpper Or lblSelectedService.Text.Trim.ToUpper = "Broadband".Trim.ToUpper Or lblSelectedService.Text.Trim.ToUpper = "gas".Trim.ToUpper Or lblSelectedService.Text.Trim.ToUpper = "Waterbill".Trim.ToUpper Then
                If txt_Mobile_CA_No.Text = "" Then
                ...
                End If
                If Not ddlOperators.SelectedIndex = 0 Then
                    Voperator = ddlOperators.SelectedValue
                Else
                    lblSearchCustomerError.Text = "Select Operators"
                    lblSearchCustomerError.CssClass = "errorlabels"
                    ddlOperators.Focus()
            ...
            If ddlGateway.SelectedValue.Trim.ToUpper = "Recharge".Trim.ToUpper Then
                ...
                If lblSelectedService.Text.Trim.ToUpper = "Mobile".Trim.ToUpper Or lblSelectedService.Text.Trim.ToUpper = "Postpaid".Trim.ToUpper Or lblSelectedService.Text.Trim.ToUpper = "dth".Trim.ToUpper Or lblSelectedService.Text.Trim.ToUpper = "Fasttage".Trim.ToUpper Or lblSelectedService.Text.Trim.ToUpper = "Broadband".Trim.ToUpper Then
                    TypeName = "RECH"
        ...
        Try
            ...
            If btn_BBPS_Fetch.Text.Trim.ToUpper = "Pay Bill".ToUpper Then
                ...
                Try
                    ...
                    ElseIf ServiceName.Trim.ToUpper = "Fasttage".ToUpper Then

                        If Not ddl_BBPS_Operators.SelectedIndex = 0 Then
                            Voperator = ddl_BBPS_Operators.SelectedItem.Text
                        Else
                            lbl_BBPS_Fetch_Response.Text = "Select Fastage"
                            lbl_BBPS_Fetch_Response.CssClass = "errorlabels"
                            ddl_BBPS_Operators.CssClass = "ValidationError"
                            ddl_BBPS_Operators.Focus()
                            Exit Sub
                        ...
                        If txt_BBPS_CA_No.Text = "" Then
                            lbl_BBPS_Fetch_Response.Text = "Enter Fastage Number"
                            lbl_BBPS_Fetch_Response.CssClass = "errorlabels"
                            txt_BBPS_CA_No.Focus()
                            Exit Sub
                        End If
                            ...
                            If v_status = True Then
                                ...
                                If GRP = "Retailer".ToUpper Then
                                    ...
                                    If Not lblRID.Text = "" Then
                                        ...
                                        Else
                                            ...
                                            QryStr = QryStr & " " & "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Actual_Transaction_Amount,Ref_TransID,Amt_Transfer_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values( '" & GV.parseString(GV.GetIPAddress) & "','" & vTransID & "','" & VCus_Amount & "','" & GV.parseString(lblTransId.Text.Trim) & "','" & GV.parseString(lblTransId.Text.Trim) & "','" & typeAmtTo & "','" & typeAmtForm & "','" & TypeName & "','" & TypeName & "','" & Now.Date.ToString("MM-dd-yyyy").ToString("MM-dd-yyyy") & "','" & RTEID & "','Admin','" & txt_BBPS_Amt.Text.Trim & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"
                                    ...
                                    Else
                                        ...
                                        Dim typeAmtForm As String = "Your Account is debited by " & txt_Recharge_Amt.Text.Trim & " Rs. Due to " & TypeName & " on number " & txt_Mobile_CA_No.Text.Trim & " / AMT " & VCus_Amount & "."
                                        Dim typeAmtTo As String = "Your Account is credited by " & txt_Recharge_Amt.Text.Trim & " Rs. Due to " & TypeName & " on number " & txt_Mobile_CA_No.Text.Trim & " / AMT " & VCus_Amount & "."
                                        QryStr = QryStr & " " & "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Actual_Transaction_Amount,Ref_TransID,Amt_Transfer_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values( '" & GV.parseString(GV.GetIPAddress) & "','" & vTransID & "','" & VCus_Amount & "','" & GV.parseString(lblTransId.Text.Trim) & "','" & GV.parseString(lblTransId.Text.Trim) & "','" & typeAmtTo & "','" & typeAmtForm & "','" & TypeName & "','" & TypeName & "','" & Now.Date.ToString("MM-dd-yyyy") & "','" & RetailerID & "','Admin','" & txt_BBPS_Amt.Text.Trim & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"
                                        Dim ServiceCharge As Decimal = 0
                                        If ServiceCharge > 0 Then
                                            ServiceCharge = ServiceCharge
                                            If ServiceCharge > 0 Then
                                ...
                                ElseIf GRP = "Customer".ToUpper Then
                                    ...
                                    If Not lblRID.Text = "" Then
                                        ...
                                        QryStr = QryStr & " " & "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Actual_Transaction_Amount,Ref_TransID,Amt_Transfer_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values( '" & GV.parseString(GV.GetIPAddress) & "','" & vTransID & "','" & VCus_Amount & "','" & GV.parseString(lblTransId.Text.Trim) & "','" & GV.parseString(lblTransId.Text.Trim) & "','" & typeAmtTo & "','" & typeAmtForm & "','" & TypeName & "','" & TypeName & "','" & Now.Date.ToString("MM-dd-yyyy") & "','" & CustID & "','Admin','" & txt_BBPS_Amt.Text.Trim & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"
                                        'QryStr = QryStr & " " & "insert into BOS_TransferAmountToAgents (TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values('" & AdmintypecommTo & "','" & Admintypecommfrom & "','Commission','" & TypeName & "','" & Now.Date & "','SuperAdmin','" & adminID & "','" & adminCom & "'," & VRecord_DateTime & ",'" & VUpdatedBy & "'," & VUpdatedOn & " ) ;"
    ...
    Public Sub reset_button_css()
        Try
            ...
            btnFastTage.CssClass = "btn btn-danger mar_top10"
    ...
    Private Sub btnpostpaid_Click(sender As Object, e As System.EventArgs) Handles btnpostpaid.Click
        ...
        End Try
    End Sub
    Private Sub btnFastTage_Click(sender As Object, e As System.EventArgs) Handles btnFastTage.Click
        Try
            add_Recharge_Operators(ddl_BBPS_Operators, "FastTage")
        Catch ex As Exception
    ...
    Public Sub add_Recharge_Operators(ByVal ddl As DropDownList, ByVal ServiceName As String)
        Try
            ...
            ElseIf ServiceName.Trim.ToUpper = "dth".ToUpper Then
                ...
                btn_Proceed_Recharge.Visible = True
                Div_SearchCustomer.Visible = True
                DIV_ShowCustomerDetail.Visible = False
            ...
            ElseIf ServiceName.Trim.ToUpper = "FastTage".ToUpper Then
                ...
                btnFastTage.CssClass = "btn btn-success mar_top10"
                'DIV_ShowCustomerDetail.Visible = True


                'lbl_Service_Heading.Text = " ::  Fastage Recharge ::"
                'lbl_Service_History_Heading.Text = " Fastage Recharge History ::-"
                lbl_Mobile_CA_No_Heading.Text = "Enter Vehicle No"

                Try
                    APIResult = GetApiResult_NEW("FASTTAGE_OPERATIONLIST_API_URL")
                    APIResult = APIResult
                    Dim dd() As String = APIResult.Split("[")
                    Dim pp() As String = dd(1).Split("]")
                    ...
                    For i As Integer = 0 To json.Length - 1
                        If json(i).Contains("name") Then
                            ...
                            Dim jss As New Script.Serialization.JavaScriptSerializer()
                            Dim data As Dictionary(Of String, String) = jss.Deserialize(Of Dictionary(Of String, String))(json(i))
                            If data("category") = "Fastag" Then
                                Dim xitem As ListItem
                                xitem = New ListItem(data("name"), data("id"))
                                ddlOperators.Items.Add(xitem)
                            End If
                ...
                If ddlOperators.Items.Count > 0 Then
                    ddlOperators.Items.Insert(0, ":: Select Operator ::")
                    ddlOperators.SelectedIndex = 0
                Else
                    ddlOperators.Items.Add(":: Select Operator ::")
                    ddlOperators.SelectedIndex = 0
                End If
    ...
    Public Sub Bind()
        Try
            ...
            ElseIf lblSelectedService.Text.Trim.ToUpper = "Fasttage".Trim.ToUpper Then
                btnFalseStatus = True
                qry = "Select  (CONVERT(VARCHAR(11),Recharge_Date,106)) as 'Date',CONVERT(varchar(15),CAST(Recharge_Date AS TIME),100) as Time,Recharge_MobileNo_CaNo as 'CANo',Recharge_Operator as 'Operator',Recharge_Amount as 'Amount', API_status as 'Status',API_resText as 'Remarks' from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Recharge_API where RetailerID='" & RetailerID & "' and Recharge_ServiceType='" & lblSelectedService.Text.Trim & "' order by rid desc "
            ElseIf lblSelectedService.Text.Trim.ToUpper = "Landline".Trim.ToUpper Then
    ...
    Protected Sub btnGrdRowGo_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            If lblSelectedService.Text.Trim.ToUpper = "MOBILE" Or lblSelectedService.Text.Trim.ToUpper = "DTH" Or lblSelectedService.Text.Trim.ToUpper = "Fastage" Then
    ...
    Protected Sub lnkBtnRepeat_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            ElseIf ServiceName.Trim.ToUpper = "Fastage".ToUpper Then
                txt_Mobile_CA_No.Text = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(4).Text)
                txt_Recharge_Amt.Text = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(6).Text)
                For c As Integer = 0 To ddlOperators.Items.Count - 1
                    If ddlOperators.Items(c).Text.Trim.ToUpper = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(5).Text).Trim.ToUpper Then
    ...
    Protected Sub ddlOperators_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlOperators.SelectedIndexChanged
        Try
            Dim setParameter_API_Obj As New DO_RECHARGE_API_Parameters
            setParameter_API_Obj.canumber = GV.parseString(txt_Mobile_CA_No.Text)
            setParameter_API_Obj.operator = GV.parseString(ddlOperators.SelectedValue)
            ...
            setParameter_API_Obj.amount = GV.parseString(txt_Recharge_Amt.Text.Trim)
            APIResult = ReadbyRestClient_NEW(FASTAGE_FETCHCUSOMERDETAILS_API_URL, Newtonsoft.Json.JsonConvert.SerializeObject(setParameter_API_Obj))
            Dim cellNumber, userName, dueDate, billAmount, billnetamount As String
            Dim json As JObject = JObject.Parse(APIResult)
            cellNumber = GV.parseString(json.SelectToken("bill_fetch")("cellNumber").ToString)
            userName = GV.parseString(json.SelectToken("bill_fetch")("userName").ToString)
            dueDate = GV.parseString(json.SelectToken("bill_fetch")("dueDate").ToString)
            billAmount = GV.parseString(json.SelectToken("bill_fetch")("billAmount").ToString)
            billnetamount = GV.parseString(json.SelectToken("bill_fetch")("billnetamount").ToString)
            DIV_ShowCustomerDetail.Visible = True
            DIV_ShowCustomerDetail.InnerHtml = " Vehicle No : " & cellNumber & ",Customer Name : " & userName & ",DueDate : " & dueDate & ",Bill Amount : " & billAmount
        Catch ex As Exception
        End Try
    End Sub
End Class