...
Public Class CLientRegistration
    ...
    Protected Sub btnsaveOk_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsaveOk.Click
        Try
            ...
            End If
            Dim Encrypted_Pass As String = GV.EncryptString(GV.key, vClientPassword.Trim)
            ...
            If btnsaveOk.Text = "Yes" Then
                ...
                If lblSessionFlag.Text = 0 Then
                    ...
                    Else
                        ...
                        If ddlCreateDatabase.SelectedValue.Trim.ToUpper = "No".ToUpper Then
                            ...
                            'Sapna
                            qry = qry & "  " & " insert into BOS_ClientRegistration (Encrypted_Pass,HoldAmt,AEPS_API_Status,RechargeAPI_Status,MoneyTransferAPI_Status,PANCardAPI_Status,CreditBalnceLimit,WebRedirectUrl,RegisterationDate,CompanyCode,CompanyName,CompanyHead,ContactPerson,Companylogo,Address_1,Address_2,Address_3,PinCode,State,District,City,Country,PhoneNo_1,PhoneNo_2,Mobile_No,Email_ID,TinNo,CinNo,GSTNo,Status,ClientPassword,LastLogin,ClientRole,IsNewDatabase,DatabaseName,ChangeTheme,Record_DateTime,EmpCode,UpdatedBy,UpdatedOn) values('" & Encrypted_Pass & "',0,'" & APIStatus & "','" & APIStatus & "','" & APIStatus & "','" & APIStatus & "', '" & VCreditBalLimit & "', '" & VWebRedirectUrl & "', '" & VRegisterationDate & "','" & VCompanyCode & "','" & VCompanyName & "','" & VCompanyHead & "','" & VContactPerson & "','" & VCompanylogo & "','" & VAddress_1 & "','" & VAddress_2 & "','" & VAddress_3 & "','" & VPinCode & "','" & VState & "','" & VDistrict & "','" & VCity & "','" & VCountry & "','" & VPhoneNo_1 & "','" & VPhoneNo_2 & "','" & VMobile_No & "','" & VEmail_ID & "','" & VTinNo & "','" & VCinNo & "','" & VGSTNo & "','" & VStatus & "','" & Encrypted_Pass & "','" & VLastLogin & "','" & VClientRole & "','" & VIsNewDatabase & "','" & VDatabaseName & "','" & VChangeTheme & "',getdate(),'" & VEmpCode & "','" & VUpdatedBy & "',getdate() );"
                        ...
                        If result = True Then
                            ...
                            Div_deInfo.Visible = True
                            lblPassword.Text = " " & GV.DecryptString(GV.key, Encrypted_Pass)
                ...
                ElseIf lblSessionFlag.Text = 1 Then
                    ...
                    If GV.parseString(ddlCreateDatabase.SelectedValue) = "Yes" Then
                        qry = " update " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration set Encrypted_Pass='" & Encrypted_Pass & "',  CreditBalnceLimit='" & VCreditBalLimit & "',  WebRedirectUrl='" & VWebRedirectUrl & "', CompanyName='" & VCompanyName & "', CompanyHead='" & VCompanyHead & "', ContactPerson='" & VContactPerson & "', Companylogo='" & VCompanylogo & "', Address_1='" & VAddress_1 & "', Address_2='" & VAddress_2 & "', Address_3='" & VAddress_3 & "', PinCode='" & VPinCode & "', State='" & VState & "', District='" & VDistrict & "', City='" & VCity & "', Country='" & VCountry & "', PhoneNo_1='" & VPhoneNo_1 & "', PhoneNo_2='" & VPhoneNo_2 & "', Mobile_No='" & VMobile_No & "', Email_ID='" & VEmail_ID & "', TinNo='" & VTinNo & "', CinNo='" & VCinNo & "', GSTNo='" & VGSTNo & "', Status='" & VStatus & "', ClientPassword='" & Encrypted_Pass & "', ClientPin='" & GV.parseString(txtTransactionPin.Text) & "', UpdatedBy='" & VUpdatedBy & "', UpdatedOn=getdate() where CompanyCode='" & GV.parseString(txtCompanyCode.Text) & "';"
                        qry = qry & " update " & GV.parseString(lblDatabaseName.Text) & ".dbo.BOS_ClientRegistration set Encrypted_Pass='" & Encrypted_Pass & "',  CreditBalnceLimit='" & VCreditBalLimit & "',  WebRedirectUrl='" & VWebRedirectUrl & "', CompanyName='" & VCompanyName & "', CompanyHead='" & VCompanyHead & "', ContactPerson='" & VContactPerson & "', Companylogo='" & VCompanylogo & "', Address_1='" & VAddress_1 & "', Address_2='" & VAddress_2 & "', Address_3='" & VAddress_3 & "', PinCode='" & VPinCode & "', State='" & VState & "', District='" & VDistrict & "', City='" & VCity & "', Country='" & VCountry & "', PhoneNo_1='" & VPhoneNo_1 & "', PhoneNo_2='" & VPhoneNo_2 & "', Mobile_No='" & VMobile_No & "', Email_ID='" & VEmail_ID & "', TinNo='" & VTinNo & "', CinNo='" & VCinNo & "', GSTNo='" & VGSTNo & "', Status='" & VStatus & "', ClientPin='" & GV.parseString(txtTransactionPin.Text) & "',ClientPassword='" & Encrypted_Pass & "', UpdatedBy='" & VUpdatedBy & "', UpdatedOn=getdate() where CompanyCode='" & GV.parseString(txtCompanyCode.Text) & "';"
                        qry = qry & " update " & GV.parseString(lblDatabaseName.Text) & ".dbo.CRM_Login_Details set Encrypted_Pass='" & Encrypted_Pass & "',  CreditBalnceLimit='" & VCreditBalLimit & "',  AccountStatus='" & VStatus & "', User_Name='" & VCompanyName & "', User_Password='" & Encrypted_Pass & "',TransactionPin='" & GV.parseString(txtTransactionPin.Text) & "',  ImagePath='" & VCompanylogo & "', MobileNo='" & VMobile_No & "', EmailId='" & VEmail_ID & "', UpdatedBy='" & VUpdatedBy & "', UpdatedOn=getdate() where User_ID='Admin';"
                    Else
                        qry = "update " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration set Encrypted_Pass='" & Encrypted_Pass & "',  CreditBalnceLimit='" & VCreditBalLimit & "',  WebRedirectUrl='" & VWebRedirectUrl & "', CompanyName='" & VCompanyName & "', CompanyHead='" & VCompanyHead & "', ContactPerson='" & VContactPerson & "', Companylogo='" & VCompanylogo & "', Address_1='" & VAddress_1 & "', Address_2='" & VAddress_2 & "', Address_3='" & VAddress_3 & "', PinCode='" & VPinCode & "', State='" & VState & "', District='" & VDistrict & "', City='" & VCity & "', Country='" & VCountry & "', PhoneNo_1='" & VPhoneNo_1 & "', PhoneNo_2='" & VPhoneNo_2 & "', Mobile_No='" & VMobile_No & "', Email_ID='" & VEmail_ID & "', TinNo='" & VTinNo & "', CinNo='" & VCinNo & "', GSTNo='" & VGSTNo & "', Status='" & VStatus & "', ClientPassword='" & Encrypted_Pass & "',ClientPin='" & GV.parseString(txtTransactionPin.Text) & "', UpdatedBy='" & VUpdatedBy & "', UpdatedOn=getdate() where CompanyCode='" & GV.parseString(txtCompanyCode.Text) & "';"
