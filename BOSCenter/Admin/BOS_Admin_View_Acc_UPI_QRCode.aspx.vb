...
Imports System.Net
Imports System.IO
Public Class BOS_Admin_View_Acc_UPI_QRCode
    ...
    Public Sub Fill_Details()
        Try
            qry = "select * from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_ClientRegistration where ClientRole='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "'"
