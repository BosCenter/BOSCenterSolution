...
Public Class Admin_IdSettings
    ...
    Dim RechargeAPI_Status, MoneyTransferAPI_Status, MoneyTransferAPI_2_Status, PANCardAPI_Status, AEPSAPI_Status, Sub_DistributorID, PayinAPI_Status, PayinAPI_2_Status, PayoutAPI_Status, PayoutAPI_2_Status As String
        ...
        Try
            ...
            If Not lnkbtn Is Nothing Then
                If Not lnkbtn.CommandArgument.Trim = "" Then
                    ...
                    ElseIf lbllnkbtn.Text.Trim.ToUpper = "Payin_API_Status".ToUpper Then
                        PayinAPI_Status = ddlPayin_Status.SelectedValue
                        Name = "Payin_API_Status"
                        strcol = " Payin_API_Status='" & PayinAPI_Status & "' "
                    ElseIf lbllnkbtn.Text.Trim.ToUpper = "Payin_API_2_Status".ToUpper Then
                        PayinAPI_2_Status = ddlPayin_2_Status.SelectedValue
                        Name = "Payin_API_2_Status"
                        strcol = " Payin_API_2_Status='" & PayinAPI_2_Status & "' "
                    ElseIf lbllnkbtn.Text.Trim.ToUpper = "Payout_API_2_Status".ToUpper Then
                        PayoutAPI_Status = ddlPayout_API_2_Status.SelectedValue
                        Name = "Payout_API_2_Status"
                        strcol = " Payout_API_2_Status='" & PayoutAPI_Status & "' "
                    ElseIf lbllnkbtn.Text.Trim.ToUpper = "Payout_API_Status".ToUpper Then
                        PayoutAPI_2_Status = ddlPayout_API_Status.SelectedValue
                        Name = "Payout_API_Status"
                        strcol = " Payout_API_Status='" & PayoutAPI_2_Status & "' "
