        ...
        Try
            ...
            If chkduration.Checked = True Then
                ...
                Else
                    RefrenceId = ""
                End If
                Querystring = "select RID as SrNo,RegistrationId,(CONVERT(VARCHAR(11),RegistrationDate,106)) as RegistrationDate,AgencyName	,(FirstName+ ' ' +LastName) as Name,MobileNo	,BusinessType	,PanCardNumber,	OfficeAddress,State,ActiveStatus from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration b where RegistrationDate between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & "' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & "' " & colName & "  " & SearchColumnName & "  " & RefrenceId & "  order by  RID Desc"
            ...
            Else
                ...
                Else
                    RefrenceId = ""
                End If
                Querystring = "select RID as SrNo,RegistrationId,(CONVERT(VARCHAR(11),RegistrationDate,106)) as RegistrationDate,AgencyName	,(FirstName+ ' ' +LastName) as Name,MobileNo	,BusinessType	,PanCardNumber,	OfficeAddress,State,ActiveStatus  from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration b  " & SearchColumnName & "  " & colName & " " & RefrenceId & " " & branchFilter & "  order by  RID Desc"
            End If
