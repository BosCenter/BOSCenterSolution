<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_ProductServiceMaster_SA.aspx.vb" Inherits="BOSCenter.BOS_ProductServiceMaster_SA" %>
    	...
    	<div class ="col-sm-10 col-sm-offset-1">
        	...
        	<div class="log_form1">
            	 <div class="form-group">
                    ...
                    <div class="clearfix" style="margin-bottom:5px;"></div>
                        <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">SA Commission <asp:Label ID="Label4"  ForeColor="Red" runat="server" Text=" *"></asp:Label></label>
                        <div class="col-sm-4">
