...
<asp:TemplateField HeaderText="Save">
            <HeaderTemplate>
            <asp:Label ID="dd112" runat="server"  Text="ShowServices_Cust"></asp:Label><br />
            <asp:Button ID="SaveAll_Cust" CommandName="btnSaveAll_Cust" CssClass="btn btn-primary mar_top10"  Text="ALL" runat="server" /><br>
             
            </HeaderTemplate>
                <ItemTemplate>
                    <asp:CheckBox ID="chkSave_Cust" runat="server" CssClass="mar_top10" Enabled="true" />
                </ItemTemplate>
                <ControlStyle Width="70px" />
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
...
<asp:TemplateField HeaderText="Search">
            <HeaderTemplate>
            <asp:Label ID="dd11243" runat="server"  Text="ShowButton_Cust"></asp:Label><br />
            <asp:Button ID="SearchAll_Cust" CommandName="btnSearchAll_Cust" CssClass="btn btn-primary mar_top10"  Text="ALL" runat="server" /><br>
             
            </HeaderTemplate>
                <ItemTemplate>
                    <asp:CheckBox ID="chkSearch_Cust" runat="server" CssClass="mar_top10" Enabled="true" />
                </ItemTemplate>
                <ControlStyle Width="70px" />
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
