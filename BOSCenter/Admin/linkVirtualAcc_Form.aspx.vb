...
Public Class linkVirtualAcc_Form
        ...
        Try
            ...
            If ddlTransferToAgent.SelectedValue.ToString.Contains(":") Then
                ...
                If btn_update.Text.Trim.ToUpper = "Update".Trim.ToUpper Then
                    insrtQry = "update  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration Set easeBuzz_Virtual_Acc_No='" & v_Accountno & "', easeBuzz_IFSC='" & v_IFSC & "', easeBuzz_Virtual_UPI_ID='" & v_UPIID & "', easeBuzz_QrCode='" & v_UPIQRCode & "'  where RegistrationId='" & aa(0) & "'"
                End If
