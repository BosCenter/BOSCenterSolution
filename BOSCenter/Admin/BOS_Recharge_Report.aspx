<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_Recharge_Report.aspx.vb" Inherits="BOSCenter.BOS_Recharge_Report" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Recharge & Bill Payment Report"></asp:Label>	
                    </div>
                </div>
            </div>
...
<div class="row">
   ...
   <div class="col-sm-2">
                          ...
                          <asp:DropDownList ID="ddlMode" cssclass="form-control inputtext" runat="server" AutoPostBack="true">
                        <asp:ListItem>ALL MODE</asp:ListItem>                          
