<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_Link_Customer_Accounts.aspx.vb" Inherits="BOSCenter.BOS_Link_Customer_Accounts" %>
   ...
   <div class="col-sm-12">
    ...
    <asp:ListItem>:::: Select Customer ::::</asp:ListItem>
         ...
         <asp:DropDownList ID="ddlTransferToAgent" cssclass="form-control" runat="server"  AutoPostBack="True">
             ...
             <ajaxToolkit:ListSearchExtender ID="ddlTransferToAgent_ListSearchExtender" runat="server" Enabled="True" 
                 IsSorted="True" QueryPattern="Contains" TargetControlID="ddlTransferToAgent" >
...
<asp:Label ID="lblError" runat="server" Text="" Visible ="false"></asp:Label>
    <asp:Label ID="lbl_result" runat="server" Text="" Visible ="false"></asp:Label>
        ...
        <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="Button2" PopupControlID="DeleteDocumentPopup"  BackgroundCssClass="modalBackground"  CancelControlID="btnCancelDeleteDocument">
