<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="SuperAdminSubModuleMaster.aspx.vb" Inherits="BOSCenter.SuperAdminSubModuleMaster" %>
        	...
        	<div class="log_form1">
                    ...
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Select Module Name</label>
                        <div class="col-sm-9">

                            <asp:DropDownList ID="ddlRefModule" runat="server" cssclass="form-control" 
                                AutoPostBack="True">
                            </asp:DropDownList>
                      ...
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Main Module Order</label>
                        <div class="col-sm-9">
                      ...
                      <div class="clearfix" style="margin-bottom:5px;"></div>
                       ...
                       <div class="form-group">
                        ...
                        <label for="inputEmail3" class="col-sm-3 control-label">
                            <asp:Label ID="lblRefSubModule" runat="server" Text="Enter Sub Module"  ></asp:Label>
                            </label>
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtRefSubModule" cssclass="form-control inputtext" 
...
<div class="clearfix" style="margin-bottom:5px;"></div>
            ...
            <div class="form-group">
                      ...
                      <div class="clearfix" style="margin-bottom:5px;"></div>
                       ...
                       <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">
                        <asp:Label ID="lblRefSubModule_Order" runat="server" Text="Enter Sub Module Order"   ></asp:Label>
                        </label>
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtRefSubModule_Order" cssclass="form-control inputtext" 
                                runat="server"  ClientIDMode="Static" ></asp:TextBox>
                        </div>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <asp:Label ID="lblSessionFlag" runat="server" Visible="False"></asp:Label>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic"
                                ControlToValidate="ddlRefModule" ErrorMessage="Select Module Name" CssClass="errorlabels" InitialValue=":::: Select Module ::::"  
                                ...
                                ControlToValidate="txtRefSubModule_Order" ErrorMessage="Enter Order of Sub Module " CssClass="errorlabels"  
                                 ValidationGroup="a"></asp:RequiredFieldValidator>
                            ...
                            <asp:Label ID="lblOldRefSubModule_Order" runat="server" Visible="False"></asp:Label>
                 ...
                 <div class="table-responsive">
                    ...
                    <div class="clearfix"></div>
                       ...
                       <asp:BoundField DataField="SrNo" HeaderText="SrNo"  />
                              <asp:BoundField DataField="ModuleName" HeaderText="Module_Name"  />
                              <asp:BoundField DataField="OrderNo" HeaderText="Module_Order" />
                              <asp:BoundField  DataField="RefSubModule" HeaderText="Sub_Module" />
                              <asp:BoundField DataField="RefSubModule_Order" HeaderText="Sub_Module_Order" />
