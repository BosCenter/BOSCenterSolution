<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Admin/SuperAdmin.Master"   CodeBehind="BOS_MakePayment_Report_SA.aspx.vb" Inherits="BOSCenter.BOS_MakePayment_Report_SA" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Make Payment Report"></asp:Label>	
                    </div>
                </div>
            </div>
         ...
         <div class="row">
                      ...
                      <div class="col-sm-4">
                          <asp:CheckBox ID="chkduration" runat="server" 
                              Text="&nbsp;Apply Payment Date" AutoPostBack="True" />
                      ...
                      <label for="inputEmail3" class="col-sm-1 control-label" style="padding-right: 14px;"> Criteria</label>
                        <div class="col-sm-3">
                          <asp:DropDownList ID="ddlSelectCriteria" cssclass="form-control"  runat="server" >
                                ...
                                <asp:ListItem>RegistrationId</asp:ListItem>
                                <asp:ListItem>PaymentMode</asp:ListItem>
                                <asp:ListItem>RefrenceID</asp:ListItem>
