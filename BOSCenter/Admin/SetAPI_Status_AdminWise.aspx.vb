...
Public Class SetAPI_Status_AdminWise
    ...
    Public Sub Bind()
        Try
            ...
            Querystring = "select RID as SrNo,(CONVERT(VARCHAR(11),RegisterationDate,106)) as Registration_Date,CompanyCode,CompanyName,DatabaseName,ContactPerson,Mobile_No,RechargeAPI_Status as 'RechargeAPI',RechargeAPI_2_Status as 'RechargeAPI2', MoneyTransferAPI_Status as 'MoneyTransferAPI', MoneyTransferAPI_2_Status as 'MoneyTransferAPI2', PANCardAPI_Status as 'PANCardAPI',AEPS_API_Status as 'AEPS_API',Payin_API_Status as Payin_API,Payin_API_2_Status as Payin_API2,Payout_API_2_Status as 'Payout_API',Payout_API_Status as 'Payout_API2', convert(numeric(18,0), isnull(HoldAmt,0)) as 'HoldAmt',HoldAmtRemarks from  " & GV.DefaultDatabase.Trim & ".dbo.[BOS_ClientRegistration]   order by  RegisterationDate desc"
            ...
            If Not Querystring = "" Then
                ...
                If GridView1.Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To GridView1.Rows.Count - 1
                        ...
                        Dim lnk_Payout_API As LinkButton = DirectCast(GridView1.Rows(i).FindControl("lnk_Payout_API"), LinkButton)
                        Dim lnk_Payout_API_2 As LinkButton = DirectCast(GridView1.Rows(i).FindControl("lnk_Payout_API_2"), LinkButton)
                        Dim lnk_Payin_API As LinkButton = DirectCast(GridView1.Rows(i).FindControl("lnk_Payin_API"), LinkButton)
                        Dim lnk_Payin_API_2 As LinkButton = DirectCast(GridView1.Rows(i).FindControl("lnk_Payin_API_2"), LinkButton)
                        ...
                        If lnk_Payout_API.Text.Trim.ToUpper = "Active".Trim.ToUpper Then
                            lnk_Payout_API.CssClass = "btn btn-success mar_top10"

                        ElseIf lnk_Payout_API.Text.Trim.ToUpper = "InActive".Trim.ToUpper Then
                            lnk_Payout_API.CssClass = "btn btn-danger mar_top10"
                        End If

                        If lnk_Payout_API_2.Text.Trim.ToUpper = "Active".Trim.ToUpper Then
                            lnk_Payout_API_2.CssClass = "btn btn-success mar_top10"

                        ElseIf lnk_Payout_API_2.Text.Trim.ToUpper = "InActive".Trim.ToUpper Then
                            lnk_Payout_API_2.CssClass = "btn btn-danger mar_top10"
                        End If

                        If lnk_Payin_API.Text.Trim.ToUpper = "Active".Trim.ToUpper Then
                            lnk_Payin_API.CssClass = "btn btn-success mar_top10"

                        ElseIf lnk_Payin_API.Text.Trim.ToUpper = "InActive".Trim.ToUpper Then
                            lnk_Payin_API.CssClass = "btn btn-danger mar_top10"
                        End If

                        If lnk_Payin_API_2.Text.Trim.ToUpper = "Active".Trim.ToUpper Then
                            lnk_Payin_API_2.CssClass = "btn btn-success mar_top10"

                        ElseIf lnk_Payin_API_2.Text.Trim.ToUpper = "InActive".Trim.ToUpper Then
                            lnk_Payin_API_2.CssClass = "btn btn-danger mar_top10"
                        End If
    ...
    Protected Sub lnk_Payout_API_GridView_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            QryStr = "Update " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration set Payout_API_2_Status='" & status & "' where CompanyCode='" & CompanyCode & "';"

            Dim dbName As String = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(4).Text)
            If Not dbName.Trim = "" Then
                If Not dbName.Trim = "BosCenter_DB" Then
                    QryStr = QryStr & " Update " & dbName.Trim & ".dbo.BOS_ClientRegistration set Payout_API_2_Status='" & status & "'  where CompanyCode='" & CompanyCode & "';"
                End If
            End If
    ...
    Protected Sub lnk_Payout_API_2_GridView_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            QryStr = "Update " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration set Payout_API_Status='" & status & "' where CompanyCode='" & CompanyCode & "';"

            Dim dbName As String = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(4).Text)
            If Not dbName.Trim = "" Then
                If Not dbName.Trim = "BosCenter_DB" Then
                    QryStr = QryStr & " Update " & dbName.Trim & ".dbo.BOS_ClientRegistration set Payout_API_Status='" & status & "'  where CompanyCode='" & CompanyCode & "';"
                End If
            End If
    ...
    Protected Sub lnk_Payin_API_GridView_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            QryStr = "Update " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration set Payin_API_Status='" & status & "' where CompanyCode='" & CompanyCode & "';"

            Dim dbName As String = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(4).Text)
            If Not dbName.Trim = "" Then
                If Not dbName.Trim = "BosCenter_DB" Then
                    QryStr = QryStr & " Update " & dbName.Trim & ".dbo.BOS_ClientRegistration set Payin_API_Status='" & status & "'  where CompanyCode='" & CompanyCode & "';"
                End If
            End If
    ...
    Protected Sub lnk_Payin_API_2_GridView_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            QryStr = "Update " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration set Payin_API_2_Status='" & status & "' where CompanyCode='" & CompanyCode & "';"

            Dim dbName As String = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(4).Text)
            If Not dbName.Trim = "" Then
                If Not dbName.Trim = "BosCenter_DB" Then
                    QryStr = QryStr & " Update " & dbName.Trim & ".dbo.BOS_ClientRegistration set Payin_API_2_Status='" & status & "'  where CompanyCode='" & CompanyCode & "';"
                End If
            End If
