...
Public Class BOS_Link_Customers_UPI_QRCode
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                'If rb_qrcode.Checked = True Then
                '    txtUpiUrl.Enabled = True
                'ElseIf rb_urlwise.Checked = True Then
                '    `Url.Enabled = False
                'End If
            End If
                    ...
                    If ds.Tables.Count > 0 Then
                        If ds.Tables(0).Rows.Count > 0 Then
                            ...
                            Else
                                ...
                                txtUpiUrl.Text = String.Empty
                            End If
                            If Not IsDBNull(ds.Tables(0).Rows(0).Item("StaticQRCodeUrl")) Then
                                If Not ds.Tables(0).Rows(0).Item("StaticQRCodeUrl").ToString = "" Then
                                    txtUpiUrl.Text = ds.Tables(0).Rows(0).Item("StaticQRCodeUrl").ToString
                                Else
                                    txt_upi_id.Text = ""
                                    txtUpiUrl.Text = String.Empty
                                End If
        ...
        Try
            ...
            If ddlTransferToAgent.SelectedValue.ToString.Contains(":") Then
                ...
                If Not btn_UPIQRCode_Upload.ToolTip.Trim = "" Then
                    ...
                    v_UPIQRCode = "~/DistributorDocuments/" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & "/" & aa(0) & "/" & fi.Name
                Else
                    v_UPIQRCode = ""
                End If
                ...
                If btn_update.Text.Trim.ToUpper = "Update".Trim.ToUpper Then
                    insrtQry = "update  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration Set easeBuzz_Virtual_UPI_ID='" & v_UPIID & "', easeBuzz_QrCode='" & v_UPIQRCode & "',StaticQRCodeUrl='" & txtUpiUrl.Text & "'  where RegistrationId='" & aa(0) & "'"
                End If
            ...
            If btnDelete_Document.Text = "Yes" Then
                If ddlTransferToAgent.SelectedValue.ToString.Contains(":") Then
                    ...
                    If lblDeleteDocumentInfo.Text = "UPIQRCode" Then
                        ...
                        qry = "update BOS_Dis_SubDis_Retailer_Registration  set easeBuzz_QrCode='' where RegistrationId='" & aa(0) & "' "
