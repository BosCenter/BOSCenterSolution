<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="Admin_BankAccount_Master.aspx.vb" Inherits="BOSCenter.Admin_BankAccount_Master" %>
    	...
    	<div class="col-sm-8 col-sm-offset-2">
        	...
        	<div class="log_form1">
                    ...
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Account Holder Name</label>
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtAccountHolderName" cssclass="form-control inputtext" 
                        ...
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtAccountNo" cssclass="form-control inputtext" 
                                  runat="server"  ClientIDMode="Static" ></asp:TextBox>
                        </div>
                      </div>
                        ...
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtIFSCCode" cssclass="form-control inputtext" 
                                  runat="server"  ClientIDMode="Static" ></asp:TextBox>
                        </div>
                      </div>
                        ...
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtBankName" cssclass="form-control inputtext" 
                                  runat="server"  ClientIDMode="Static" ></asp:TextBox>
                        </div>
                      </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtBranchName" cssclass="form-control inputtext" 
                                  runat="server"  ClientIDMode="Static" ></asp:TextBox>
                        </div>
                      </div>
                       <div class="clearfix" style="margin-bottom:5px;"></div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <asp:TextBox ID="txtPanNo" cssclass="form-control inputtext" 
                                  runat="server"  ClientIDMode="Static" ></asp:TextBox>
                        </div>
                      </div>
                    ...
                    <div class="col-sm-3">
                          ...
                          <div class="col-sm-9">
                           <asp:Button ID="btnSave" runat="server" Text="Save"  OnClientClick="this.disabled='true'; this.value='wait...';" UseSubmitBehavior="false" 
...
<%--
            ...
            <ItemTemplate>
                <%# Container.DataItemIndex + 1%>
                              ...
                              <asp:BoundField HeaderText="A/C HolderName" DataField="AccountHolder_Name" />
                              <asp:BoundField HeaderText="A/C No" DataField="AccountNo" />
                              <asp:BoundField HeaderText="IFSC_Code" DataField="IFSC_Code" />
                              <asp:BoundField HeaderText="Bank_Name" DataField="Bank_Name" />
                              <asp:BoundField HeaderText="BranchName" DataField="BranchName" />
                              <asp:BoundField HeaderText="AccountType" DataField="AccountType" />
                              <asp:BoundField HeaderText="ServiceCharge" DataField="PanNo" />
...
<td align="center" bgcolor="Silver"   >&nbsp;</td>
    ...
    <tr>
        <td align="center">
            <asp:Button ID="btnok" runat="server" Text="OK" Width="80px" CssClass="btn btn-primary" OnClick="btnDeleteRow_Click" OnClientClick="this.disabled='true'; this.value='wait...';" UseSubmitBehavior="false" />
            &nbsp;&nbsp;&nbsp;
