<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_ProductServiceMaster_AD.aspx.vb" Inherits="BOSCenter.BOS_ProductServiceMaster_AD" %>
...
<ContentTemplate>
	...
	<div class="row">
    	<div class ="col-sm-10 col-sm-offset-1">
        	...
        	<div class="log_form1">
            	 <div class="form-group">
                     ...
                     <div class="clearfix" style="margin-bottom:5px;"></div>
                        <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Master Distributor Comm. <asp:Label ID="Label1"  ForeColor="Red" runat="server" Text=" *"></asp:Label></label>
                        <div class="col-sm-4">
        ...
        runat="server" Enabled="True" FilterType="Custom" ValidChars=".0123456789" 
                       ...
                       <div class="clearfix" style="margin-bottom:5px;"></div>
                  <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Service Charge Type <asp:Label ID="Label5"  ForeColor="Red" runat="server" Text=" *"></asp:Label></label>
                        <div class="col-sm-4">
                            <asp:DropDownList ID="ddl_Service_Charge_Type" cssclass="form-control"  runat="server" >
...
<%--
         ...
         <asp:BoundField HeaderText="ServiceCharge" DataField="ServiceCharge" />
                          <asp:BoundField HeaderText="Mas_Dis_Comm_Type" DataField="CommissionType" />
                        <asp:BoundField HeaderText="Mas_Dis_Comm" DataField="Commission" />
