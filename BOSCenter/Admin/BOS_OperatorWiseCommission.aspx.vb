...
Public Class BOS_OperatorWiseCommission
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            Dim V_Sub_Dis_CommissionType, V_Sub_Dis_Commission, V_Retailer_CommissionType, V_Retailer_Commission, V_Customer_CommissionType, V_Customer_Commission, V_Service_Charge_Type As String
            ...
            If ddl_Retailer_Customer_ServiceChargeType.SelectedIndex = 0 Then
                lblError.Text = "Please Select Service Charge Type."
                lblError.CssClass = "errorlabels"
                ddl_Retailer_Customer_ServiceChargeType.Focus()
                Exit Sub
            Else
                V_Service_Charge_Type = (ddl_Retailer_Customer_ServiceChargeType.SelectedValue)
            End If
            ...
            If lblSessionFlag.Text = 0 Then
                ...
                Else
                    QryStr = "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_OperatorWiseCommission (ServiceType,ServiceCharge,Customer_CommissionType,Customer_Commission,Sub_Dis_CommissionType,Sub_Dis_Commission,Retailer_CommissionType,Retailer_Commission,APIName,Category,Code,OperatorName,Dis_CommissionType,Dis_Commission,ActiveStatus,UpdatedBy,UpdatedOn,Service_Charge_Type) values('" & VServiceType & "'," & VServiceCharge & ",'" & V_Customer_CommissionType & "'," & V_Customer_Commission & ",'" & V_Sub_Dis_CommissionType & "'," & V_Sub_Dis_Commission & ",'" & V_Retailer_CommissionType & "'," & V_Retailer_Commission & ",'" & VAPIName & "','" & VCategory & "','" & VCode & "','" & VOperatorName & "','" & VCommissionType & "'," & VCommission & ",'" & VStatus & "','" & VUpdatedBy & "'," & VUpdatedOn & ",'" & V_Service_Charge_Type & "' );"
