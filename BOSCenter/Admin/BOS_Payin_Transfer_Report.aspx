<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_Payin_Transfer_Report.aspx.vb" Inherits="BOSCenter.BOS_Payin_Transfer_Report" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Payin Transation Details"></asp:Label>	
                    </div>
                </div>
            </div>
                   ...
                   <%-- <asp:CalendarExtender ID="txtFrom_CalendarExtender" runat="server" 
                        ...
                        <div class="col-sm-4">
                            ...
                            <asp:CalendarExtender ID="txtTO_CalendarExtender" runat="server"
                               Enabled="True" TargetControlID="txtTO" Format="dd/MM/yyyy" >
                            </asp:CalendarExtender>
