...
Public Class BOS_ProductServiceMaster_AD
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            Dim V_Sub_Dis_CommissionType, V_Sub_Dis_Commission, V_Retailer_CommissionType, V_Retailer_Commission, V_Customer_CommissionType, V_Customer_Commission, VSlabApplicable, V_Retailer_Customer_ServiceChargeType As String
            ...
            If ddl_Service_Charge_Type.SelectedIndex = 0 Then
                lblError.Text = "Please Select Service Charge Type."
                lblError.CssClass = "errorlabels"
                ddl_Service_Charge_Type.Focus()
                Exit Sub
            Else
                V_Retailer_Customer_ServiceChargeType = GV.parseString(ddl_Service_Charge_Type.SelectedValue)
            End If
            ...
            If lblSessionFlag.Text = 0 Then
                ...
                Else
                    QryStr = "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_ProductServiceMaster (Customer_CommissionType,Customer_Commission,SlabApplicable,CommissionType,Commission,Sub_Dis_CommissionType,Sub_Dis_Commission,Retailer_CommissionType,Retailer_Commission,ServiceType,ServiceCharge,CanChange,ContainCategory,ProductType,Title,ActiveStatus,UpdatedBy,UpdatedOn,Service_Charge_Type) values('" & V_Customer_CommissionType & "'," & V_Customer_Commission & ",'" & VSlabApplicable & "','" & VCommisonType & "','" & VCommison & "','" & V_Sub_Dis_CommissionType & "'," & V_Sub_Dis_Commission & ",'" & V_Retailer_CommissionType & "'," & V_Retailer_Commission & ",'" & VServiceType & "'," & VServiceCharge & ",'" & VCanChange & "','" & VContainCategory & "','" & Vtype & "','" & Vtitle & "','" & VStatus & "','" & VUpdatedBy & "'," & VUpdatedOn & ",'" & V_Retailer_Customer_ServiceChargeType & "' );"
