Public Class API_Balance_Report
        ...
        Try
            If Not IsPostBack Then
                ...
                ElseIf group.Trim.ToUpper = "Distributor".Trim.ToUpper Then
                    ...
                    ddlSelectCriteria.Items.Add("Agent ID")
                    ddlSelectCriteria.Items.Add("Name")
                ElseIf Not (group.Trim.ToUpper = "Retailer".Trim.ToUpper Or group.Trim.ToUpper = "Customer".Trim.ToUpper Or group.Trim.ToUpper = "Master Distributor".Trim.ToUpper Or group.Trim.ToUpper = "Super Admin".Trim.ToUpper Or group.Trim.ToUpper = "Admin".Trim.ToUpper) Then
                    ddlAgentType.Items.Add("All AgentType")
                    ddlAgentType.Items.Add("Customer")
                    ddlAgentType.Items.Add("Master Distributor")
                    ddlAgentType.Items.Add("Retailer")
        ...
        Try
            ...
            ElseIf group.Trim.ToUpper = "Admin".Trim.ToUpper Then
                ...
                If group.Trim.ToUpper = "Admin".ToUpper Then
                    ...
                    ',AgentPassword as 'Password',TransactionPin as 'Pin'
                End If
                ...
                If Not Querystring = "" Then
                    ...
                    If GridView1.Rows.Count > 0 Then
                        ...
                        For i As Integer = 0 To GridView1.Rows.Count - 1
                            ...
                            ' GridView1.Rows(i).Cells(10).Text = GV.parseString(GV.DecryptString(GV.key, GridView1.Rows(i).Cells(10).Text.Trim))
            ...
            ElseIf Not (group.Trim.ToUpper = "Retailer".Trim.ToUpper Or group.Trim.ToUpper = "Customer".Trim.ToUpper Or group.Trim.ToUpper = "Master Distributor".Trim.ToUpper Or group.Trim.ToUpper = "Super Admin".Trim.ToUpper Or group.Trim.ToUpper = "Admin".Trim.ToUpper) Then
                ...
                MoreColumns = " ,AgentPassword as 'Password',RefrenceID as 'RefrenceID' "
    ...
    'Remove Password And Pin 12/04/23
    'Public Sub Bind()
    '    Try
    '        Dim Loginid As String = ""
    '        Dim group As String = GV.get_SuperAdmin_SessionVariables("Group", Request, Response)
    ...
    '            If group.Trim.ToUpper = "Admin".ToUpper Then
    '                'MoreColumns = " ,AgentPassword as 'Password'"
    '            End If
    ...
    '            MoreColumns = " RefrenceID as 'RefrenceID' "

    '            ' ,AgentPassword as 'Password',
