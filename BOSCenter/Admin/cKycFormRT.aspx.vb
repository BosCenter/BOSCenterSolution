...
Public Class cKycFormRT
    ...
    Private Sub btnPopupYes_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPopupYes.Click
        Try
            ...
            If Not txtReferenceNo.Text.Trim = "" Then
                VReferenceNo = GV.parseString(txtReferenceNo.Text.Trim)
            Else
                VReferenceNo = ""
            End If
            ...
            Dim VAddharCardBack_Path, VAddharCardFront_PAth, VPhoto_Path As String
            ...
            If Not btnUpload_AddharCardBack.ToolTip.Trim = "" Then
                ...
                VAddharCardBack_Path = "~/DistributorDocuments/" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & "/" & VRequestID & "/" & fi.Name
            Else
            ...
            If Not btnUpload_AddharCardFront.ToolTip.Trim = "" Then
                ...
                VAddharCardFront_PAth = "~/DistributorDocuments/" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & "/" & VRequestID & "/" & fi.Name
            Else
            ...
            If Not btnUpload_Photo.ToolTip.Trim = "" Then
                ...
                VPhoto_Path = "~/DistributorDocuments/" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & "/" & VRequestID & "/" & fi.Name
            Else
                VPhoto_Path = ""
            End If
            ...
            If btnSave.Text.Trim.ToUpper = "Submit".Trim.ToUpper Then
                ...
                If GV.FL.RecCount(" " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Card_Kyc_RT_Details Where RequestID='" & VRequestID & "' ") > 0 Then 'Change where condition according to Criteria 
                    lblError.Text = "Record Already Exists."
                    lblError.CssClass = "errorlabels"
                    Exit Sub
                End If
                Dim QryStr As String = "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Card_Kyc_RT_Details (ReferenceNumber,UploadAddharCard_Front,UploadAddharCard_Back,UploadPhoto,kCode,kCodeType,RequestID,RequestDate,ApprovedBy,ApprovedDateTime,ApporvedStatus,ApporveRemakrs,Salutation,FirstName,MiddleName,LastName,Address,PhoneNo,AadharNumber,CardNumber,WebFpData,WebImgFpData1,WebImgFpData2,WebImgFpData3,CompanyCode,RecordDateTime,UpdatedBy,UpdatedOn) values('" & VReferenceNo & "','" & VAddharCardFront_PAth & "','" & VAddharCardBack_Path & "','" & VPhoto_Path & "','" & VkCode & "','" & VkCodeType & "', '" & VRequestID & "','" & VRequestDate & "','" & VApprovedBy & "',NULL,'" & VApporvedStatus & "','" & VApporveRemakrs & "','" & VSalutation & "','" & VFirstName & "','" & VMiddleName & "','" & VLastName & "','" & VAddress & "','" & VPhoneNo & "','" & VAadharNumber & "','" & VCardNumber & "','" & VWebFpdata & "','" & VWebFigureData1 & "','" & VWebFigureData2 & "','" & VWebFigureData3 & "','" & VCompanyCode & "','" & VRecordDateTime & "','" & VUpdatedBy & "','" & VUpdatedOn & "' )"
                ...
                If GV.FL.DMLQueries(QryStr) = True Then
                    ...
                    Dim destinationpath As String = "~/DistributorDocuments/" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & "/" & VRequestID
                    If Not btnUpload_AddharCardBack.ToolTip.Trim = "" Then
    ...
    Public Sub FillPreviousData()
        Try
            If GV.FL.RecCount(" " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Card_Kyc_RT_Details Where kCode='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' ") > 0 Then
                div_req.Visible = True

                DS = GV.FL.OpenDs(" " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Card_Kyc_RT_Details Where kCode='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' ")
                If Not DS Is Nothing Then
                    If DS.Tables.Count > 0 Then
        ...
        Try
            ...
            If imagUpload.HasFile = True Then
                ...
                If (UCase(Session("ext")) = UCase(".jpg")) Or (UCase(Session("ext")) = UCase(".jpeg")) Or (UCase(Session("ext")) = UCase(".png")) Or (UCase(Session("ext")) = UCase(".gif")) Then
                    ...
                    completeFilePath = Server.MapPath("~/Temp" & "/" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & "/" & txtRequestID.Text.Trim & "_" & imgstr & Session("ext"))
                    imgPath = "~/Temp" & "/" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & "/" & txtRequestID.Text.Trim & "_" & imgstr & Session("ext")
        ...
        Try
            ...
            If btnDelete_Document.Text = "Yes" Then
                ...
                ElseIf lblDeleteDocumentInfo.Text = "AddharCardFront" Then
                    ...
                    qry = "update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Card_Kyc_RT_Details set UploadAddharCard_Front=''  where RequestID='" & VRequestID & "' "
                ...
                ElseIf lblDeleteDocumentInfo.Text = "AddharCardBack" Then
                    ...
                    File.Delete(Server.MapPath(imgpath))
                    qry = "update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Card_Kyc_RT_Details set UploadAddharCard_Back=''  where RequestID='" & VRequestID & "'"
                ...
                ElseIf lblDeleteDocumentInfo.Text = "Photo" Then
                    ...
                    File.Delete(Server.MapPath(imgpath))
                    qry = "update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Card_Kyc_RT_Details set UploadPhoto=''  where RequestID='" & VRequestID & "' "
