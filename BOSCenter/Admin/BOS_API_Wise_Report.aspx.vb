        ...
        End Try
            ...
            ElseIf GV.parseString(ddlAmountType.SelectedValue.Trim).ToUpper = "Commission".Trim.ToUpper Then
                ...
                If ddlTransferToAgent.SelectedItem.Text = "ALL ADMIN" Then
                    ...
                    If chkduration.Checked = True Then
                        Querystring = " (select RID as 'Sr No',  API_TransId COLLATE DATABASE_DEFAULT as 'TRANSACTION NO',  Ref_TransID COLLATE DATABASE_DEFAULT as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom COLLATE DATABASE_DEFAULT as 'TRANSFER FROM',  TransferTo COLLATE DATABASE_DEFAULT as 'TRANSFER TO',  Remark COLLATE DATABASE_DEFAULT as 'COMMISSION TYPE',  0 as 'CR',  TransferAmt as 'DR',  '0' as 'BALANCE',  TransferFromMsg COLLATE DATABASE_DEFAULT as 'REMARKS'     from BosCenter_DB.dbo.BOS_TransferAmountToAgents  where  TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & "    )   
                                        union   
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  TransferAmt as 'CR',  0 as 'DR',  '0' as 'BALANCE',  TransferToMsg as 'REMARKS'    from BosCenter_DB.dbo.BOS_TransferAmountToAgents where TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & ")   
                                        union  
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  0 as 'CR',  TransferAmt as 'DR',  '0' as 'BALANCE',  TransferFromMsg as 'REMARKS'     from CMP1085.dbo.BOS_TransferAmountToAgents  where  TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & "  )  
                                        union  
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  TransferAmt as 'CR',  0 as 'DR',  '0' as 'BALANCE',  TransferToMsg as 'REMARKS'    from CMP1085.dbo.BOS_TransferAmountToAgents where TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & ")  
                                        union  
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  0 as 'CR',  TransferAmt as 'DR',  '0' as 'BALANCE',  TransferFromMsg as 'REMARKS'     from CMP1174.dbo.BOS_TransferAmountToAgents  where  TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & ")   
                                        union
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  TransferAmt as 'CR',  0 as 'DR',  '0' as 'BALANCE',  TransferToMsg as 'REMARKS'    from CMP1174.dbo.BOS_TransferAmountToAgents where TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & "   )  
                                        union
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  0 as 'CR',  TransferAmt as 'DR',  '0' as 'BALANCE',  TransferFromMsg as 'REMARKS'     from CMP1179.dbo.BOS_TransferAmountToAgents  where  TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & ") 
                                        union
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  TransferAmt as 'CR',  0 as 'DR',  '0' as 'BALANCE',  TransferToMsg as 'REMARKS'    from CMP1179.dbo.BOS_TransferAmountToAgents where TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & "   )   
                                        union
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  0 as 'CR',  TransferAmt as 'DR',  '0' as 'BALANCE',  TransferFromMsg as 'REMARKS'     from CMP1207.dbo.BOS_TransferAmountToAgents  where  TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & ")   
                                        union
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  TransferAmt as 'CR',  0 as 'DR',  '0' as 'BALANCE',  TransferToMsg as 'REMARKS'    from CMP1207.dbo.BOS_TransferAmountToAgents where TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & ")   
                                        union
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  0 as 'CR',  TransferAmt as 'DR',  '0' as 'BALANCE',  TransferFromMsg as 'REMARKS'     from CMP1218.dbo.BOS_TransferAmountToAgents  where  TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & ")   
                                        union
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  TransferAmt as 'CR',  0 as 'DR',  '0' as 'BALANCE',  TransferToMsg as 'REMARKS'    from CMP1218.dbo.BOS_TransferAmountToAgents where TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & ")  
                                        union 
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  0 as 'CR',  TransferAmt as 'DR',  '0' as 'BALANCE',  TransferFromMsg as 'REMARKS'     from CMP1223.dbo.BOS_TransferAmountToAgents  where  TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & ") 
                                        union
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  TransferAmt as 'CR',  0 as 'DR',  '0' as 'BALANCE',  TransferToMsg as 'REMARKS'    from CMP1223.dbo.BOS_TransferAmountToAgents where TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & ")   
                                        union
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  0 as 'CR',  TransferAmt as 'DR',  '0' as 'BALANCE',  TransferFromMsg as 'REMARKS'     from CMP1278.dbo.BOS_TransferAmountToAgents  where  TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & ")  
                                        union
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  TransferAmt as 'CR',  0 as 'DR',  '0' as 'BALANCE',  TransferToMsg as 'REMARKS'    from CMP1278.dbo.BOS_TransferAmountToAgents where TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and RecordDateTime between '" & GV.returnDateMonthWiseWithDateChecking(txtFrom.Text) & " 00:00:00.000' and '" & GV.returnDateMonthWiseWithDateChecking(txtTO.Text) & " 23:59:59.999'    and Amount_Type='Commission'  " & Service_Type & ") order by rid desc  "
                    Else
                        Querystring = " (select RID as 'Sr No',  API_TransId COLLATE DATABASE_DEFAULT as 'TRANSACTION NO',  Ref_TransID COLLATE DATABASE_DEFAULT as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom COLLATE DATABASE_DEFAULT as 'TRANSFER FROM',  TransferTo COLLATE DATABASE_DEFAULT as 'TRANSFER TO',  Remark COLLATE DATABASE_DEFAULT as 'COMMISSION TYPE',  0 as 'CR',  TransferAmt as 'DR',  '0' as 'BALANCE',  TransferFromMsg COLLATE DATABASE_DEFAULT as 'REMARKS'     from BosCenter_DB.dbo.BOS_TransferAmountToAgents  where  TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and  Amount_Type='Commission'  " & Service_Type & ")   
                                        union 
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  TransferAmt as 'CR',  0 as 'DR',  '0' as 'BALANCE',  TransferToMsg as 'REMARKS'    from BosCenter_DB.dbo.BOS_TransferAmountToAgents where TransferTo in ('Super Admin')    and Amount_Type='Commission'   )  
                                        union 
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  0 as 'CR',  TransferAmt as 'DR',  '0' as 'BALANCE',  TransferFromMsg as 'REMARKS'     from CMP1085.dbo.BOS_TransferAmountToAgents  where  TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and  Amount_Type='Commission'  " & Service_Type & ")  
                                        union   
                                        (select RID as 'Sr No',  API_TransId as 'TRANSACTION NO',  Ref_TransID as 'UPIRefID',  convert(varchar, RecordDateTime, 106) as 'DATE',  LTRIM(RIGHT(CONVERT(VARCHAR(20), RecordDateTime, 100), 7)) as 'TIME',  TransferFrom as 'TRANSFER FROM',  TransferTo as 'TRANSFER TO',  Remark as 'COMMISSION TYPE',  TransferAmt as 'CR',  0 as 'DR',  '0' as 'BALANCE',  TransferToMsg as 'REMARKS'    from CMP1085.dbo.BOS_TransferAmountToAgents where TransferFrom in (" & loginID & ") " & Filter_apiPartnerTrans & " and  Amount_Type='Commission'  " & Service_Type & ")
