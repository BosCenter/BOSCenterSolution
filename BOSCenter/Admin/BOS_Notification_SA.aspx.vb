...
Public Class BOS_Notification_SA
    ...
    Private Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                GV.FL.AddInDropDownListAll(ddl_Admin, "CompanyCode +':'+ CompanyName", "" & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration where not CompanyCode='cmp1045' order by RID Desc")
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            If ddl_Admin.SelectedIndex = 0 Then
                ...
                If iserrorfound = False Then
                    iserrorfound = True
                    ddl_Admin.CssClass = "ValidationError"
            ...
            Else
                ...
                ddl_Admin.CssClass = "form-control"
            End If
            ...
            If btnSave.Text = "Save" Then
                If GV.FL.RecCount(" " & GV.DefaultDatabase.Trim & ".dbo.Bos_Notification_Master_SA Where AgentType='" & AgentType & "' ") > 0 Then 'Change where condition according to Criteria 
            ...
            Else
                If GV.FL.RecCount(" " & GV.DefaultDatabase.Trim & ".dbo.Bos_Notification_Master_SA Where (AgentType='" & AgentType & "' and not AgentType='" & lblOld_value.Text.Trim & "')") > 0 Then 'Change where condition according to Criteria 
                    lblError.Text = "Record Already Exists."
                    lblError.CssClass = "errorlabels"
                    Exit Sub
                End If
    ...
    Private Sub btnPopupYes_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPopupYes.Click
        Try
            If Session("Workfor") = "Delete" Then
                ...
                Dim QryStr As String = "delete from  " & GV.DefaultDatabase.Trim & ".dbo.Bos_Notification_Master_SA where RID=" & lblRID.Text.Trim & ""
            ...
            If ddl_Admin.Items.Count > 0 Then
                If Not ddl_Admin.SelectedValue.Trim = "" Then
                    Dim dd() As String = ddl_Admin.SelectedValue.Split(":")
                    AgentType = dd(0)
                Else
                    AgentType = ""
            ...
            If Not btnUpload_OriginalPic.ToolTip.Trim = "" Then
                ...
                Dim dd() As String = ddl_Admin.SelectedValue.Split(":")
                NotificationPic = "~/MakePaymentDocs/" & CompanyCode.Trim & "_" & dd(0).Trim & "_" & fi.Name.Trim
            Else
                NotificationPic = ""
            End If
            ...
            If Session("EditFlag") = 0 Then
                ...
                Dim QryStr As String = "insert into  " & GV.DefaultDatabase.Trim & ".dbo.Bos_Notification_Master_SA (NotificationID, NotificationDate, AgentType, ActiveStatus, NotificationPic, RecordDatetime, UpdatedOn, UpdatedBy) values( '" & NotificationID & " ','" & NotificationDate & " ','" & AgentType & " ','" & ActiveStatus & " ','" & NotificationPic & " ','" & RecordDatetime & "','" & UpdatedOn & "','" & UpdatedBy & "' )"
                If GV.FL.DMLQueries(QryStr) = True Then
            ...
            ElseIf Session("EditFlag") = 1 Then
                ...
                Dim QryStr As String = "update  " & GV.DefaultDatabase.Trim & ".dbo.Bos_Notification_Master_SA set  AgentType='" & AgentType & "', ActiveStatus='" & ActiveStatus & "', NotificationPic='" & NotificationPic & "', UpdatedBy='" & UpdatedBy & "', UpdatedOn='" & UpdatedOn & "'  where RID=" & lblRID.Text.Trim & ""
                If GV.FL.DMLQueries(QryStr) = True Then
                    Dim destinationpath As String = "~/MakePaymentDocs/"
                    If Not btnUpload_OriginalPic.ToolTip.Trim = "" Then
    ...
    Public Sub Bind()
        Try
            ...
            Dim qry As String = "select RID as SrNo,NotificationID,(CONVERT(VARCHAR(11),NotificationDate,106)) as NotificationDate,(select CompanyCode+':'+CompanyName from BOS_ClientRegistration CL where CL.CompanyCode=NM.AgentType) as [AgentType],[NotificationPic],[ActiveStatus] from  " & GV.DefaultDatabase.Trim & ".dbo.Bos_Notification_Master_SA  NM order by RID desc  "
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            Dim lblgrdRID As Label = DirectCast(GridView1.Rows(gvrow.RowIndex).FindControl("lblgrdRID"), Label)
            lblRID.Text = lblgrdRID.Text
            Dim ss() As String = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(5).Text).Split(":")

            lblOld_value.Text = GV.parseString(ss(0).Trim)
            ...
            ddl_Admin.SelectedValue = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(5).Text)
            ...
            DS = GV.FL.OpenDs(" " & GV.DefaultDatabase.Trim & ".dbo.Bos_Notification_Master_SA where RID=" & lblRID.Text & "")
    ...
    Protected Sub ImagebtnExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ImagebtnExcel.Click
        Try
            ' Dim Excelqry As String = "select RID as SrNo, Product_Date,Product_OrderCategory,Product_Code,Product_Descp,Product_BrandCode,Product_Num,Product_Pic from Bos_Notification_Master_SA "
            If GridView1.Rows.Count > 0 Then
    ...
    Protected Sub ImagebtnWOrd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ImagebtnWOrd.Click
        Try
            'Dim Wordqry As String = "select RID as SrNo, Product_Date,Product_OrderCategory,Product_Code,Product_Descp,Product_BrandCode,Product_Num,Product_Pic from Bos_Notification_Master_SA "
            If GridView1.Rows.Count > 0 Then
    ...
    Protected Sub Imagepdf_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Imagepdf.Click
        Try
            ' Dim PDFqry As String = "select RID as SrNo, Product_Date,Product_OrderCategory,Product_Code,Product_Descp,Product_BrandCode,Product_Num,Product_Pic from Bos_Notification_Master_SA "
            If GridView1.Rows.Count > 0 Then
        ...
        Try
            ...
            If btnDelete_Document.Text = "Yes" Then
                ...
                If lblDeleteDocumentInfo.Text = "ProductImage" Then
                    ...
                    qry = "update  " & GV.DefaultDatabase.Trim & ".dbo.Bos_Notification_Master_SA set NotificationPic=''  where NotificationID='" & txtNotificationID.Text.Trim & "';"
