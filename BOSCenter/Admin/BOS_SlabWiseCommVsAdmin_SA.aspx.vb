...
Public Class BOS_SlabWiseCommVsAdmin_SA
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                ' GV.FL.AddInDropDownListDistinct(ddl_Slab, "APIName", "" & GV.DefaultDatabase.Trim & ".dbo.BOS_CommissionSlabwise_SA where  ")
                ...
                ddl_AD_ServiceChargeType.SelectedIndex = 0
                ddl_SA_ServiceChargeType_SelectedIndexChanged(sender, e)
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            Dim V_AD_CommissionType, V_AD_Commission, V_AD_ServiceChargeType, V_AD_ServiceCharge As String

            V_AD_CommissionType = ""
            V_AD_Commission = "0"
            V_AD_ServiceChargeType = ""
            V_AD_ServiceCharge = "0"
            VFromAmount = "0"
            VToAmount = "0"
            ...
            If ddl_AD_ServiceChargeType.SelectedIndex = 0 Then
                V_AD_ServiceChargeType = GV.parseString(ddl_AD_ServiceChargeType.SelectedValue.Trim)
            Else
                If txt_AD_ServiceCharge.Text = "" Then
                    lblError.Text = "Please Enter Admin Service Charge."
                    lblError.CssClass = "errorlabels"
                    txt_AD_ServiceCharge.Focus()
                    Exit Sub
                Else
                    V_AD_ServiceCharge = GV.parseString(txt_AD_ServiceCharge.Text.Trim)
                End If
                V_AD_ServiceChargeType = GV.parseString(ddl_AD_ServiceChargeType.SelectedValue.Trim)
            End If

            If GV.parseString(V_AD_ServiceCharge.Trim) = "" Then
                V_AD_ServiceCharge = "0"
            End If
            ...
            If lblSessionFlag.Text = 0 Then
                ...
                Else
                    QryStr = "insert into " & GV.DefaultDatabase.Trim & ".dbo.BOS_CommissionSlabwiseVsAdmin_SA (AdminID,Admin_CommissionType,Admin_Commission,APIName,FromAmount,ToAmount,UpdatedBy,UpdatedOn, Admin_ServiceChargeType, Admin_ServiceCharge) values('" & VAdminID & "','" & V_AD_CommissionType & "'," & V_AD_Commission & ",'" & VAPIName & "','" & VFromAmount & "','" & VToAmount & "','" & VUpdatedBy & "'," & VUpdatedOn & " ,'" & V_AD_ServiceChargeType & "','" & V_AD_ServiceChargeType & "');"
            ...
            ElseIf lblSessionFlag.Text = 1 Then
                QryStr = "update " & GV.DefaultDatabase.Trim & ".dbo.BOS_CommissionSlabwiseVsAdmin_SA set Admin_CommissionType='" & V_AD_CommissionType & "',Admin_Commission=" & V_AD_Commission & ", Admin_ServiceChargeType='" & V_AD_ServiceChargeType & "', Admin_ServiceCharge='" & V_AD_ServiceCharge & "' ,UpdatedBy='" & VUpdatedBy & "', UpdatedOn=" & VUpdatedOn & " where RID=" & lblRID.Text.Trim & " ;"
    ...
    Private Sub Clear()
        Try
            ...
            ddl_AD_ServiceChargeType.SelectedIndex = 0
            If ddl_AD_ServiceChargeType.SelectedIndex = 0 Then
                txt_AD_ServiceCharge.Text = "0"
                txt_AD_ServiceCharge.Enabled = False
                txt_AD_ServiceCharge.CssClass = "form-control"
            End If
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            ddl_AD_ServiceChargeType.SelectedValue = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(8).Text)
            ddl_SA_ServiceChargeType_SelectedIndexChanged(sender, e)
            txt_AD_ServiceCharge.Text = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(9).Text)
    ...
    Protected Sub ddl_SA_ServiceChargeType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddl_AD_ServiceChargeType.SelectedIndexChanged
        Try
            txt_AD_ServiceCharge.Enabled = True
            txt_AD_ServiceCharge.CssClass = "form-control"
            If ddl_AD_ServiceChargeType.SelectedIndex = 0 Then
                txt_AD_ServiceCharge.Text = "0"
                txt_AD_ServiceCharge.Enabled = False
