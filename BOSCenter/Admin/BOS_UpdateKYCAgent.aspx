...
<div class="col-md-4">
<div class="form-group">
<label for='txtPanCardNumber'>  Pan Card Number <asp:Label ID="Label5" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
...
<asp:MaskedEditExtender ID="MaskedEditExtender1" runat="server" Mask="99/99/9999"  Enabled="True" MaskType="Date" TargetControlID="txtDOB">
...
<div class="col-md-4">
<div class="form-group">
<label for='txtAlternateMobileNo'>  Alternate Mobile  No</label>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtPincode'>  Pin Code<asp:Label ID="Label19" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
