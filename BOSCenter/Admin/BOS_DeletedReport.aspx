<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_DeletedReport.aspx.vb" Inherits="BOSCenter.BOS_DeletedReport" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Deleted Mas Dis / Dis / Cust / Retailer Report"></asp:Label>	
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                          <asp:CheckBox ID="chkduration" runat="server" 
                              Text="&nbsp;Apply Deleted Date" AutoPostBack="True" />
                   ...
                   <div class="row">
                      ...
                      <div class="form-group">
                       <div class="col-sm-3">
                        ...
                        <asp:ListItem>All Agents</asp:ListItem>
