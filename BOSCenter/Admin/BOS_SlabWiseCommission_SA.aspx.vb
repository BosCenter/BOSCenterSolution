...
Public Class BOS_SlabWiseCommission_SA
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                ddl_SA_Service_Charge.SelectedIndex = 0
                ddl_SA_Service_Charge_SelectedIndexChanged(sender, e)
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            Dim V_SA_CommissionType, V_SA_Commission, V_SA_ServiceChargeType, V_SA_ServiceCharge As String

            V_SA_CommissionType = ""
            V_SA_Commission = "0"
            V_SA_ServiceChargeType = ""
            V_SA_ServiceCharge = "0"
            ...
            If ddl_SA_Service_Charge.SelectedIndex = 0 Then
                V_SA_ServiceChargeType = GV.parseString(ddl_SA_Service_Charge.SelectedValue.Trim)
            Else
                If txt_Service_Charge.Text = "" Then
                    lblError.Text = "Please Enter Service Charge."
                    lblError.CssClass = "errorlabels"
                    txt_Service_Charge.Focus()
                    Exit Sub
                Else
                    V_SA_ServiceCharge = GV.parseString(txt_Service_Charge.Text.Trim)
                End If
                V_SA_ServiceChargeType = GV.parseString(ddl_SA_Service_Charge.SelectedValue.Trim)
            End If
            ...
            If lblSessionFlag.Text = 0 Then
                ...
                Else
                    QryStr = "insert into " & GV.DefaultDatabase.Trim & ".dbo.BOS_CommissionSlabwise_SA (SA_CommissionType,SA_Commission,APIName,FromAmount,ToAmount,UpdatedBy,UpdatedOn,SA_ServiceChargeType,SA_ServiceCharge) values('" & V_SA_CommissionType & "'," & V_SA_Commission & ",'" & VAPIName & "','" & VFromAmount & "','" & VToAmount & "','" & VUpdatedBy & "'," & VUpdatedOn & ",'" & V_SA_ServiceChargeType & "','" & V_SA_ServiceCharge & "' );"
            ...
            ElseIf lblSessionFlag.Text = 1 Then
                QryStr = "update " & GV.DefaultDatabase.Trim & ".dbo.BOS_CommissionSlabwise_SA set FromAmount='" & VFromAmount & "',ToAmount='" & VToAmount & "',SA_CommissionType='" & V_SA_CommissionType & "',SA_Commission=" & V_SA_Commission & ",SA_ServiceChargeType='" & V_SA_ServiceChargeType & "',SA_ServiceCharge='" & V_SA_ServiceCharge & "', UpdatedBy='" & VUpdatedBy & "', UpdatedOn=" & VUpdatedOn & " where RID=" & lblRID.Text.Trim & " ;"
    ...
    Private Sub Clear()
        Try
            ...
            If ddl_SA_Service_Charge.SelectedIndex = 0 Then
                ...
                txt_Service_Charge.Enabled = False
                txt_Service_Charge.CssClass = "form-control"
            End If
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            ddl_SA_Service_Charge.SelectedValue = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(7).Text)
            ddl_SA_Service_Charge_SelectedIndexChanged(sender, e)
            txt_Service_Charge.Text = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(8).Text)
    ...
    Protected Sub ddl_SA_Service_Charge_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddl_SA_Service_Charge.SelectedIndexChanged
        Try
            txt_Service_Charge.Enabled = True
            txt_Service_Charge.CssClass = "form-control"
            If ddl_SA_Service_Charge.SelectedIndex = 0 Then
                txt_Service_Charge.Text = "0"
                txt_Service_Charge.Enabled = False
