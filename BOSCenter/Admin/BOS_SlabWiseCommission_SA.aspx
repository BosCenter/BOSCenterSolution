<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_SlabWiseCommission_SA.aspx.vb" Inherits="BOSCenter.BOS_SlabWiseCommission_SA" %>
	...
	<div class="row">
    	<div class ="col-sm-11 col-sm-offset-1">
        	...
        	<div class="log_form1">
                       ...
                       <div class="clearfix" style="margin-bottom:5px;"></div>
                        ...
                        <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">From Amount <asp:Label ID="lblStarCommissionType" ForeColor="Red" runat="server" Text=" *"></asp:Label></label>
                        <div class="col-sm-3">
                            <asp:TextBox ID="txtFromAmount" cssclass="form-control" runat="server" 
                                MaxLength="7"></asp:TextBox>
                            <asp:FilteredTextBoxExtender ID="txtFromAmount_FilteredTextBoxExtender" 
                                runat="server" Enabled="True" FilterType="Numbers" 
                                TargetControlID="txtFromAmount">
                            </asp:FilteredTextBoxExtender>
                        </div>
                        <label for="inputEmail3" class="col-sm-2 control-label">To Amount <asp:Label ID="Label4" ForeColor="Red" runat="server" Text=" *"></asp:Label></label>
                        <div class="col-sm-4">
                            <asp:TextBox ID="txtToAmount" cssclass="form-control" runat="server" 
                                MaxLength="7"></asp:TextBox>
                            <asp:FilteredTextBoxExtender ID="txtToAmount_FilteredTextBoxExtender" 
                                runat="server" Enabled="True" FilterType="Numbers" 
                                TargetControlID="txtToAmount">
                            </asp:FilteredTextBoxExtender>
                        </div>
                      ...
                      <div class="clearfix" style="margin-bottom:5px;"></div>
                        ...
                        <div class="col-sm-4">
                         ...
                         <div class="col-sm-5">
                            <asp:TextBox ID="txt_SA_Commission" cssclass="form-control" runat="server" 
                                 MaxLength="7"></asp:TextBox>
        ...
        runat="server" Enabled="True" FilterType="Custom" ValidChars=".0123456789" 
                 ...
                 <div class="clearfix" style="margin-bottom:5px;"></div>
                        ...
                        <div class="col-sm-4">
                            <asp:DropDownList ID="ddl_SA_Service_Charge" cssclass="form-control"  runat="server" 
                                AutoPostBack="True">
                            <asp:ListItem>Not Applicable</asp:ListItem>
                            <asp:ListItem>Percentage</asp:ListItem>
                            <asp:ListItem>Amount</asp:ListItem>
                         ...
                         <div class="col-sm-5">
                            <asp:TextBox ID="txt_Service_Charge" cssclass="form-control" runat="server" 
                                 MaxLength="7"></asp:TextBox>
                            <asp:FilteredTextBoxExtender ID="txtFilteredServiceCharge" 
        runat="server" Enabled="True" FilterType="Custom" ValidChars=".0123456789" 
                                 TargetControlID="txt_Service_Charge">
    </asp:FilteredTextBoxExtender>
                        </div>
                    </div>
                                      <div class="clearfix" style="margin-bottom:5px;"></div>
...
<%--
         ...
         <asp:BoundField HeaderText="ToAmount" DataField="ToAmount" />
                  <asp:BoundField HeaderText="SA_Comm_Type" DataField="SA_CommissionType" />
                     ...
                     <asp:BoundField HeaderText="SA_ServiceCharge_Type" DataField="SA_ServiceChargeType" />
                        <asp:BoundField HeaderText="SA_Service Charge" DataField="SA_ServiceCharge" />
                          </Columns>
