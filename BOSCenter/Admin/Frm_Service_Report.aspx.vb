...
Public Class Frm_Service_Report
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                lblHeading.Text = "Search Service Report"
    ...
    Public Sub Bind()
        Try
            ...
            'Frm_Digital_signature
            'Frm_FOOD_LICENCE
            'Frm_Gazzet
            'Frm_Gst_Registration
            'Frm_IT_Return
            'Frm_NSDC_Details
            'Frm_Passport_Sewa
            'Frm_Shop_Act
            'frm_Udyam_Registration
            'Frm_Voter_Id
            'Frm_Pan_Card_Form



            Dim AgentFilter As String = ""

            If GV.parseString(ddlAgentType.SelectedValue).Trim.ToUpper = "Shop Act".Trim.ToUpper Then
                If chkduration.Checked = True Then
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " and  EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,SelectTitle,ApplicantFirstName,ApplicantMiddleName,ApplicantLastName,ApplicantFatherFirstName,ApplicantFatherMiddleName,ApplicantFatherLastName,DOB,Gender,CardName,AadhaarNumber,NameonAadhaar,MobileNumber,Email,PanDeliveryState,ProofOfIdentity,ProofOfAddress,ProofOfDOB,HouseNo_Building_Landmark,Statusofapplicant,RegistrationNumberforcompany_firms_LLPs,SourceofIncome,Village,Post1,Post2,District,DistrictArea,AREACODE,AOType,RANGECODE,AONO,State,Pin from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Pan_Card_Form  where  RecordDateTime between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & " 00:00:00.000' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & " 23:59:59.999' " & AgentFilter & "  order by  RID Desc"
                Else
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " where EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,SelectTitle,ApplicantFirstName,ApplicantMiddleName,ApplicantLastName,ApplicantFatherFirstName,ApplicantFatherMiddleName,ApplicantFatherLastName,DOB,Gender,CardName,AadhaarNumber,NameonAadhaar,MobileNumber,Email,PanDeliveryState,ProofOfIdentity,ProofOfAddress,ProofOfDOB,HouseNo_Building_Landmark,Statusofapplicant,RegistrationNumberforcompany_firms_LLPs,SourceofIncome,Village,Post1,Post2,District,DistrictArea,AREACODE,AOType,RANGECODE,AONO,State,Pin from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Pan_Card_Form  " & AgentFilter & "   order by  RID Desc"
                End If
            ElseIf GV.parseString(ddlAgentType.SelectedValue).Trim.ToUpper = "Udyam Registration".Trim.ToUpper Then

                If chkduration.Checked = True Then
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " and  EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.frm_Udyam_Registration  where  RecordDateTime between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & " 00:00:00.000' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & " 23:59:59.999' " & AgentFilter & "  order by  RID Desc"
                Else
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " where EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.frm_Udyam_Registration  " & AgentFilter & "   order by  RID Desc"
                End If

            ElseIf GV.parseString(ddlAgentType.SelectedValue).Trim.ToUpper = "Food Licence".Trim.ToUpper Then
                'Frm_FOOD_LICENCE
                ...
                If chkduration.Checked = True Then
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " and  EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_FOOD_LICENCE  where  RecordDateTime between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & " 00:00:00.000' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & " 23:59:59.999' " & AgentFilter & "  order by  RID Desc"
                Else
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " where EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_FOOD_LICENCE  " & AgentFilter & "   order by  RID Desc"
                End If

            ElseIf GV.parseString(ddlAgentType.SelectedValue).Trim.ToUpper = "GST Registration".Trim.ToUpper Then
                ...
                If chkduration.Checked = True Then
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " and  EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Gst_Registration  where  RecordDateTime between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & " 00:00:00.000' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & " 23:59:59.999' " & AgentFilter & "  order by  RID Desc"
                Else
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " where EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Gst_Registration  " & AgentFilter & "   order by  RID Desc"
                End If
            ElseIf GV.parseString(ddlAgentType.SelectedValue).Trim.ToUpper = "Passport Sewa".Trim.ToUpper Then
                ...
                If chkduration.Checked = True Then
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " and  EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Passport_Sewa  where  RecordDateTime between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & " 00:00:00.000' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & " 23:59:59.999' " & AgentFilter & "  order by  RID Desc"
                Else
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " where EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Passport_Sewa  " & AgentFilter & "   order by  RID Desc"
                End If
            ElseIf GV.parseString(ddlAgentType.SelectedValue).Trim.ToUpper = "Digital Signature".Trim.ToUpper Then
                'Frm_Digital_signature
                If chkduration.Checked = True Then
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " and  EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Digital_signature  where  RecordDateTime between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & " 00:00:00.000' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & " 23:59:59.999' " & AgentFilter & "  order by  RID Desc"
                Else
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " where EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Digital_signature  " & AgentFilter & "   order by  RID Desc"
                End If
            ElseIf GV.parseString(ddlAgentType.SelectedValue).Trim.ToUpper = "Voter ID".Trim.ToUpper Then
                ...
                If chkduration.Checked = True Then
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " and  EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Voter_Id  where  RecordDateTime between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & " 00:00:00.000' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & " 23:59:59.999' " & AgentFilter & "  order by  RID Desc"
                Else
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " where EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Voter_Id  " & AgentFilter & "   order by  RID Desc"
                End If
            ElseIf GV.parseString(ddlAgentType.SelectedValue).Trim.ToUpper = "IT Return".Trim.ToUpper Then
                ...
                If chkduration.Checked = True Then
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " and  EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_IT_Return  where  RecordDateTime between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & " 00:00:00.000' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & " 23:59:59.999' " & AgentFilter & "  order by  RID Desc"
                Else
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " where EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_IT_Return  " & AgentFilter & "   order by  RID Desc"
                End If
            ElseIf GV.parseString(ddlAgentType.SelectedValue).Trim.ToUpper = "Gazzet".Trim.ToUpper Then
                ...
                If chkduration.Checked = True Then
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " and  EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Gazzet  where  RecordDateTime between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & " 00:00:00.000' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & " 23:59:59.999' " & AgentFilter & "  order by  RID Desc"
                Else
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " where EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Gazzet  " & AgentFilter & "   order by  RID Desc"
                End If
            ElseIf GV.parseString(ddlAgentType.SelectedValue).Trim.ToUpper = "NSDC Form".Trim.ToUpper Then
                ...
                If chkduration.Checked = True Then
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " and  EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_NSDC_Details  where  RecordDateTime between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & " 00:00:00.000' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & " 23:59:59.999' " & AgentFilter & "  order by  RID Desc"
                Else
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " where EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_NSDC_Details  " & AgentFilter & "   order by  RID Desc"
                End If
            ElseIf GV.parseString(ddlAgentType.SelectedValue).Trim.ToUpper = "Pan Card".Trim.ToUpper Then
                ...
                If chkduration.Checked = True Then
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " and  EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Pan_Card_Form  where  RecordDateTime between  '" & GV.FL.returnDateMonthWise(txtFrom.Text) & " 00:00:00.000' and '" & GV.FL.returnDateMonthWise(txtTO.Text) & " 23:59:59.999' " & AgentFilter & "  order by  RID Desc"
                Else
                    If Not (GV.get_SuperAdmin_SessionVariables("Group", Request, Response).Trim.ToUpper = "ADMIN") Then
                        AgentFilter = " where EntryBy='" & GV.get_SuperAdmin_SessionVariables("LoginID", Request, Response).Trim & "' "
                    End If
                    Querystring = "select RID as SrNo,EntryBy as 'AgentID',(CONVERT(VARCHAR(11),RecordDateTime,106)) as ApplyDate,* from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Pan_Card_Form  " & AgentFilter & "   order by  RID Desc"
                End If
            ...
            If Not Querystring = "" Then
                ...
                If GridView1.Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To GridView1.Rows.Count - 1
                        ...
                        If group1 = "Admin" Or group1 = "Super Admin" Then
    ...
    Protected Sub ImagebtnExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImagebtnExcel.Click
        Try
            If Not lblExportQry.Text = "" Then
                If GridView1.Rows.Count > 0 Then
                    GV.ExportToExcel_New(GridView1, Response, "", "ServiceReport", lblExportQry.Text, "dyanamic")
                End If
            End If
    ...
    Protected Sub ImagebtnWOrd_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImagebtnWOrd.Click
        Try
            If Not lblExportQry.Text = "" Then
                If GridView1.Rows.Count > 0 Then
                    GV.ExportToWord_New(GridView1, Response, "ServiceReport", lblExportQry.Text, "dyanamic")
                End If
            End If
        Catch ex As Exception
            GV.logerrors(ex.Message + "StackTrace : " + ex.StackTrace)
    ...
    Protected Sub ExportToPdf_DivTag_HavingGridview(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles Imagepdf.Click
        Try
            If Not lblExportQry.Text = "" Then
                If GridView1.Rows.Count > 0 Then
                    GV.ExportToPdf_New(GridView1, "", Response, "ServiceReport  ", lblExportQry.Text, "dyanamic")
                End If
            End If
        Catch ex As Exception
            GV.logerrors(ex.Message + "StackTrace : " + ex.StackTrace)
