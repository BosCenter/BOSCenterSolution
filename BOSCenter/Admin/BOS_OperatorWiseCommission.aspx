<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_OperatorWiseCommission.aspx.vb" Inherits="BOSCenter.BOS_OperatorWiseCommission" %>
	...
	<div class="row">
    	<div class ="col-sm-11 col-sm-offset-1">
        	...
        	<div class="log_form1">
                     ...
                     <div class="clearfix" style="margin-bottom:5px;"></div>
                 <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label"> Select Operator <asp:Label ID="Label5"  ForeColor="Red" runat="server" Text=" *"></asp:Label></label>
                        <div class="col-sm-9">
                            <asp:DropDownList ID="ddl_OperatorName" cssclass="form-control"  runat="server" AutoPostBack="true">
                      ...
                      <div class="clearfix" style="margin-bottom:5px;"></div>
                        <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Master Distributor Comm. <asp:Label ID="lblStarServiceType"  ForeColor="Red" runat="server" Text=" *"></asp:Label></label>
                        <div class="col-sm-4">
        ...
        runat="server" Enabled="True" FilterType="Custom" ValidChars=".0123456789" TargetControlID="txtServiceCharge">
                 ...
                 <div class="clearfix" style="margin-bottom:5px;"></div>
                        ...
                        <label for="inputEmail3" class="col-sm-3 control-label">Service Charge Type <asp:Label ID="Label6"  ForeColor="Red" runat="server" Text=" *"></asp:Label></label>
                        <div class="col-sm-4">
                            <asp:DropDownList ID="ddl_Retailer_Customer_ServiceChargeType" cssclass="form-control"  runat="server" 
                                >
                            <asp:ListItem>Select Service Charge Type</asp:ListItem>
...
<%--
                 ...
                 <div class="table-responsive">
                    ...
                    <div class="clearfix"></div>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  cssclass="grid-view-themeclass"
                            BorderStyle="None" AllowPaging="True" PageSize="10">
         ...
         <asp:BoundField HeaderText="Mas_Dis_Comm_Type" DataField="Dis_CommissionType" />
                        <asp:BoundField HeaderText="Mas_Dis_Comm" DataField="Dis_Commission" />


                         <asp:BoundField HeaderText="Dis_Comm_Type" DataField="Sub_Dis_CommissionType" />
                        <asp:BoundField HeaderText="Dis_Comm" DataField="Sub_Dis_Commission" />
                    ...
                    <asp:BoundField HeaderText="ServiceType" DataField="ServiceType" />
                        <asp:BoundField HeaderText="ServiceCharge" DataField="ServiceCharge" />
                             <asp:BoundField HeaderText="ServiceChargeType" DataField="Service_Charge_Type" />
