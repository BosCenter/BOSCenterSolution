<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_CreateAgent.aspx.vb" Inherits="BOSCenter.BOS_CreateAgent" %>
...
<label for='txtAgentType'>  Agent Type</label>
...
<asp:TextBox ID='txtRefrenceID' runat='server' ReadOnly="true" placeholder='Registration ID' class='form-control'></asp:TextBox>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
<label for='txtRegistrationId'>  Refrence Type</label>
<asp:TextBox ID='txtRefrenceType' runat='server' ReadOnly="true" placeholder='Registration ID' class='form-control'></asp:TextBox>
</div>
</div>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtPanCardNumber'>  PanCard Number <asp:Label ID="Label5" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
<asp:TextBox ID='txtPanCardNumber' runat='server'  placeholder='PanCardNumber' class='form-control' MaxLength="10"></asp:TextBox>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtFirstName'>  First Name <asp:Label ID="Label6" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtDOB'>  DOB (DD/MM/YYYY)<asp:Label ID="Label7" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label>&nbsp;<asp:Label ID="lblDateError" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label> </label>
<asp:TextBox ID='txtDOB' runat='server'  placeholder='DOB' class='form-control' AutoPostBack="true"></asp:TextBox>
   
    <asp:MaskedEditExtender ID="MaskedEditExtender1" runat="server" Mask="99/99/9999"  Enabled="True" MaskType="Date" TargetControlID="txtDOB" Century="2000">
...
<div class="col-md-4">
<div class="form-group">
<label for='txtEmailID'>  Email ID <asp:Label ID="Label8" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label>&nbsp;<asp:Label ID="lblEmailError" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label></label>
<asp:TextBox ID='txtEmailID' runat='server'  placeholder='EmailID' class='form-control' AutoPostBack="true"></asp:TextBox>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
...
<div class="col-md-4">
<div class="form-group">
<label for='txtAlternateMobileNo'>  Alternate MobileNo</label>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtPermanentAddress'>  Permanent Address <asp:Label ID="Label10" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
<asp:TextBox ID='txtPermanentAddress' runat='server'  placeholder='PermanentAddress' class='form-control'></asp:TextBox>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
<label for='txtBusinessType'>  Business Type <asp:Label ID="Label11" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtOfficeAddress'>  Office Address<asp:Label ID="Label12" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtAddharCardNo'>  Addhar Card No <asp:Label ID="Label16" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
<asp:TextBox ID='txtAddharCardNo' runat='server'  placeholder='AddharCardNo' class='form-control' MaxLength="12"></asp:TextBox>
    <asp:FilteredTextBoxExtender ID="txtAddharCardNo_FilteredTextBoxExtender" runat="server" BehaviorID="txtAddharCardNo_FilteredTextBoxExtender" FilterType="Numbers" TargetControlID="txtAddharCardNo" ValidChars="1234567890" />
</div>
</div>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtAddharCardNo'>  Credit Bal Limit<asp:Label ID="Label17" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtBusinessType'>  Status <asp:Label ID="Label18" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtAgeProof'>  Selfy With Document</label>

<div style="margin-bottom:5px;"></div>
  
<asp:FileUpload ID="FileUpload_SelfyWithDocument" runat="server"  />

    <asp:Button ID="btnUpload_SelfyWithDocument" runat="server" 
        Text="Upload" />
    &nbsp;<asp:Button ID="btnDeleteUpload_SelfyWithDocument" runat="server" 
         Text="Remove" Enabled="False" />
    <asp:Image ID="Image_SelfyWithDocument" runat="server" BorderStyle="None" CssClass="" 
        Height="61px" ImageUrl="~/images/uploadimage.png" Width="71px" />
    <asp:Label ID="lblErrorImage_SelfyWithDocument" runat="server"></asp:Label>
</div>
</div>
</div>
<div class="row">
<div class="col-md-4">
<div class="form-group">
<label for='txtAgeProof'>  Upload Signature</label>

<div style="margin-bottom:5px;"></div>
  
<asp:FileUpload ID="FileUpload_UploadSignature" runat="server"  />

    <asp:Button ID="btnUpload_UploadSignature" runat="server" 
        Text="Upload" />
    &nbsp;<asp:Button ID="btnDeleteUpload_UploadSignature" runat="server" 
         Text="Remove" Enabled="False" />
    <asp:Image ID="Image_UploadSignature" runat="server" BorderStyle="None" CssClass="" 
        Height="61px" ImageUrl="~/images/uploadimage.png" Width="71px" />
    <asp:Label ID="lblErrorImage_UploadSignature" runat="server"></asp:Label>
</div>
</div>
</div>
...
<asp:PostBackTrigger ControlID="btnUpload_UploadSignature"  />
<asp:AsyncPostBackTrigger ControlID="btnDeleteUpload_UploadSignature"   EventName="Click" />

<asp:PostBackTrigger ControlID="btnUpload_SelfyWithDocument"  />
<asp:AsyncPostBackTrigger ControlID="btnDeleteUpload_SelfyWithDocument"   EventName="Click" />
