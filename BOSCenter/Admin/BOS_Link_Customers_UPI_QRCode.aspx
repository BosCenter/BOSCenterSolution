<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_Link_Customers_UPI_QRCode.aspx.vb" Inherits="BOSCenter.BOS_Link_Customers_UPI_QRCode" %>
   ...
   <div class="col-sm-12">
    ...
    <asp:ListItem>:::: Select Customer ::::</asp:ListItem>
         ...
         <asp:DropDownList ID="ddlTransferToAgent" cssclass="form-control" runat="server"  AutoPostBack="True">
             ...
             <ajaxToolkit:ListSearchExtender ID="ddlTransferToAgent_ListSearchExtender" runat="server" Enabled="True" IsSorted="True" QueryPattern="Contains" TargetControlID="ddlTransferToAgent" >
                       ...
                       <div class="clearfix" style="margin-bottom:20px;"></div>
                        ...
                        <div class="col-sm-8">
                            <asp:TextBox ID="txt_upi_id"  cssclass="form-control" runat="server"></asp:TextBox>
                              ...
                              <%--  <div>  
                        <asp:RadioButton ID="rb_qrcode" runat="server" Text="QR Code Wise" GroupName="qrcode"  Checked="true" OnCheckedChanged="qrcode_CheckedChanged" />  
                        <asp:RadioButton ID="rb_urlwise" runat="server" Text="Url Wise" GroupName="qrcode" OnCheckedChanged="qrcode_CheckedChanged" />        
                        </div>--%>

                       <div class="clearfix" style="margin-bottom:20px;"></div>

                        <label for="inputUpiUrl" class="col-sm-4 control-label">UPI Url</label>
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtUpiUrl"  cssclass="form-control" runat="server"></asp:TextBox>
                        </div>
                         <div class="clearfix" style="margin-bottom:20px;"></div>
...
<asp:Label ID="lblError" runat="server" Text="" Visible ="false"></asp:Label>
    <asp:Label ID="lbl_result" runat="server" Text="" Visible ="false"></asp:Label>
        ...
        <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender4" runat="server" TargetControlID="Button2" PopupControlID="DeleteDocumentPopup"  BackgroundCssClass="modalBackground"  CancelControlID="btnCancelDeleteDocument">
