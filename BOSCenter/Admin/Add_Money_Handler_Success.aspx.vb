                    ...
                    If dbData(1).Trim.ToUpper = "WA" Then
                        ...
                        Try
                            ...
                            If Not GV.FL.RecCount(" " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents Where Amt_Transfer_TransID='" & VAmtTransTransID & "' ") > 0 Then 'Change where condition according to Criteria 
                                ...
                                Dim QryStr As String = "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Amt_Transfer_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values('" & GV.parseString(GV.GetIPAddress) & "','" & VAmtTransTransID & "','" & VAmtTransTransID & "','" & VTransferToMsg & "','" & VTransferFromMsg & "','" & AmouontType & "','" & "Add By Wallet - Gateway" & "','" & Now.Date.ToString("MM-dd-yyyy") & "','" & VTransferFrom & "','" & VTransferTo & "','" & VTransferAmt & "','" & Now.Date.ToString("MM-dd-yyyy") & "','Admin','" & Now.Date.ToString("MM-dd-yyyy") & "' ) ;"

                                QryStr = QryStr & " " & "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Amt_Transfer_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values('" & GV.parseString(GV.GetIPAddress) & "','" & VAmtTransTransID & "','" & VAmtTransTransID & "','" & VTransferToMsg & "','" & VTransferFromMsg & "','" & AmouontType & "','" & "Add By Wallet - Gateway" & "','" & Now.Date.ToString("MM-dd-yyyy") & "','ADMIN','SUPERADMIN','" & VTransferAmt & "','" & Now.Date.ToString("MM-dd-yyyy") & "','Admin','" & Now.Date.ToString("MM-dd-yyyy") & "' ) ;"
                                ...
                                If GV.FL.DMLQueries(QryStr) = True Then
                                    ...
                                    Dim Service1() As String = GV.FL.AddInVar("convert(nvarchar,ServiceCharge)+':'+ServiceType", dbName & ".dbo.BOS_ProductServiceMaster where Title='PayUMoney' ").Split(":")
                                    'After Discussion with Sir
                                    If VTransferAmt > 100 Then
                                    ...
                                    If NetAmount1 > 0 Then
                                        ...
                                        QryStr = "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_TransferAmountToAgents (TransIpAddress,API_TransId,Amt_Transfer_TransID,TransferToMsg,TransferFromMsg,Amount_Type,Remark,TransactionDate,TransferFrom,TransferTo,TransferAmt,RecordDateTime,UpdatedBy,UpdatedOn) values('" & GV.parseString(GV.GetIPAddress) & "','" & VAmtTransTransID & "','" & VAmtTransTransID & "','" & VTo & "','" & VFrom & "','" & "Service Charge" & "','" & "Service Charge" & "','" & Now.Date.ToString("MM-dd-yyyy") & "','" & RTE & "','ADMIN','" & NetAmount1 & "',getdate(),'Admin',getdate() ) ;"
