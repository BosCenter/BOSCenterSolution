...
Public Class BOS_ApproveKyc
    ...
    Public Sub Bind()
        Try
            ...
            ElseIf ddlSelectCriteria.SelectedValue.Trim.ToUpper = "Request ID".Trim.ToUpper Then
                Filter = " And RequestID  like '" & GV.parseString(txtSearchingValue.Text.Trim) & "%'"
            ElseIf ddlSelectCriteria.SelectedValue.Trim.ToUpper = "Registration ID".Trim.ToUpper Then
                Filter = " And KCode like '" & GV.parseString(txtSearchingValue.Text.Trim) & "%'"
            ElseIf ddlSelectCriteria.SelectedValue.Trim.ToUpper = "First Name".Trim.ToUpper Then
                Filter = " And FirstName like '" & GV.parseString(txtSearchingValue.Text.Trim) & "%'"
            End If
            Querystring = ""



            'select  RequestID,RequestDate,ApprovedBy,ApprovedDateTime,ApporvedStatus,ApporveRemakrs,Salutation,FirstName,MiddleName,LastName,Address,PhoneNo,AadharNumber,CardNumber,WebFpData,WebImgFpData1,WebImgFpData2,WebImgFpData3,CompanyCode,RecordDateTime,UpdatedBy,UpdatedOn  from BOS_Card_Kyc_Details ;
    ...
    Protected Sub UpdateDetails_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            ddlStatus.SelectedValue = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(10).Text) 'RefID
            txtRemarks.Text = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(11).Text)


            lblCompanyCode.Text = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(12).Text)
    ...
    Protected Sub ImagebtnExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImagebtnExcel.Click
        Try
            GV.ExportToExcel(GridView1, Response, "ApproveKycForm")
        Catch ex As Exception
            GV.logerrors(ex.Message + "StackTrace : " + ex.StackTrace)
        End Try
    ...
    Protected Sub ImagebtnPdf_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImagebtnPdf.Click
        Try
            GV.ExportToPdf(GridView1, Response, "ApproveKycForm")
        Catch ex As Exception
            GV.logerrors(ex.Message + "StackTrace : " + ex.StackTrace)
        End Try
    End Sub
    ...
    Protected Sub Imagebtnword_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImagebtnWOrd.Click
        Try
            GV.ExportToWord(GridView1, Response, "ApproveKycForm")
        Catch ex As Exception
            GV.logerrors(ex.Message + "StackTrace : " + ex.StackTrace)
        End Try
    End Sub
