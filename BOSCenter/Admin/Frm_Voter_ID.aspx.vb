Public Class Frm_Voter_ID
    ...
    Private Sub btnClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClear.Click
        Try
            ...
            Else
                ...
                txtNAMEOFPARLIMANTRY_ASSEMBLY.CssClass = "form-control"
                ...
                txtNAMEOFPARLIMANTRY_ASSEMBLY.Text = ""
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            Else
                txtApplicantFathersLastName.CssClass = "form-control"
                VApplicantFathersLastName = GV.parseString(txtApplicantFathersLastName.Text)
            End If
            ...
            If GV.parseString(txtNAMEOFPARLIMANTRY_ASSEMBLY.Text) = "" Then
                txtNAMEOFPARLIMANTRY_ASSEMBLY.CssClass = "ValidationError"
                isErrorFound = True
                If isFocusApplied = False Then
                    txtNAMEOFPARLIMANTRY_ASSEMBLY.Focus()
                    isFocusApplied = True
                End If
            Else
                txtNAMEOFPARLIMANTRY_ASSEMBLY.CssClass = "form-control"
                VNAMEOFPARLIMANTRY_ASSEMBLY = GV.parseString(txtNAMEOFPARLIMANTRY_ASSEMBLY.Text)
            End If
    ...
    Private Sub btnPopupYes_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPopupYes.Click
        Try
            If Session("Workfor") = "Delete" Then
                ...
                Dim QryStr As String = "delete from " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Voter_Id where RID=" & lblRID.Text.Trim & ""
            ...
            If Not txtNAMEOFPARLIMANTRY_ASSEMBLY.Text.Trim = "" Then
                VNAMEOFPARLIMANTRY_ASSEMBLY = GV.parseString(txtNAMEOFPARLIMANTRY_ASSEMBLY.Text.Trim)
            Else
                VNAMEOFPARLIMANTRY_ASSEMBLY = ""
            End If
            ...
            If Session("EditFlag") = 0 Then
                ...
                If GV.FL.RecCount("" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Voter_Id Where RID=" & lblRID.Text.Trim & " ") > 0 Then 'Change where condition according to Criteria 
                    lblError.Text = "Record Already Exists."
                    lblError.CssClass = "errorlabels"
                    Exit Sub
                End If
                Dim QryStr As String = "insert into " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Voter_Id (RecordDateTime, EntryBy,ApplicantLastName,ApplicantFirstName,ApplicantMiddleName,ApplicantFathersLastName,ApplicantFathersFirstName,ApplicantFathersMiddleName,MobileNumber,Email,MothersName,DOB,Gender,NAMEOFPARLIMANTRY_ASSEMBLY,MaritalStatus,States,District,Taluka,Village,Location,Street,BuildingName,HouseNo_Building_Landmark,Pin) values(  '" & VRecordDateTime & "','" & VEntryBy & "','" & VApplicantLastName & "','" & VApplicantFirstName & "','" & VApplicantMiddleName & "','" & VApplicantFathersLastName & "','" & VApplicantFathersFirstName & "','" & VApplicantFathersMiddleName & "','" & VMobileNumber & "','" & VEmail & "','" & VMothersName & "','" & VDOB & "','" & VGender & "','" & VNAMEOFPARLIMANTRY_ASSEMBLY & "','" & VMaritalStatus & "','" & VStates & "','" & VDistrict & "','" & VTaluka & "','" & VVillage & "','" & VLocation & "','" & VStreet & "','" & VBuildingName & "','" & VHouseNo_Building_Landmark & "','" & VPin & "' )"
                If GV.FL.DMLQueries(QryStr) = True Then
                    Clear()
        ...
        Try
            If Not IsPostBack Then
                ...
                If Not Session("RecordID") = "" And Session("RecordEdit") = 1 And Session("RecordEditConfirm") = 9 Then
                    ...
                    btnClear.Text = "Close"
                    btnDelete.Enabled = True
                    formheading_1.Text = "Edit VOTER ID "
                    DS = GV.FL.OpenDs("" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.Frm_Voter_Id where RID='" & Session("RecordID") & "'")
                    If Not DS Is Nothing Then
                        If DS.Tables.Count > 0 Then
                            ...
                            If Not IsDBNull(DS.Tables(0).Rows(0).Item("NAMEOFPARLIMANTRY_ASSEMBLY")) Then
                                If Not DS.Tables(0).Rows(0).Item("NAMEOFPARLIMANTRY_ASSEMBLY").ToString() = "" Then
                                    txtNAMEOFPARLIMANTRY_ASSEMBLY.Text = GV.parseString(DS.Tables(0).Rows(0).Item("NAMEOFPARLIMANTRY_ASSEMBLY").ToString())
                                Else
                                    txtNAMEOFPARLIMANTRY_ASSEMBLY.Text = ""
                                End If
                            Else
