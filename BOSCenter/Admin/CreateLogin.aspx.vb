...
Public Class CreateLogin
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            Dim Encrypted_Pass As String = GV.EncryptString(GV.key, VUser_Password.Trim)
            ...
            ElseIf lblSessionFlag.Text = 1 Then
                ...
                Else
                    ...
                    QryStr = "update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.CRM_Login_Details set  Encrypted_Pass='" & Encrypted_Pass & "' , CanLogin='" & VCanLogin & "',EmpType='" & VEmpType & "', EmailId='" & VEmailID & "',MobileNo='" & VMobileNO & "', ImagePath='" & VImagePath & "', Fromtime='" & fromTime & "', Totime='" & totime & "', User_Name='" & VUser_Name & "', User_Password='" & GV.EncryptString(GV.key, VUser_Password) & "', User_Type='" & VUser_Type & "', AccountStatus='" & VAccountStatus & "', UpdatedOn=getdate(), UpdatedBy='" & VUpdatedBy & "' where RID=" & lblRID.Text.Trim & ";"
