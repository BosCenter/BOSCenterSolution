...
Public Class SetAPI_Status_RetailerWise
    ...
    Protected Sub lnk_Payout_API_GridView_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            QryStr = "Update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration set Payout_API_2_Status='" & status & "' where RegistrationId='" & CompanyCode & "';"
    ...
    Protected Sub lnk_Payout_API_2_GridView_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            QryStr = "Update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration set Payout_API_Status='" & status & "' where RegistrationId='" & CompanyCode & "';"
    ...
    Protected Sub lnk_Payin_API_GridView_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            QryStr = "Update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration set Payin_API_Status='" & status & "' where RegistrationId='" & CompanyCode & "';"
    ...
    Protected Sub lnk_Payin_API_2_GridView_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            QryStr = "Update " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration set Payin_API_2_Status='" & status & "' where RegistrationId='" & CompanyCode & "';"
