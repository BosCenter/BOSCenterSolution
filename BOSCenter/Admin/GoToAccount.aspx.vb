Public Class GoToAccount
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        Try
            ...
            DataBaseName = GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response)

            If DataBaseName = "CMP1218" Then
                ...
                End If
                CMP1218Bind()
            ElseIf DataBaseName = "CMP1174" Then
                If Not ddlSelectCriteria.SelectedIndex = 0 Then
                    If txtSearchString.Text.Trim = "" Then
                        lblError1.Text = "Please Enter the Value"
                        lblError1.CssClass = "errorlabels"
        ...
        Try
            ...
            If group.Trim.ToUpper = "Super Admin".ToUpper Then
                If ddlSelectCriteria.SelectedValue = "All Records" Then
                    ...
                    Querystring = "select '0' as 'SrNo',CompanyName as 'Company Name',CompanyCode as 'Company Code',CinNo as 'Cin No',GSTNo as 'GST No',Status as 'Account Status',DatabaseName,Status as 'Status','0' as 'API Balance' from " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration  order by  rid Desc"
                ElseIf ddlSelectCriteria.SelectedValue = "Name" Then
                    Querystring = "select '0' as 'SrNo',CompanyName as 'Company Name',CompanyCode as 'Company Code',CinNo as 'Cin No',GSTNo as 'GST No',Status as 'Account Status',DatabaseName,Status as 'Status','0' as 'API Balance' from " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration Where CompanyName  like '" & GV.parseString(txtSearchString.Text.Trim) & "%' order by  rid Desc"
            ...
            If Not Querystring = "" Then
                ...
                If GridView1.Rows.Count > 0 Then
                    ...
                    Else
                        For i As Integer = 0 To GridView1.Rows.Count - 1
                            GridView1.Rows(i).Cells(9).Text = GV.returnAPIBalance(GV.parseString(GridView1.Rows(i).Cells(7).Text.Trim))
    ...
    Public Sub CMP1218Bind()
        Try
            ...
            Else
                If ddlSelectCriteria.SelectedValue = "All Records" Then
                    ddlSelectCriteria.Text = ""
                    Querystring = "select '0' as 'SrNo',(FirstName+' '+LastName) as Name,RegistrationId as 'Registration ID',AgentPassword As Password,AgentType as 'Agent Role',ActiveStatus as 'Status',(CONVERT(VARCHAR(11),RegistrationDate,106)) as 'Registration Date',AgencyName as 'Agency Name',MobileNo as 'Mobile No','0' as 'Wallet Bal' from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.[BOS_Dis_SubDis_Retailer_Registration] where AgentType='" & group & "' " & Loginid & "  order by  rid Desc"
                ElseIf ddlSelectCriteria.SelectedValue = "Name" Then
                    Querystring = "select '0' as 'SrNo',(FirstName+' '+LastName) as Name,RegistrationId as 'Registration ID',AgentPassword As Password,AgentType as 'Agent Role',ActiveStatus as 'Status',(CONVERT(VARCHAR(11),RegistrationDate,106)) as 'Registration Date',AgencyName as 'Agency Name',MobileNo as 'Mobile No','0' as 'Wallet Bal' from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.[BOS_Dis_SubDis_Retailer_Registration] Where AgentType='" & group & "' " & Loginid & "  and FirstName  like '" & GV.parseString(txtSearchString.Text.Trim) & "%' order by  rid Desc"
                ElseIf ddlSelectCriteria.SelectedValue = "Login ID" Then
                    Querystring = "select '0' as 'SrNo',(FirstName+' '+LastName) as Name,RegistrationId as 'Registration ID',AgentPassword As Password,AgentType as 'Agent Role',ActiveStatus as 'Status',(CONVERT(VARCHAR(11),RegistrationDate,106)) as 'Registration Date',AgencyName as 'Agency Name',MobileNo as 'Mobile No','0' as 'Wallet Bal' from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.[BOS_Dis_SubDis_Retailer_Registration] Where AgentType='" & group & "' " & Loginid & "  and RegistrationId='" & GV.parseString(txtSearchString.Text.Trim) & "'  order by  rid Desc"
                End If
            End If
    ...
    ' Update 4/12/23 Password and Pin
    'Public Sub Bind()
    '    Try
    '        Dim Loginid As String = ""
    '        Dim group As String = GV.get_SuperAdmin_SessionVariables("Group", Request, Response)
    ...
    '            If ddlSelectCriteria.SelectedValue = "All Records" Then
    '                ddlSelectCriteria.Text = ""
    '                Querystring = "select '0' as 'SrNo',CompanyName as 'Company Name',CompanyCode as 'Company Code',ClientPassword as 'Password',CinNo as 'Cin No',GSTNo as 'GST No',Status as 'Account Status',DatabaseName,ClientPin as 'Pin','0' as 'API Balance' from " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration  order by  rid Desc"
    '            ElseIf ddlSelectCriteria.SelectedValue = "Name" Then
    '                Querystring = "select '0' as 'SrNo',CompanyName as 'Company Name',CompanyCode as 'Company Code',ClientPassword as 'Password',CinNo as 'Cin No',GSTNo as 'GST No',Status as 'Account Status',DatabaseName,ClientPin as 'Pin','0' as 'API Balance' from " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration Where CompanyName  like '" & GV.parseString(txtSearchString.Text.Trim) & "%' order by  rid Desc"
    '            ElseIf ddlSelectCriteria.SelectedValue = "Login ID" Then
    '                Querystring = "select '0' as 'SrNo',CompanyName as 'Company Name',CompanyCode as 'Company Code',ClientPassword as 'Password',CinNo as 'Cin No',GSTNo as 'GST No',Status as 'Account Status',DatabaseName,ClientPin as 'Pin','0' as 'API Balance' from " & GV.DefaultDatabase.Trim & ".dbo.BOS_ClientRegistration Where  CompanyCode='" & GV.parseString(txtSearchString.Text.Trim) & "'  order by  rid Desc"
    '            End If
    '        Else
    '            If ddlSelectCriteria.SelectedValue = "All Records" Then
    '                ddlSelectCriteria.Text = ""
    '                Querystring = "select '0' as 'SrNo',(FirstName+' '+LastName) as Name,RegistrationId as 'Registration ID',AgentPassword as 'Agent Password',TransactionPin as 'Transaction Pin',(CONVERT(VARCHAR(11),RegistrationDate,106)) as 'Registration Date',AgencyName as 'Agency Name',MobileNo as 'Mobile No','0' as 'Wallet Bal' from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.[BOS_Dis_SubDis_Retailer_Registration] where AgentType='" & group & "' " & Loginid & "  order by  rid Desc"
    '            ElseIf ddlSelectCriteria.SelectedValue = "Name" Then
    '                Querystring = "select '0' as 'SrNo',(FirstName+' '+LastName) as Name,RegistrationId as 'Registration ID',AgentPassword as 'Agent Password',TransactionPin as 'Transaction Pin',(CONVERT(VARCHAR(11),RegistrationDate,106)) as 'Registration Date',AgencyName as 'Agency Name',MobileNo as 'Mobile No','0' as 'Wallet Bal' from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.[BOS_Dis_SubDis_Retailer_Registration] Where AgentType='" & group & "' " & Loginid & "  and FirstName  like '" & GV.parseString(txtSearchString.Text.Trim) & "%' order by  rid Desc"
    '            ElseIf ddlSelectCriteria.SelectedValue = "Login ID" Then
    '                Querystring = "select '0' as 'SrNo',(FirstName+' '+LastName) as Name,RegistrationId as 'Registration ID',AgentPassword as 'Agent Password',TransactionPin as 'Transaction Pin',(CONVERT(VARCHAR(11),RegistrationDate,106)) as 'Registration Date',AgencyName as 'Agency Name',MobileNo as 'Mobile No','0' as 'Wallet Bal' from  " & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.[BOS_Dis_SubDis_Retailer_Registration] Where AgentType='" & group & "' " & Loginid & "  and RegistrationId='" & GV.parseString(txtSearchString.Text.Trim) & "'  order by  rid Desc"
    '            End If
    '        End If
    ...
    '                    For i As Integer = 0 To GridView1.Rows.Count - 1
    '                        GridView1.Rows(i).Cells(9).Text = GV.AgentBalance(GV.parseString(GridView1.Rows(i).Cells(3).Text.Trim), GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim)
    '                        GridView1.Rows(i).Cells(4).Text = GV.DecryptString(GV.key, GridView1.Rows(i).Cells(4).Text)
    '                        ' GridView1.Columns().visible = False
    '                    Next
    '                Else
    '                    For i As Integer = 0 To GridView1.Rows.Count - 1
    '                        GridView1.Rows(i).Cells(10).Text = GV.returnAPIBalance(GV.parseString(GridView1.Rows(i).Cells(8).Text.Trim))
    '                        GridView1.Rows(i).Cells(4).Text = GV.DecryptString(GV.key, GV.parseString(GridView1.Rows(i).Cells(4).Text))
    '                    Next
    '                End If
    '            Else
    '                clear()
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            If groupType.Trim.ToUpper = "Super Admin".ToUpper Then
                ...
                loginID = "Admin"
                Password = GV.FL.AddInVar("ClientPassword", "" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_ClientRegistration where CompanyCode='" & CompanyCode & "' ")
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    If dataAdd = 0 Then
                        ...
                        GV.LoginInfo("DataBaseName") = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(7).Text)
            ...
            Else
                ...
                If DataBaseName = "CMP1218" Then
                    Password = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(4).Text)
                    ds = GV.FL.OpenDs("" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration where RegistrationId='" & loginID & "' and AgentPassword='" & GV.EncryptString(GV.key, Password) & "'  and AgentType='" & Group & "'")
                ElseIf DataBaseName = "CMP1174" Then
                    Password = GV.parseString(GridView1.Rows(gvrow.RowIndex).Cells(4).Text)
                    ds = GV.FL.OpenDs("" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration where RegistrationId='" & loginID & "' and AgentPassword='" & GV.EncryptString(GV.key, Password) & "'  and AgentType='" & Group & "'")
                Else
                    Password = GV.FL.AddInVar("AgentPassword", "" & GV.get_SuperAdmin_SessionVariables("DataBaseName", Request, Response).Trim & ".dbo.BOS_Dis_SubDis_Retailer_Registration where RegistrationId='" & GV.parseString(loginID.Trim) & "' ")
