            ...
            If Not IsPostBack Then
                ...
                If Not IsPostBack Then
                    ...
                    If host = "boscenter.in" Then
                        Response.Redirect("index_.html")
                        'txtCompanyCode.Text = "CMP1085"
                        'txtCompanyCode.Enabled = True
                        'txtCompanyCode.CssClass = "form-control"

                    ElseIf host = "easytalktechnologies.com" Or host = "www.easytalktechnologies.com" Or host = "https://easytalktechnologies.com/" Then
                    ...
                    ElseIf host = "www.login.urjamitra.org.in" Or host = "login.urjamitra.org.in" Or host = "https://login.urjamitra.org.in" Then
                    ...
                    ElseIf host = "admin.yaseentech.com" Then
                        ...
                        txtCompanyCode.Enabled = False
                        txtCompanyCode.CssClass = "form-control"
                    ElseIf host = "www.paykre.com" Or host = "paykre.com" Or host = "https://paykre.com" Then
                        Response.Redirect("PayKre_Login.aspx")
                        txtCompanyCode.Text = "CMP1218"
                        txtCompanyCode.Enabled = False
                        txtCompanyCode.CssClass = "form-control"
                    ElseIf host = "www.publicsevakendra.co.in" Or host = "publicsevakendra.co.in" Or host = "https://publicsevakendra.co.in" Then
                        If fBrowserIsMobile() = False Then
                            ...
                            txtCompanyCode.CssClass = "form-control"
                        Else
                            Response.Redirect("psk_mLogin.aspx")
                            txtCompanyCode.Text = "CMP1223"
                            txtCompanyCode.Enabled = False
                            txtCompanyCode.CssClass = "form-control"
                        End If
                    ElseIf host = "www.kotakpayments.com" Or host = "kotakpayments.com" Or host = "https://kotakpayments.com" Then
                        Response.Redirect("KotakPayments.aspx")
                        txtCompanyCode.Text = "CMP1232"
                        txtCompanyCode.Enabled = False
                        txtCompanyCode.CssClass = "form-control"
                    ElseIf host = "vpaybusiness.in" Or host = "www.vpaybusiness.in" Or host = "https://vpaybusiness.in" Then
                        Response.Redirect("vpaylogin.aspx")
                        txtCompanyCode.Text = "CMP1235"
                        txtCompanyCode.Enabled = False
                        txtCompanyCode.CssClass = "form-control"
                    ElseIf host = "www.click2pay.co.in" Or host = "click2pay.co.in" Or host = "https://click2pay.co.in" Then
                        Response.Redirect("Login_ClickToPay.aspx")
                        txtCompanyCode.Text = "CMP1194"
                        txtCompanyCode.Enabled = False
                        txtCompanyCode.CssClass = "form-control"
                    ElseIf host = "www.instape.in" Or host = "instape.in" Or host = "https://instape.in" Then
                        Response.Redirect("Login_instape.aspx")
                        txtCompanyCode.Text = "CMP1165"
                        txtCompanyCode.Enabled = False
                        txtCompanyCode.CssClass = "form-control"
                    ElseIf host = "www.egylypay.com" Or host = "egylypay.com" Or host = "https://egylypay.com" Then
                        Response.Redirect("Ezlypay_Login.aspx")
                        txtCompanyCode.Text = "CMP1278"
                        txtCompanyCode.Enabled = False
                        txtCompanyCode.CssClass = "form-control"
                    Else
                        ...
                        If GV.FL.RecCount(DBName & ".dbo.BOS_Dis_SubDis_Retailer_Registration where   RegistrationId='" & GV.parseString(MemberId) & "' ") Then
                            If GV.FL.RecCount(DBName & ".dbo.BOS_Dis_SubDis_Retailer_Registration where   RegistrationId='" & GV.parseString(MemberId) & "' and  MobileNo='" & GV.parseString(Email) & "' ") > 0 Then
                                ...
                                If GV.FL.AddInVar("AllowSms", GV.DefaultDatabase.Trim & ".dbo.Autonumber").ToString.Trim.ToUpper = "Yes".ToUpper Then
                                    ...
                                    ElseIf DBName.Trim = "CMP1218" Then
                                        Dim vMessage As String = "Dear " & vName & " Your OTP is : " & Session("OTP") & " . Please Do Not Share With Anyone .Thanks For Using PayKre Website:- https://www.paykre.org/"
                                        GV.send_Template_Based_SMS_API(GV.parseString(Email), vMessage, "Send Otp", "CMP1218")
                                    Else
                            ...
                            If GV.FL.RecCount(DBName & ".dbo.CRM_Login_Details where  User_ID='" & GV.parseString(MemberId) & "' and  MobileNo='" & GV.parseString(Email) & "' ") > 0 Then
                                ...
                                If GV.FL.AddInVar("AllowSms", GV.DefaultDatabase.Trim & ".dbo.Autonumber").ToString.Trim.ToUpper = "Yes".ToUpper Then
                                    ...
                                    ElseIf DBName.Trim = "CMP1174" Then
                                        ...
                                        GV.send_Template_Based_SMS_API(GV.parseString(Email), vMessage, "Send Otp", "CMP1174")
                                    ElseIf DBName.Trim = "CMP1218" Then
                                        Dim vMessage As String = "Dear " & vName & " Your OTP is : " & Session("OTP") & " . Please Do Not Share With Anyone .Thanks For Using PayKre Website:- https://paykre.org/"
                                        GV.send_Template_Based_SMS_API(GV.parseString(Email), vMessage, "Send Otp", "CMP1218")
                                    Else
                                        Dim vMessage As String = "Dear " & vName & " Your OTP is : " & Session("OTP") & " . Please Do Not Share With Anyone . Thanks For Using BOS."
                                        GV.send_Template_Based_SMS_API(GV.parseString(Email), vMessage, "Send Otp", "")
        ...
        Try
            ...
            If Not txtLoginId.Text.Trim = "" Then
                ...
                If Session("Src") = "EmailID" Then
                    ...
                    msg = msg & "Password : " & GV.DecryptString(GV.key, strarr(1).ToString.Trim) & "<br>"
                ...
                ElseIf Session("Src") = "Mobile" Then
                    ...
                    'Dim DecrPass As String = strarr(1).ToString.Trim
                    'DecrPass = GV.DecryptString(GV.key, DecrPass)
                    msg = msg & "Password : " & GV.DecryptString(GV.key, strarr(1)) & Environment.NewLine & Environment.NewLine
                    ...
                    If rdbForgotType.SelectedValue = "Password" Then
                        If GV.FL.AddInVar("AllowSms", GV.DefaultDatabase.Trim & ".dbo.Autonumber").ToString.Trim.ToUpper = "Yes".ToUpper Then
                            ...
                            If DBName.Trim = "CMP1165" Then
                                Dim vMessage As String = "Dear " & vName & " Your Password Is " & GV.DecryptString(GV.key, strarr(1).ToString.Trim) & " Please Do Not Share With Anyone . Thanks For Using Kuber Money"
                                GV.send_Template_Based_SMS_API(GV.parseString(txtEmail.Text.Trim), vMessage, "Forgot Password", "CMP1165")
                            ElseIf DBName.Trim = "CMP1174" Then
                                Dim vMessage As String = "Dear " & vName & " Your Password Is " & GV.DecryptString(GV.key, strarr(1).ToString.Trim) & " Please Do Not Share With Anyone. Thanks For Using Easy Talk. Web: https://bit.ly/3p1OkPj App: https://bit.ly/3Szblqb"
                                GV.send_Template_Based_SMS_API(GV.parseString(txtEmail.Text.Trim), vMessage, "Forgot Password", "CMP1174")
                            Else
                                Dim vMessage As String = "Dear " & vName & " Your Password Is " & GV.DecryptString(GV.key, strarr(1).ToString.Trim) & " Please Do Not Share With Anyone. Thanks For Using BOS."
