<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="create_retailer.aspx.vb" Inherits="BOSCenter.create_retailer" %>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtFirstName'>Retailer Name <asp:Label ID="Label6" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label></label>
