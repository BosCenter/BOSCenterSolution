...
Public Class AddFundController
    ...
    Public Function GetValue(ByVal Companycode As String, ByVal LoginID As String, ByVal UserPassword As String) As AddFund
        ...
        UserPassword = EncryptString(key, UserPassword)
        ...
        ElseIf LoginID.Trim.Contains("-") Then
            localDs = OpenDsWithSelectQuery("select * from dbo.BOS_Dis_SubDis_Retailer_Registration where   RegistrationId='" & LoginID & "' and AgentPassword='" & UserPassword & "'  and AgentType in ('Customer','Retailer')  and ActiveStatus='Active' ")
        Else
