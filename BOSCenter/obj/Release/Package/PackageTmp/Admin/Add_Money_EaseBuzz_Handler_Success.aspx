<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="Add_Money_EaseBuzz_Handler_Success.aspx.vb" Inherits="BOSCenter.Add_Money_EaseBuzz_Handler_Success" %>
...
<asp:Label ID='lblformsectionhead3' runat='server' Text='ADD TO WALLET'></asp:Label>
</div>
