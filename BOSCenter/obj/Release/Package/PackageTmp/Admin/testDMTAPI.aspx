<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="testDMTAPI.aspx.vb" Inherits="BOSCenter.testDMTAPI" %>
...
&nbsp;<br />
        ...
        &nbsp;<asp:Button ID="btnCall_PAN_API" runat="server" Text="Call PAN API" />
        <br />
