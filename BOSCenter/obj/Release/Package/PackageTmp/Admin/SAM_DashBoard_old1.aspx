<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="SAM_DashBoard_old1.aspx.vb" Inherits="BOSCenter.SAM_DashBoard_old1" %>
...
<div class="form-section sa" style="height:120px;color:White;border-radius:40px;margin-left:4px;background: linear-gradient(to bottom right, green, yellow);">
<div class="row">
<div class="col-md-12">
<h4 >&nbsp;API BALANCE</h4>
</div>
...
<div class="form-section sa"  style="height:120px;color:White;border-radius:40px;margin-left:4px; background: linear-gradient(to bottom right, blue,cyan)">
<div class="row">
<div class="col-md-12">
<h4>&nbsp;PAN Card</h4>
</div>
...
<div class="col-md-8">
    ...
    <div class="row">
    <div class="col-md-12">
    <asp:Button ID="Button6" style=""  Visible="false" CssClass="btn btn-primary" runat="server" Text="Proceed" /></div>
    <br />
    </div>
...
<div class="col-md-8">
    ...
    <div class="row">
     <div class="col-md-12">
     <%--<asp:LinkButton ID="LinkButton11" PostBackUrl="https://www.travelbooking.live/"     CssClass="btn btn-danger pull-right mar_top10" runat="server" Width="100%">Add Dealer</asp:LinkButton>--%>
     <asp:HyperLink ID="ForwardLink" Target="_blank"  NavigateUrl="https://www.travelbooking.live/"   cssclass="btn btn-primary" runat="server">Proceed</asp:HyperLink>
    <%--<asp:Button ID="Button1" CssClass="btn btn-primary" Visible="false" runat="server" Text="Proceed" />--%>
    </div>
    </div>
