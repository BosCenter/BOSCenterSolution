<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_DistrictMaster.aspx.vb" Inherits="BOSCenter.BOS_DistrictMaster" %>
        	...
        	<div class="log_form1">
            	<%--
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Enter District</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                         ...
                         <%--   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ControlToValidate="txtDistrictName" ErrorMessage="District Name Required."  CssClass = "errorlabels"
        ...
        <ContentTemplate>
            ...
            <div class="row">
                 ...
                 <div class="table-responsive">
                    ...
                    <div class="clearfix"></div>
                        <asp:GridView ID="GridView1" runat="server"  cssclass="grid-view-themeclass" AutoGenerateColumns="False"  AllowPaging="True"
                            BorderStyle="None">
