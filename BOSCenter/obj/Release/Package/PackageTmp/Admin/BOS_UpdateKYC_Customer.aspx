<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_UpdateKYC_Customer.aspx.vb" Inherits="BOSCenter.BOS_UpdateKYC_Customer" %>
...
<asp:Label ID='lblformsectionhead3' runat='server' Text='UPDATE KYC Details'></asp:Label>
</div>
...
<asp:DropDownList ID="ddl_Ref_Code" runat="server" ReadOnly="true" class='form-control' AutoPostBack="true">
...
<asp:TextBox ID='txtMobileNo' runat='server'  MaxLength="10"  ReadOnly="true" placeholder='MobileNo' class='form-control'></asp:TextBox>
