<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Admin/SuperAdmin.Master"   CodeBehind="BOS_ApproveKyc.aspx.vb" Inherits="BOSCenter.BOS_ApproveKyc" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="Apporve Card KYC "></asp:Label>	
                    </div>
                </div>
            </div>
