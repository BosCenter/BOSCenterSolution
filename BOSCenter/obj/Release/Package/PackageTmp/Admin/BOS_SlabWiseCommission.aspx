<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_SlabWiseCommission.aspx.vb" Inherits="BOSCenter.BOS_SlabWiseCommission" %>
...
<br />
	...
	<div class="row">
    	<div class ="col-sm-11 col-sm-offset-1">
        	...
        	<div class="log_form1">
                       ...
                       <div class="clearfix" style="margin-bottom:5px;"></div>
                          ...
                          <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Select Slab <asp:Label ID="Label5" runat="server"  ForeColor="Red"  Text=" *"></asp:Label></label>
                        <div class="col-sm-9">
        ...
        runat="server" Enabled="True" FilterType="Custom" ValidChars=".0123456789" 
                    ...
                    <div class="clearfix" style="margin-bottom:5px;"></div>
                        <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Customer Commission <asp:Label ID="Label1"  ForeColor="Red" runat="server" Text=" *"></asp:Label></label>
                        <div class="col-sm-4">
