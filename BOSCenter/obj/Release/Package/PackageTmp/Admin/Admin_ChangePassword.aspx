<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="Admin_ChangePassword.aspx.vb" Inherits="BOSCenter.Admin_ChangePassword" %>
                   ...
                   <form class="form-horizontal">
                      <div class="form-group">
                        ...
                        <%-- <asp:Label ID="lbloldPass" runat="server" Text="Enter Old Password" CssClass="errorlabels-sm" Visible="false" ></asp:Label>--%>
                         ...
                         <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="txtOldPassword" CssClass="errorlabels-sm" runat="server" ErrorMessage="Enter Old Password"></asp:RequiredFieldValidator>--%>
