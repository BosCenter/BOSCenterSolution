<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Admin/SuperAdmin.Master"   CodeBehind="BOS_PendingForm_Report_SA.aspx.vb" Inherits="BOSCenter.BOS_PendingForm_Report_SA" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server"  cssclass="grid-view-themeclass"
                          ...
                          <Columns>
                            ...
                            <asp:TemplateField ShowHeader="False">
                              ...
                              <asp:BoundField DataField="kCodeType" HeaderText="Agency Type" />
                            ...
                            <asp:BoundField DataField="AllotedDateTime" HeaderText="Alloted Date Time" />
