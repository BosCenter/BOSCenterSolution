<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="AddMailTemplates.aspx.vb" Inherits="BOSCenter.AddMailTemplates" %>
        	...
        	<div class="log_form1">
                    ...
                    <div class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-11">
                            <asp:TextBox ID="txtMailID" cssclass="form-control inputtext" runat="server"  
                      ...
                      <div class="form-group">
                       <div class="col-sm-12 ">
                        <asp:ListBox ID="lstTemplates" runat="server"  CssClass="form-control"
                               Height="340px" AutoPostBack="True">
