<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/SuperAdmin.Master" CodeBehind="BOS_API_Log_Report.aspx.vb" Inherits="BOSCenter.BOS_API_Log_Report" %>
        ...
        <div class="row">
            	<div class="col-sm-12">
                	<div class="log_form_head1">
                        <asp:Label ID="lblHeading" runat="server" Text="API Wise Log Report"></asp:Label>	
                    </div>
                </div>
            </div>
...
<div class="row">
        ...
        <form class="form-horizontal">
                   ...
                   <div class="row">
                      ...
                      <div class="form-group">
                       <div class="col-sm-3">
                        <asp:DropDownList ID="ddlAPILogs" runat="server" class='form-control mar_lft10'>
                                 <asp:ListItem>:::: Select API Logs ::::</asp:ListItem>
                                 <asp:ListItem>Money Transfer API-2</asp:ListItem>
                                 <asp:ListItem>Recharge API-2</asp:ListItem>
                                ...
                                <asp:ListItem>Axis-Bank-Account</asp:ListItem>
                      ...
                      <label for="inputEmail3" class="col-sm-1 control-label" style="padding-right: 14px;"> Criteria</label>
                        <div class="col-sm-3">
                            <asp:DropDownList ID="ddlSelectCriteria" cssclass="form-control inputtext"  
                               ...
                               <asp:ListItem >Trans ID</asp:ListItem>
                            </asp:DropDownList>
                  ...
                  <asp:ListItem>500 Record(s)</asp:ListItem>
                   ...
                   &nbsp;&nbsp;   Search Details ::-
                    ...
                    <asp:GridView ID="GridView1" runat="server" cssclass="grid-view-themeclass"
                            BorderStyle="None" AllowPaging="True" AutoGenerateColumns="true"  AlternatingRowStyle-Wrap ="false">
