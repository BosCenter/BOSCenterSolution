<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="CreateCustomer.aspx.vb" Inherits="BOSCenter.CreateCustomer" %>
...
<asp:Label ID='lblformsectionhead3' runat='server' Text='Registration Details'></asp:Label>
</div>
...
<div class="col-md-4">
<div class="form-group">
<label for='txtAgentName'>  Reference Type</asp:Label></label>
...
<div class="row mar_top10">
    <div class="col-md-4">
<div class="form-group">
<label for='txtEmailID'>  Email ID <asp:Label ID="Label7" runat="server" ForeColor="red" Text="&nbsp;*"></asp:Label>&nbsp;<asp:Label ID="lblEmailError" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label></label>
